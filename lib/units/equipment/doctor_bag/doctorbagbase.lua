...
function DoctorBagBase.spawn( pos, rot, amount_upgrade_lvl ) -- Only called from server
	local unit_name = "units/payday2/equipment/gen_equipment_medicbag/gen_equipment_medicbag"
	--[[local unit_name = "units/payday2/equipment/gen_equipment_medic_bag_small/gen_equipment_medic_bag_small"
	if amount_upgrade_lvl > 0 then
		unit_name = "units/payday2/equipment/gen_equipment_medic_bag_large/gen_equipment_medic_bag_large"
	end]]
...
function DoctorBagBase:take( unit )
	...
	-- print( "Took " .. taken .. " health, " .. self._amount .. " left" )
