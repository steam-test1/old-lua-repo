...
function SentryGunDamage:damage_explosion(attack_data)
	...
	local attacker_unit = attack_data.attacker_unit and attack_data.attacker_unit:base() and attack_data.attacker_unit:base().thrower_unit and attack_data.attacker_unit:base():thrower_unit()
