...
-- Command line was: F:\SteamLibrary\SteamApps\common\PAYDAY 2\lua\lib\units\equipment\ammo_bag\ammobagbase.luac 

if not AmmoBagBase then
  AmmoBagBase = class(UnitBase)
end
AmmoBagBase.spawn = function(l_1_0, l_1_1, l_1_2)
  ...
  managers.network:session():send_to_peers_synched("sync_ammo_bag_setup", unit, l_1_2)
  unit:base():setup(l_1_2)
  return unit
end

AmmoBagBase.set_server_information = function(l_2_0, l_2_1)
  l_2_0._server_information = {owner_peer_id = l_2_1}
  managers.network:game():member(l_2_1):peer():set_used_deployable(true)
end

AmmoBagBase.server_information = function(l_3_0)
  return l_3_0._server_information
end

AmmoBagBase.init = function(l_4_0, l_4_1)
  UnitBase.init(l_4_0, l_4_1, false)
  l_4_0._unit = l_4_1
  l_4_0._max_ammo_amount = tweak_data.upgrades.ammo_bag_base + managers.player:upgrade_value_by_level("ammo_bag", "ammo_increase", 1)
  l_4_0._unit:sound_source():post_event("ammo_bag_drop")
end

AmmoBagBase.sync_setup = function(l_5_0, l_5_1)
  l_5_0:setup(l_5_1)
end

AmmoBagBase.setup = function(l_6_0, l_6_1)
  l_6_0._ammo_amount = tweak_data.upgrades.ammo_bag_base + managers.player:upgrade_value_by_level("ammo_bag", "ammo_increase", l_6_1)
...
AmmoBagBase.update = function(l_7_0, l_7_1, l_7_2, l_7_3)
  l_7_0:_check_body()
end

AmmoBagBase._check_body = function(l_8_0)
...
AmmoBagBase.server_set_dynamic = function(l_9_0)
  l_9_0:_set_dynamic()
...
AmmoBagBase.sync_net_event = function(l_10_0, l_10_1)
  l_10_0:_set_dynamic()
end

AmmoBagBase._set_dynamic = function(l_11_0)
  l_11_0._is_dynamic = true
  l_11_0._unit:body("dynamic"):set_enabled(true)
end

AmmoBagBase.take_ammo = function(l_12_0, l_12_1)
  if l_12_0._empty then
    return 
  end
  local taken = l_12_0:_take_ammo(l_12_1)
  if taken > 0 then
    l_12_1:sound():play("pickup_ammo")
    managers.network:session():send_to_peers_synched("sync_ammo_bag_ammo_taken", l_12_0._unit, taken)
  end
  if l_12_0._ammo_amount <= 0 then
    l_12_0:_set_empty()
  else
...
AmmoBagBase._set_visual_stage = function(l_13_0)
  local percentage = l_13_0._ammo_amount / l_13_0._max_ammo_amount
...
AmmoBagBase.sync_ammo_taken = function(l_14_0, l_14_1)
  l_14_0._ammo_amount = l_14_0._ammo_amount - l_14_1
  if l_14_0._ammo_amount <= 0 then
    l_14_0:_set_empty()
  else
...
AmmoBagBase._take_ammo = function(l_15_0, l_15_1)
  local taken = 0
  local inventory = l_15_1:inventory()
  if inventory then
    for _,weapon in pairs(inventory:available_selections()) do
      local took = weapon.unit:base():add_ammo_from_bag(l_15_0._ammo_amount)
      taken = taken + took
      l_15_0._ammo_amount = l_15_0._ammo_amount - took
      if l_15_0._ammo_amount <= 0 then
        l_15_0:_set_empty()
        return taken
      end
    end
...
AmmoBagBase._set_empty = function(l_16_0)
  l_16_0._empty = true
  l_16_0._unit:set_slot(0)
end

AmmoBagBase.save = function(l_17_0, l_17_1)
  local state = {}
  state.ammo_amount = l_17_0._ammo_amount
  state.is_dynamic = l_17_0._is_dynamic
  l_17_1.AmmoBagBase = state
end

AmmoBagBase.load = function(l_18_0, l_18_1)
  local state = l_18_1.AmmoBagBase
  l_18_0._ammo_amount = state.ammo_amount
...
AmmoBagBase.destroy = function(l_19_0)
end
