...
TweakData.RELOAD = true		-- Whether to reload the tweak data every time the script is reloaded.
...
function TweakData:_set_easy()
	...
	self.experience_manager.total_objectives_finished	= 750		-- Amount of XP bonus from amount of completed objectives during a heist (400 max)
end
...
function TweakData:_set_normal()
	...
	-- old
	self.experience_manager.total_level_objectives		= 2000	-- How much XP should be divided in a level from objectives 
	self.experience_manager.total_criminals_finished	= 50		-- Amount of XP bonus recieved from each alive criminal at heist end
	self.experience_manager.total_objectives_finished	= 1000	-- Amount of XP bonus from amount of completed objectives during a heist (400 max)
end
...
function TweakData:_set_hard()
	...
	-- old
	self.experience_manager.total_level_objectives		= 2500	-- How much XP should be divided in a level from objectives 
	self.experience_manager.total_criminals_finished	= 150		-- Amount of XP bonus recieved from each alive criminal at heist end
	self.experience_manager.total_objectives_finished	= 1500	-- Amount of XP bonus from amount of completed objectives during a heist (400 max)
end
...
function TweakData:_set_overkill()
	...
	-- old
	self.experience_manager.total_level_objectives		= 5000	-- How much XP should be divided in a level from objectives 
	self.experience_manager.total_criminals_finished	= 500		-- Amount of XP bonus recieved from each alive criminal at heist end
	self.experience_manager.total_objectives_finished	= 3000	-- Amount of XP bonus from amount of completed objectives during a heist (400 max)
end
...
function TweakData:_set_overkill_145()
	...
	-- old
	self.experience_manager.total_level_objectives		= 5000	-- How much XP should be divided in a level from objectives 
	self.experience_manager.total_criminals_finished	= 2000	-- Amount of XP bonus recieved from each alive criminal at heist end
	self.experience_manager.total_objectives_finished	= 3000	-- Amount of XP bonus from amount of completed objectives during a heist (400 max)
end
...
function TweakData:init()
	...
	self.permissions = { "public", "friends_only", "private" }
	self.server_states = { "in_lobby", "loading", "in_game" }
	self.menu_sync_states = {"crimenet", "skilltree", "options", "lobby", "blackmarket", "blackmarket_weapon", "blackmarket_mask"}
	...
	--[[self.mask_sets = {
		clowns = {
			{ mask_icon = "mask_clown2", health_gui_offset = 128, mask_obj = "units/characters/npc/criminal/masks/clown/hoxton_clown" },
			{ mask_icon = "mask_clown1", health_gui_offset =  64, mask_obj = "units/characters/npc/criminal/masks/clown/wolf_clown" },
			{ mask_icon = "mask_clown3", health_gui_offset =   0, mask_obj = "units/characters/npc/criminal/masks/clown/dallas_clown" },
			{ mask_icon = "mask_clown4", health_gui_offset = 192, mask_obj = "units/characters/npc/criminal/masks/clown/chains_clown" },
			health_gui_image = "guis/textures/team_health_org"
		},
		
		alienware = {
			{ mask_icon = "mask_alien2", health_gui_offset = 128, mask_obj = "units/characters/npc/criminal/masks/alien/hoxton_alien" },
			{ mask_icon = "mask_alien1", health_gui_offset =  64, mask_obj = "units/characters/npc/criminal/masks/alien/wolf_alien" },
			{ mask_icon = "mask_alien3", health_gui_offset =   0, mask_obj = "units/characters/npc/criminal/masks/alien/dallas_alien" },
			{ mask_icon = "mask_alien4", health_gui_offset = 192, mask_obj = "units/characters/npc/criminal/masks/alien/chains_alien" },
			health_gui_image = "guis/textures/team_health_alienware"
		},
		
		developer = {
			{ mask_icon = "mask_dev", health_gui_offset = 0, mask_obj = "units/characters/npc/criminal/masks/hockey/hoxton_hockey" },
			{ mask_icon = "mask_dev", health_gui_offset = 0, mask_obj = "units/characters/npc/criminal/masks/hockey/wolf_hockey" },
			{ mask_icon = "mask_dev", health_gui_offset = 0, mask_obj = "units/characters/npc/criminal/masks/hockey/dallas_hockey" },
			{ mask_icon = "mask_dev", health_gui_offset = 0, mask_obj = "units/characters/npc/criminal/masks/hockey/chains_hockey" },
			health_gui_image = "guis/textures/team_health_devcom"
		},
		
		hockey_com = {
			{ mask_icon = "mask_com", health_gui_offset = 64, mask_obj = "units/characters/npc/criminal/masks/hockey_com/hoxton_hockey_com" },
			{ mask_icon = "mask_com", health_gui_offset = 64, mask_obj = "units/characters/npc/criminal/masks/hockey_com/wolf_hockey_com" },
			{ mask_icon = "mask_com", health_gui_offset = 64, mask_obj = "units/characters/npc/criminal/masks/hockey_com/dallas_hockey_com" },
			{ mask_icon = "mask_com", health_gui_offset = 64, mask_obj = "units/characters/npc/criminal/masks/hockey_com/chains_hockey_com" },
			health_gui_image = "guis/textures/team_health_devcom"
		},
		
		bf3 = {
			{ mask_icon = "mask_bf2", health_gui_offset = 128, mask_obj = "units/characters/npc/criminal/masks/beeef/hoxton_beeef" },
			{ mask_icon = "mask_bf1", health_gui_offset =  64, mask_obj = "units/characters/npc/criminal/masks/beeef/wolf_beeef" },
			{ mask_icon = "mask_bf3", health_gui_offset =   0, mask_obj = "units/characters/npc/criminal/masks/beeef/dallas_beeef" },
			{ mask_icon = "mask_bf4", health_gui_offset = 192, mask_obj = "units/characters/npc/criminal/masks/beeef/chains_beeef" },
			health_gui_image = "guis/textures/team_health_beef"
		},
		
		santa = {
			{ mask_icon = "mask_santa", health_gui_offset = 128, mask_obj = { default = "units/characters/npc/criminal/masks/santa_clause_mask/hoxton_santa", bridge = "units/characters/npc/criminal/masks/santa_clause_mask/hoxton_santa_raincoat" } },
			{ mask_icon = "mask_santa", health_gui_offset = 128, mask_obj = { default = "units/characters/npc/criminal/masks/santa_clause_mask/wolf_santa",   bridge = "units/characters/npc/criminal/masks/santa_clause_mask/wolf_santa_raincoat" } },
			{ mask_icon = "mask_santa", health_gui_offset = 128, mask_obj = { default = "units/characters/npc/criminal/masks/santa_clause_mask/dallas_santa", bridge = "units/characters/npc/criminal/masks/santa_clause_mask/dallas_santa_raincoat" } },
			{ mask_icon = "mask_santa", health_gui_offset = 128, mask_obj = { default = "units/characters/npc/criminal/masks/santa_clause_mask/chains_santa", bridge = "units/characters/npc/criminal/masks/santa_clause_mask/chains_santa_raincoat" } },
			health_gui_image = "guis/textures/team_health_devcom"
		},
		
		gold = {
			{ mask_icon = "mask_gold2", health_gui_offset = 128, mask_obj = "units/characters/npc/criminal/masks/gold/hoxton_clown_gold" },
			{ mask_icon = "mask_gold1", health_gui_offset =  64, mask_obj = "units/characters/npc/criminal/masks/gold/wolf_clown_gold" },
			{ mask_icon = "mask_gold3", health_gui_offset =   0, mask_obj = "units/characters/npc/criminal/masks/gold/dallas_clown_gold" },
			{ mask_icon = "mask_gold4", health_gui_offset = 192, mask_obj = "units/characters/npc/criminal/masks/gold/chains_clown_gold" },
			health_gui_image = "guis/textures/team_health_145"
		},
		
		president = {
			{ mask_icon = "mask_president2", health_gui_offset = 128, mask_obj = { default = "units/characters/npc/criminal/masks/presidents/hoxton_president", bridge = "units/characters/npc/criminal/masks/presidents/hoxton_president_raincoat" } },
			{ mask_icon = "mask_president1", health_gui_offset =  64, mask_obj = { default = "units/characters/npc/criminal/masks/presidents/wolf_president",   bridge = "units/characters/npc/criminal/masks/presidents/wolf_president_raincoat" } },
			{ mask_icon = "mask_president3", health_gui_offset =   0, mask_obj = { default = "units/characters/npc/criminal/masks/presidents/dallas_president", bridge = "units/characters/npc/criminal/masks/presidents/dallas_president_raincoat" } },
			{ mask_icon = "mask_president4", health_gui_offset = 192, mask_obj = "units/characters/npc/criminal/masks/presidents/chains_president" },
			health_gui_image = "guis/textures/team_health_presidents"
		},
		
		zombie = {
			{ mask_icon = "mask_zombie2", health_gui_offset = 128, mask_obj = "units/characters/npc/criminal/masks/zombie/boomer_hoxton" },
			{ mask_icon = "mask_zombie1", health_gui_offset =  64, mask_obj = "units/characters/npc/criminal/masks/zombie/smoker_wolf" },
			{ mask_icon = "mask_zombie3", health_gui_offset =   0, mask_obj = "units/characters/npc/criminal/masks/zombie/hunter_dallas" },
			{ mask_icon = "mask_zombie4", health_gui_offset = 192, mask_obj = "units/characters/npc/criminal/masks/zombie/hulk_chains" },
			health_gui_image = "guis/textures/team_health_zombie"
		},

		troll = {
			{ mask_icon = "mask_troll2", health_gui_offset = 128, mask_obj = "units/characters/npc/criminal/masks/troll/hoxton_lol" },
			{ mask_icon = "mask_troll1", health_gui_offset =  64, mask_obj = "units/characters/npc/criminal/masks/troll/wolf_lol" },
			{ mask_icon = "mask_troll3", health_gui_offset =   0, mask_obj = "units/characters/npc/criminal/masks/troll/dallas_lol" },
			{ mask_icon = "mask_troll4", health_gui_offset = 192, mask_obj = "units/characters/npc/criminal/masks/troll/chains_lol" },
...
-- States:
	self.states = {}
	self.states.title = {}
	self.states.title.ATTRACT_VIDEO_DELAY = 90	-- How long delay, in seconds, to wait before playing attract video in the title screen.

-- Menu:
	self.menu = {}
	self.menu.BRIGHTNESS_CHANGE = 0.05			-- How much to change brightness per step.
	self.menu.MIN_BRIGHTNESS = 0.5				-- Minimum brightness.
	self.menu.MAX_BRIGHTNESS = 1.5				-- Maximum brightness.
	...
	local orange = Vector3( 204, 161, 102 )/255 -- 224, 109, 81
	local green = Vector3( 194, 252, 151 )/255 -- 102, 204, 51
	local brown = Vector3( 178, 104, 89 )/255 -- 98, 70, 43
	local blue = Vector3( 120, 183, 204 )/255 -- 104, 133, 161
	local team_ai = Vector3( 0.2, 0.8, 1 ) -- Vector3( 0.2, 0.9, 0.5 ) -- Vector3( 1, 1, 0 ) -- Vector3( 0.1, 1.0, 0.5 ) -- Vector3( 0, 0.7, 0 ) -- Vector3( 0, 1.0, 0 ) -- Vector3( 25, 255, 25 )/255
	-- local team_ai = Vector3( 255, 255, 0 )/255
	-- self.peer_vector_colors = { orange, blue, green, brown }		
	self.peer_vector_colors = { green, blue, brown, orange, team_ai }
	self.peer_colors = { "mrgreen", "mrblue", "mrbrown", "mrorange", "mrai" }	
...
-- MENU SCREENS COLORS																											-- skilltree references
	self.screen_colors = {}
	self.screen_colors.text = Color( 255, 255, 255, 255 ) / 255								-- text
	self.screen_colors.resource = Color( 255, 77, 198, 255 ) / 255						-- cost
	self.screen_colors.important_1 = Color( 255, 255, 51, 51 ) / 255					-- points needed text
	self.screen_colors.important_2 = Color( 125, 255, 51, 51 ) / 255					-- points needed text
	self.screen_colors.item_stage_1 = Color( 255, 255, 255, 255 ) / 255				-- owned
	self.screen_colors.item_stage_2 = Color( 255, 89, 115, 128 ) / 255				-- unlocked
	self.screen_colors.item_stage_3 = Color( 255, 23, 33, 38 ) / 255					-- locked
	self.screen_colors.button_stage_1 = Color( 255, 0, 0, 0 ) / 255						-- tab: selected
	self.screen_colors.button_stage_2 = Color( 255, 77, 198, 255 ) / 255				-- tab: mouseover
	self.screen_colors.button_stage_3 = Color( 127, 0, 170, 255 ) / 255				-- tab: rest
	
	self.screen_colors.crimenet_lines = Color( 255, 127, 157, 182 ) / 255
	-- self.screen_colors.button_stage_2 = Color( 190, 0, 170, 255 ) / 255				-- tab: mouseover
	-- self.screen_colors.button_stage_3 = Color( 127, 0, 170, 255 ) / 255				-- tab: rest
	...
	if Global.old_colors_purple then
		...
		self.screen_color_white = Color(255/255,255/255,255/255)
		self.screen_color_red = Color(182/255,63/255,54/255)
		self.screen_color_green = Color(32/255,255/255,132/255)
		self.screen_color_grey = Color(100/255,100/255,100/255)
		self.screen_color_light_grey = Color(200/255,200/255,200/255)
		
		self.screen_color_blue = Color(77/255,198/255,255/255)
		self.screen_color_blue_selected = Color(77/255,198/255,255/255) -- self.screen_color_blue
		...
		self.screen_color_yellow = Color(220/255,172/255,45/255)
		self.screen_color_yellow_selected = Color(255/255,204/255,0/255) -- self.screen_color_yellow
		self.screen_color_yellow_noselected = Color(187/255, 109/255, 20/255) -- self.screen_color_yellow_selected:with_alpha( 0.2 )
	end
...
-- DIALOGS:
	...
	self.dialog.PADDING = 30			-- Padding between dialog text and dialog background edge.
	self.dialog.BUTTON_PADDING = 5		-- Padding between button text and button background edge.
	self.dialog.BUTTON_SPACING = 10		-- Space between buttons.

	-- self.dialog.BG_COLOR = Color( 1, 1, 1 )
	self.dialog.FONT = self.menu.default_font
	self.dialog.BG_COLOR = self.menu.default_menu_background_color -- Color( 93/255, 105/255, 111/255 )
	...
	-- self.dialog.BUTTON_TEXT_COLOR = Color( 0.8, 0.8, 0.8 )
	...
	self.dialog.TITLE_SIZE 	= self.menu.topic_font_size			-- Title font size.
	self.dialog.TEXT_SIZE 	= self.menu.dialog_text_font_size	-- Text font size.
	self.dialog.BUTTON_SIZE = self.menu.dialog_title_font_size		-- Button font size.

	self.dialog.TITLE_TEXT_SPACING = 20			-- Space between title and text.
	self.dialog.BUTTON_TEXT_SPACING = 3		-- Space between button and text.
...
-- Interaction:
	self.interaction = {}
	self.interaction.CULLING_DISTANCE = 2000	-- Objects in this distance will be updated.
	self.interaction.INTERACT_DISTANCE = 200	-- Objects in this distance will be available for the player to interact with (can be overriden by each interactable)
	...
	self.interaction.requires_ecm_jammer.requires_upgrade = { category = "ecm_jammer", upgrade = "can_open_sec_doors" }
	...
	self.interaction.requires_ecm_jammer_atm.requires_upgrade = { category = "ecm_jammer", upgrade = "affects_cameras" }
	...
	--self.interaction.secret_stash_limo_roof_crowbar.equipment_text_id = "debug_interact_equipment_crowbar"
	--self.interaction.secret_stash_limo_roof_crowbar.special_equipment = "crowbar"
	...
	--self.interaction.suburbia_iron_gate_crowbar.sound_done	 	= "crowbar_metal_finished"
	...
	self.interaction.pick_lock_easy.requires_upgrade = { category = "player", upgrade = "pick_lock_easy" }
	self.interaction.pick_lock_easy.upgrade_timer_multiplier = { category = "player", upgrade = "pick_lock_easy_speed_multiplier" }
	...
	self.interaction.pick_lock_easy_no_skill.upgrade_timer_multiplier = { category = "player", upgrade = "pick_lock_easy_speed_multiplier" }
...
--	self.interaction.pick_lock_hard.interact_distance = 100
	self.interaction.pick_lock_hard.requires_upgrade = { category = "player", upgrade = "pick_lock_hard" }
	...
	self.interaction.pick_lock_hard_no_skill.upgrade_timer_multiplier = { category = "player", upgrade = "pick_lock_easy_speed_multiplier" }
	...
	self.interaction.drill_jammed.upgrade_timer_multiplier = { category = "player", upgrade = "drill_fix_interaction_speed_multiplier" }
	...
	--self.interaction.lance.special_equipment = "lance"
	...
	-- self.interaction.hospital_saw.blocked_hint 	= "no_drill"
	...
	self.interaction.hospital_saw_jammed.upgrade_timer_multiplier = { category = "player", upgrade = "drill_fix_interaction_speed_multiplier" }
	...
	-- self.interaction.apartment_saw.blocked_hint 	= "no_drill"
	...
	self.interaction.apartment_saw_jammed.upgrade_timer_multiplier = { category = "player", upgrade = "drill_fix_interaction_speed_multiplier" }
	...
	-- self.interaction.secret_stash_saw.blocked_hint 	= "no_drill"
	...
	self.interaction.secret_stash_saw_jammed.upgrade_timer_multiplier = { category = "player", upgrade = "drill_fix_interaction_speed_multiplier" }
	...
	-- self.interaction.revive.equipment_consume = true
	...
	self.interaction.revive.upgrade_timer_multiplier = { category = "player", upgrade = "revive_interaction_speed_multiplier" }
	-- self.interaction.revive.contour = "character_interactable"
...
--	self.interaction.hostage_trade.interact_distance = 300
	self.interaction.hostage_trade.contour = "character_interactable"
	self.interaction.hostage_trade.timer = 3
	self.interaction.hostage_trade.requires_upgrade = { category = "player", upgrade = "hostage_trade" }
	...
	self.interaction.doctor_bag.upgrade_timer_multiplier = { category = "doctor_bag", upgrade = "interaction_speed_multiplier" }
	...
	self.interaction.requires_cable_ties.requires_upgrade = { category = "cable_tie", upgrade = "can_cable_tie_doors" }
	self.interaction.requires_cable_ties.upgrade_timer_multiplier = { category = "cable_tie", upgrade = "interact_speed_multiplier" }
	...
	--self.interaction.ejection_seat_interact.sound_event = "bar_drill_apply"
	...
	--self.interaction.c4.interact_distance = 150
	...
	--self.interaction.c4_diffusible.interact_distance = 150
	...
	self.interaction.intimidate.upgrade_timer_multiplier = { category = "cable_tie", upgrade = "interact_speed_multiplier" }
	...
	-- self.interaction.trip_mine.start_active = false
	...
	self.interaction.corpse_dispose.requires_upgrade = { category = "player", upgrade = "corpse_dispose" }
	...
	-- self.interaction.shaped_sharge.equipment_text_id = "debug_interact_equipment_c4"
	...
	--self.interaction.shaped_sharge.axis				= "z"
	self.interaction.shaped_sharge.requires_upgrade = { category = "player", upgrade = "trip_mine_shaped_charge" }
	...
	self.interaction.hostage_convert.requires_upgrade = { category = "player", upgrade = "convert_enemies" }
	self.interaction.hostage_convert.upgrade_timer_multiplier = { category = "player", upgrade = "convert_enemies_interaction_speed_multiplier" }
...
-- Overlay effects:
	...
	self.overlay_effects.level_fade_in = {
								...
								fade_out 	= 3,
								color 		= Color( 1.0, 0, 0, 0 ),	
								timer 		= TimerManager:game(), -- it needs to pause if player presses esc in singleplayer while fading out
								play_paused = true
								}
	...
	local d_color 				= Color( 0.75, 1, 1, 1 ) -- Color( 0.75, 1, 0.4, 0.0 )
	local d_sustain 			= 0.1
	...
	self.overlay_effects.damage = {
								...
								fade_in 	= 0,
								fade_out 	= d_fade_out,
								color 		= d_color -- Color( 0.5, 0.5, 0.5, 0.5 )
								}
	...
	self.overlay_effects.damage_left = {
								...
								fade_out 	= d_fade_out,
								color 		= d_color,
								gradient_points = { 0, d_color, 0.1, d_color, 0.15, Color():with_alpha( 0 ), 1, Color():with_alpha( 0 ) },
	...
	self.overlay_effects.damage_right = {
								...
								fade_in 	= 0,
								fade_out 	= d_fade_out,
								color 		= d_color, -- Color.white, -- Color( 0.95, 0.5, 0.5, 0.5 ),
								-- gradient_points = { 1,d_color, 0.5, Color():with_alpha( 0 ), 0, Color():with_alpha( 0 ) },
								gradient_points = { 1,d_color, 1-0.1, d_color ,1-0.15, Color():with_alpha( 0 ), 0, Color():with_alpha( 0 ) },
								orientation	= "horizontal"
								}
	self.overlay_effects.damage_up = {
								...
								fade_in 	= 0,
								fade_out 	= d_fade_out,
								color 		= d_color, -- Color( 0.95, 0.5, 0.5, 0.5 ),
								-- gradient_points = { 0,d_color, 0.5, Color():with_alpha( 0 ), 1, Color():with_alpha( 0 ) },
								gradient_points = { 0, d_color, 0.1, d_color, 0.15, Color():with_alpha( 0 ), 1, Color():with_alpha( 0 ) },
...
-- ExperienceManager
	...
	self.experience_manager.level_limit.low_cap_level = -1				-- Players <= this level will gain additional experience from his level experience, using .low_cap_multiplier 
	self.experience_manager.level_limit.low_cap_multiplier = 0.75
	self.experience_manager.level_limit.pc_difference_multipliers = { 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1, 0.01 }	-- players above low_cap_level will gain experience of the difference between his level and job level, from the different of pc
	...
	self.experience_manager.total_criminals_finished	= 50		-- Amount of XP bonus recieved from each alive criminal at heist end
	self.experience_manager.total_objectives_finished	= 500		-- Amount of XP bonus from amount of completed objectives during a heist (400 max)
	...
	for i = exp_step_start, exp_step_end do
		self.experience_manager.levels[ i ]			= {
														-- points = math.round((1000000 * (exp_step * (i - exp_step_start))) + 2000) * multiplier,
														-- points = math.round((1000000 * (exp_step * (i - exp_step_start))),
	...
	self.achievement.going_places = 1000000 -- Amount of money to earn
	self.achievement.spend_money_to_make_money = 1000000 -- Amount of money to spend
	self.achievement.you_gotta_start_somewhere = 5 -- Level
	self.achievement.guilty_of_crime = 10 -- Level
	self.achievement.gone_in_30_seconds = 25 -- Level (gone_in_30_seconds changed to a level progression) 
	self.achievement.armed_and_dangerous = 50 -- Level
	self.achievement.big_shot = 75 -- Level (big_shot changed to a level progression)
	...
	self.achievement.complete_heist_achievements = {
		in_soviet_russia = { stat="halloween_10_stats", mask="bear", difficulty="overkill_145", contracts={ "vlad" } },
		i_take_scores = { stat="armored_4_stat", mask="heat", difficulty="overkill_145", jobs={ "arm_cro", "arm_cro_prof", "arm_und", "arm_und_prof", "arm_hcm", "arm_hcm_prof", "arm_par", "arm_par_prof", "arm_fac", "arm_fac_prof" } },
		eco_round = { award="charliesierra_7", no_shots="primaries", difficulty="overkill_145", jobs={ "roberts" } },
	}
	
	
	self.achievement.four_mask_achievements = {
		reindeer_games = { award="charliesierra_9", masks={ "santa_happy", "santa_mad", "santa_drunk", "santa_surprise" } },
	}
...
-- Pick up definitions
	...
	self.danger_zones = { 0.6, 0.5, 0.35, 0.1 } -- enemy focus delay multiplier. for danger levels 1 to 4
	
	-- Contour settings
	self.contour							= {}
	
	self.contour.character					= {}
	self.contour.character.standard_color	= Vector3( 0.1, 1.0, 0.5 )
	self.contour.character.friendly_color		= Vector3( 0.2, 0.8, 1.0 )
	self.contour.character.downed_color		= Vector3( 1.0, 0.5, 0.0 )
	self.contour.character.dead_color		= Vector3( 1.0, 0.1, 0.1 )
	self.contour.character.dangerous_color	= Vector3( 0.6, 0.2, 0.2 )
	self.contour.character.more_dangerous_color	= Vector3( 1.0, 0.1, 0.1 )
	self.contour.character.standard_opacity = 0
	
	self.contour.character_interactable					= {}
	self.contour.character_interactable.standard_color	= Vector3( 1.0, 0.5, 0.0 )
	self.contour.character_interactable.selected_color	= Vector3( 1.0, 1.0, 1.0 )
	
	self.contour.interactable					= {}
	self.contour.interactable.standard_color 	= Vector3( 1.0, 0.5, 0.0 )
	self.contour.interactable.selected_color 	= Vector3( 1.0, 1.0, 1.0 )
...
-- Music definitions
	...
	-- self.music.hit.switches				= { "track_01", "track_02" }
	...
	-- self.music.stress.switches			= { "track_01", "track_02" }
	...
	-- self.music.stealth.switches			= { "track_01", "track_02" }
	...
	self.music.heist.switches			= { "track_01", "track_02", "track_03", "track_04", "track_05", "track_06", "track_07", "track_08", "track_09", "track_10" }
	...
	-----------------------------
			...
			-----------------------------------------------------------------------------
	self.blame = {}										-- Bain dialog for different reasons why the police was called (on_enemy_weapons_hot)
																		-- Make sure to update BLAME_SYNC in GroupAIStateBase.lua when adding or removing blames
	
	self.blame.default = "hint_blame_missing" -- "Play_pln_alm_any_any"									-- Default blame, if the reason is nil
	self.blame.empty = nil																			-- nil
	
		-- camera blames you
	self.blame.cam_criminal = "hint_cam_criminal" -- "Play_pln_alm_cam_rob"
	self.blame.cam_dead_body = "hint_cam_dead_body" -- "Play_pln_alm_cam_bod"
	self.blame.cam_hostage = "hint_cam_hostage" -- "Play_pln_alm_cam_hos"
	self.blame.cam_distress = "hint_cam_distress" -- "Play_pln_alm_cam_vio"
	self.blame.cam_body_bag = "hint_body_bag" -- "Play_pln_alm_cam_bag"
	self.blame.cam_gunfire = "hint_gunfire" -- "pln_alm_cam_fir"
	
	self.blame.cam_drill = "hint_cam_drill" -- "Play_pln_alm_cam_dri"
	self.blame.cam_saw = "hint_cam_saw" -- false
	self.blame.cam_sentry_gun = "hint_sentry_gun" -- false
	self.blame.cam_trip_mine = "hint_trip_mine" -- false
	self.blame.cam_ecm_jammer = "hint_ecm_jammer" -- false
	
	self.blame.cam_c4 = "hint_c4" -- "Play_pln_alm_any_exp" 									-- attention object
	self.blame.cam_computer = "hint_computer" -- false 														-- attention object
	self.blame.cam_glass = "hint_glass" -- "Play_pln_alm_cam_win"								-- attention object
	self.blame.cam_broken_cam = "hint_cam_broken_cam" -- "Play_pln_alm_cam_win"								-- attention object
	self.blame.cam_vault = "hint_vault" -- "Play_pln_alm_cam_vau"								-- attention object
	self.blame.cam_fire = "hint_fire" -- false																	-- attention object
	self.blame.cam_voting = "hint_voting" -- "Play_pln_alm_cam_vot" 							-- attention object
	self.blame.cam_breaking_entering = "hint_breaking_entering" -- "Play_pln_alm_cam_vot" 							-- attention object
	
		-- civilian blames you
	-- self.blame.civ_911 = false -- "Play_pln_alm_civ_911"
	self.blame.civ_criminal = "hint_civ_criminal" -- "Play_pln_alm_cop_wea"	-- ?
	self.blame.civ_dead_body = "hint_civ_dead_body" -- false -- "Play_pln_alm_cop_bod"
	self.blame.civ_hostage = "hint_civ_hostage" -- "Play_pln_alm_cop_sus"
	self.blame.civ_distress = "hint_civ_distress" -- false
	self.blame.civ_body_bag = "hint_civ_body_bag" -- "Play_pln_alm_cop_bag"
	self.blame.civ_gunfire = "hint_civ_gunfire" -- false
	           
	self.blame.civ_drill = "hint_civ_drill" -- "Play_pln_alm_cop_dri"
	self.blame.civ_saw = "hint_civ_saw" -- false
	self.blame.civ_sentry_gun = "hint_civ_sentry_gun" -- false
	self.blame.civ_trip_mine = "hint_civ_trip_mine" -- false
	self.blame.civ_ecm_jammer = "hint_civ_ecm_jammer" -- false
	           
	self.blame.civ_c4 = "hint_civ_c4" -- "Play_pln_alm_any_exp" 								-- attention object
	self.blame.civ_computer = "hint_civ_computer" -- "Play_pln_alm_cop_com" 					-- attention object
	self.blame.civ_glass = "hint_civ_glass" -- "Play_pln_alm_cop_win" 							-- attention object
	self.blame.civ_broken_cam = "hint_civ_broken_cam" -- "Play_pln_alm_cop_win" 				-- attention object
	self.blame.civ_vault = "hint_civ_vault" -- false	 										-- attention object
	self.blame.civ_fire = "hint_civ_fire" -- false 												-- attention object
	self.blame.civ_voting = "hint_civ_voting" -- false 											-- attention object
	self.blame.civ_breaking_entering = "hint_civ_breaking_entering" -- false 					-- attention object
	
	
		-- cop blames you
	self.blame.cop_criminal = "hint_cop_criminal" -- "Play_pln_alm_cop_wea"	-- ?
	self.blame.cop_dead_body = "hint_cop_dead_body" -- false -- "Play_pln_alm_cop_bod"
	self.blame.cop_hostage = "hint_cop_hostage" -- "Play_pln_alm_cop_sus"
	self.blame.cop_distress = "hint_cop_distress" -- false
	self.blame.cop_body_bag = "hint_cop_body_bag" -- "Play_pln_alm_cop_bag"
	self.blame.cop_gunfire = "hint_cop_gunfire" -- false
	
	self.blame.cop_drill = "hint_cop_drill" -- "Play_pln_alm_cop_dri"
	self.blame.cop_saw = "hint_cop_saw" -- false
	self.blame.cop_sentry_gun = "hint_cop_sentry_gun" -- false
	self.blame.cop_trip_mine = "hint_cop_trip_mine" -- false
	self.blame.cop_ecm_jammer = "hint_cop_ecm_jammer" -- false
	
	self.blame.cop_c4 = "hint_cop_c4" -- "Play_pln_alm_any_exp" 								-- attention object
	self.blame.cop_computer = "hint_cop_computer" -- "Play_pln_alm_cop_com" 					-- attention object
	self.blame.cop_glass = "hint_cop_glass" -- "Play_pln_alm_cop_win" 							-- attention object
	self.blame.cop_broken_cam = "hint_cop_broken_cam" -- "Play_pln_alm_cop_win" 				-- attention object
	self.blame.cop_vault = "hint_cop_vault" -- false	 										-- attention object
	self.blame.cop_fire = "hint_cop_fire" -- false 												-- attention object
	...
	self.blame.alarm_pager_bluff_failed = "hint_alarm_pager_bluff_failed" -- false -- u failed to bluff regarding the corpse pager alarm
	self.blame.alarm_pager_not_answered = "hint_alarm_pager_not_answered" -- false -- u did not answer the corpse pager alarm
	self.blame.alarm_pager_hang_up = "hint_alarm_pager_hang_up" -- false -- u hung up during the conversation with HQ
...
function TweakData:set_scale()
	...
	-- SD resolution scale
	-- This should contains tweakable values for scaling/resizing gui components when running the game in SD resolution
	local lang_mods = { [Idstring("german"):key()] = { large = 0.9, small = 1, sd_large = 0.9, sd_small = 0.9, sd_menu_border_multiplier = 0.9,
	...
	lang_mods[Idstring("french"):key()] = { large = 0.9, small = 1, sd_large = 0.9, sd_small = 0.95,
	...
	lang_mods[Idstring("italian"):key()] = { large = 1, small = 1, sd_large = 1, sd_small = 1,
												objectives_text_kern = -0.8,
												kit_desc_large = 0.9,
												sd_w_interact_multiplier = 1.5,
												w_interact_multiplier = 1.35,
											}
	lang_mods[Idstring("spanish"):key()] = { large = 1, small = 1, sd_large = 1, sd_small = 0.9, sd_menu_border_multiplier = 0.85,
												stats_upgrade_kern = -1,
	...
	-- local lang_mod = lang_mods[ lang_key ] or 1
	...
	-- self.sd_scale.objectives_desc_text_kern = objectives_desc_text_kern or self.sd_scale.objectives_text_kern or 0
	...
	--[[if res and res.y <= 601 then
		...
		-- self.scale.objectives_desc_text_kern = objectives_desc_text_kern or self.scale.objectives_text_kern or 0
...
function TweakData:set_menu_scale()
	local lang_mods_def = { [Idstring("german"):key()] = { 	topic_font_size = 0.8,
															challenges_font_size = 1,
															upgrades_font_size = 1,
															mission_end_font_size = 1,
															},
							[Idstring("french"):key()] = { 	topic_font_size = 1,
															challenges_font_size = 1,
															upgrades_font_size = 1,
															mission_end_font_size = 1,
														},
							[Idstring("italian"):key()] = { topic_font_size = 1,
															challenges_font_size = 1,
															upgrades_font_size = 1,
															mission_end_font_size = 0.95,
														},
							[Idstring("spanish"):key()] = { topic_font_size = 0.95,
	...
	local lang_mods = lang_mods_def[ SystemInfo:language():key() ] or { topic_font_size = 1,
																		challenges_font_size = 1,
																		upgrades_font_size = 1,
																		mission_end_font_size = 1}

	local scale_multiplier						= self.scale.default_font_multiplier -- Change this to test scale alot of font sizes in menus
	local small_scale_multiplier				= self.scale.small_font_multiplier
	
	self.menu.default_font 						= "fonts/font_medium_shadow_mf" -- "fonts/font_small_shadow_mf" self.menu.default_font_shadow 
	self.menu.default_font_no_outline			= "fonts/font_medium_noshadow_mf" -- "fonts/font_small_shadow_mf"	
	...
	self.menu.meidum_font_size					= 24 * scale_multiplier-- 20
	...
	--[[
	self.menu.pd2_screens_bg_font	= self.menu.eroded_font
	self.menu.pd2_screens_bg_font_size	= 80
	
	self.menu.pd2_screens_title_font	= self.menu.medium_font_no_outline
	self.menu.pd2_screens_title_font_size	= 44
	
	self.menu.pd2_screens_default_font	= self.menu.default_font_no_outline
	self.menu.pd2_screens_default_font_size	= 24
	
	self.menu.pd2_screens_text_font	= self.menu.default_font_no_outline
	self.menu.pd2_screens_text_font_size	= 20
	
	self.menu.pd2_screens_small_font	= self.menu.small_font_noshadow
	self.menu.pd2_screens_small_font_size	= 14
	]]
	
	
	self.menu.pd2_massive_font = "fonts/font_large_mf" -- "fonts/font_eroded"
	...
	self.menu.default_font_size					= 24 * scale_multiplier-- 20 
	self.menu.default_font_row_item_color		= Color.white -- Color( 1, 0.7, 0.7, 0.7 )
	--self.menu.default_hightlight_row_item_color = Color( 1, 255/255, 168/255, 0)
	self.menu.default_hightlight_row_item_color = Color( 1, 0, 0, 0)
	self.menu.default_menu_background_color		= Color( 1, 83/255, 95/255, 101/255 ) -- Color( 1, 0/255, 255/255, 0/255 )
	self.menu.highlight_background_color_left	= Color( 1, 255/255, 168/255, 0 )
	self.menu.highlight_background_color_right	= Color( 1, 255/255, 168/255, 0 )
	self.menu.default_changeable_text_color		= Color( 255, 77, 198, 255 ) / 255 -- Color( 1, 255/255, 168/255, 0 )
	self.menu.default_disabled_text_color		= Color( 1, 0.5, 0.5, 0.5 )
	self.menu.arrow_available					= Color( 1, 255/255, 168/255, 0 )
	...
	self.menu.main_menu_background_color 	= Color( 1, 0/255, 0/255, 0/255 )
	...
	self.menu.multichoice_font_size			= 24 * scale_multiplier-- 20
	...
	self.menu.upper_saferect_border 		= 64 * self.scale.menu_border_multiplier	-- Y value for upper saferect border lon 
	self.menu.border_pad			 		= 8 * self.scale.menu_border_multiplier		-- Padding used for placing objects near borders
	
	self.menu.kit_description_font_size		= 14 *  self.scale.kit_description_multiplier
	
	-- Load level environment settings
	self.load_level								= {}
	--local t = self.scale.load_briefing_text_h_multiplier
	-- print( "192 * self.scale.briefing_text_h_multiplier", self.scale.briefing_text_h_multiplier, 192, 192 * self.scale.briefing_text_h_multiplier ) 
	self.load_level.briefing_text				= { h = 192 * (self.scale.briefing_text_h_multiplier) }
	self.load_level.upper_saferect_border		= self.menu.upper_saferect_border	-- Y value for upper saferect border lon 
	self.load_level.border_pad					= self.menu.border_pad				-- Padding used for placing objects near borders
	self.load_level.stonecold_small_logo		= "guis/textures/game_small_logo"
	
end

function TweakData:set_hud_values()
	local lang_mods_def = { [Idstring("german"):key()] = { 	
															hint_font_size = 0.9, 
	...
	local lang_mods = lang_mods_def[ SystemInfo:language():key() ] or { hint_font_size = 1, 
																		stats_challenges_font_size = 1,
																		active_objective_title_font_size = 1,
																		present_mid_text_font_size = 1,
	...
	self.hud.medium_font = "fonts/font_medium_mf" -- "fonts/font_small_shadow_mf"
	self.hud.medium_font_noshadow = "fonts/font_medium_mf" -- "fonts/font_small_shadow_mf"
	-- self.hud.medium_font_noshadow			= "fonts/font_univers_530_bold_no_outline" -- "fonts/font_small_shadow_mf"	
	...
	self.hud.prime_color = Color( 1, 255/255, 168/255, 0)
	self.hud.suspicion_color = Color( 1, 0/255, 119/255, 178/255)
	self.hud.detected_color = Color( 1, 255/255, 51/255, 0/255 )
end

-- Called directly from  , need to set these values before any gui tries to access then
