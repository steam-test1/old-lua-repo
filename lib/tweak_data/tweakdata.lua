...
-- CHAT COLORS
	...
	self.chat_colors = { 	Color( self.peer_vector_colors[1]:unpack() ),
...
-- ExperienceManager
	...
	self.experience_manager.difficulty_multiplier = { 1.5, 2.5, 5 } -- This is an addition to the job/stage xp( stage_xp+stage_xp*mul ), hard, overkill, overkill_146
