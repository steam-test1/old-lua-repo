...
-- 	self.nightclub.intro_cues				= { "intro_nightclub01", "intro_nightclub02" }
	...
	self.branchbank_cloaker.intro_event = { "Play_pln_branchbank_random_a_intro_a", "Play_pln_branchbank_gold_a_intro_a", "Play_pln_branchbank_depositbox_a_intro_a", "Play_pln_branchbank_cash_stage1_intro_a" }
	...
	self.arm_cro.outro_event = { "Play_pln_at1_end_01", "Play_pln_at1_end_02", "Play_pln_at1_end_03", "Play_pln_at1_end_01b", "Play_pln_at1_end_02b", "Play_pln_at1_end_03b" }
	...
	self.arm_und.outro_event = { "Play_pln_at1_end_01", "Play_pln_at1_end_02", "Play_pln_at1_end_03", "Play_pln_at1_end_01b", "Play_pln_at1_end_02b", "Play_pln_at1_end_03b" }
	...
	self.arm_bri.outro_event = { "Play_pln_at1_end_01", "Play_pln_at1_end_02", "Play_pln_at1_end_03", "Play_pln_at1_end_01b", "Play_pln_at1_end_02b", "Play_pln_at1_end_03b" }
	...
	self.arm_hcm.outro_event = { "Play_pln_at1_end_01", "Play_pln_at1_end_02", "Play_pln_at1_end_03", "Play_pln_at1_end_01b", "Play_pln_at1_end_02b", "Play_pln_at1_end_03b" }
	...
	self.arm_par.outro_event = { "Play_pln_at1_end_01", "Play_pln_at1_end_02", "Play_pln_at1_end_03", "Play_pln_at1_end_01b", "Play_pln_at1_end_02b", "Play_pln_at1_end_03b" }
	...
	self.arm_fac.outro_event = { "Play_pln_at1_end_01", "Play_pln_at1_end_02", "Play_pln_at1_end_03", "Play_pln_at1_end_01b", "Play_pln_at1_end_02b", "Play_pln_at1_end_03b" }
	...
	self.arm_for.outro_event = { "Play_pln_tr1_end_01", "Play_pln_tr1_end_02" }
	...
	self.arm_for.static_experience = { 4000, 7000, 15000, 25000 }
	...
	self.on_time_1.outro_event = { "Play_pln_watchdogs_new_stage1_end_a", "Play_pln_watchdogs_new_stage1_end_b" }
	
	self.on_time_1.music = "heist"
	self.on_time_1.package = { "packages/level_debug" }
	...
	self.on_time_2.intro_event = { "Play_pln_watchdogs_new_stage2_intro_a", "Play_pln_watchdogs_new_stage2_intro_b" }
	self.on_time_2.outro_event = { "Play_pln_watchdogs_new_stage2_end_a", "Play_pln_watchdogs_new_stage2_end_b" }
	
	self.on_time_2.music = "heist"
	self.on_time_2.package = { "packages/level_debug" }
...
------------------------- PD1 -------------------------
	...
	self._level_index =	{
					...
					"election_day_1", "election_day_2", "election_day_3", "election_day_3_skip1", "election_day_3_skip2",
