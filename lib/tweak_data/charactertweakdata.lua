...
-- HEALTH
	...
	self.gensec.surrender_break_time = { 20, 30 } -- How quickly does the character snap back to combat after surrendering. { min, max }. (sec)
	self.gensec.suppression = presets.suppression.hard
	self.gensec.surrender = presets.surrender.hard
	self.gensec.ecm_vulnerability = 0.9 -- chance of puking when exposed to ecm feedback
	self.gensec.ecm_hurts = { ears = { min_duration = 5, max_duration = 7 } } 					-- what type of hurts ecm feedback can inflict (puking, covering ears ect) and their durations
	self.gensec.weapon_voice = "3"			-- weapon sound, characteristic for unit ( 1 - 3 )
...
-- HEALTH
	...
	self.cop.ecm_vulnerability = 1 -- chance of puking when exposed to ecm feedback
...
-- HEALTH
	...
	self.spooc.dodge_with_grenade.check = function( t, nr_grenades_used )
...
-- HEALTH
	...
	self.shield.weapon.mp9.RELOAD_SPEED = 1.5
	...
	self.shield.weapon.mp9.FALLOFF = {
		{ r=0, acc={0.7, 0.95}, dmg_mul=4, recoil={0.35,0.55}, mode={ 0.2, 2, 4, 10 } },
		{ r=700, acc={0.5, 0.75}, dmg_mul=3, recoil={0.35,0.55}, mode={ 0.2, 2, 4, 10 } },
		{ r=1000, acc={0.45, 0.65}, dmg_mul=2, recoil={0.35,0.55}, mode={ 0.2, 2, 4, 10 } },
		{ r=2000, acc={0.3, 0.5}, dmg_mul=2, recoil={0.35,1.2}, mode={ 2, 5, 6, 4 } },
	...
	self.shield.weapon.c45.RELOAD_SPEED = 1.5
	...
	self.shield.weapon.c45.FALLOFF = {
		...
		{ r=700, acc={0.5, 0.8}, dmg_mul=1.5, recoil={0.35,0.55}, mode={ 1, 0, 0, 0 } },
		{ r=1000, acc={0.4, 0.6}, dmg_mul=1.25, recoil={0.35,0.55}, mode={ 1, 0, 0, 0 } },
...
---- NORMAL ----
	...
	presets.weapon.normal.raging_bull.FALLOFF = {
		{ r=500, acc={0.5, 0.85}, dmg_mul=1.5, recoil={0.8,1.1}, mode={ 1, 0, 0, 0 } },
		{ r=1000, acc={0.375, 0.55}, dmg_mul=1, recoil={0.8,1.1}, mode={ 1, 0, 0, 0 } },
		{ r=2000, acc={0.25, 0.45}, dmg_mul=0.75, recoil={1,1.3}, mode={ 1, 0, 0, 0 } },
		{ r=3000, acc={0.01, 0.35}, dmg_mul=0.5, recoil={1,1.5}, mode={ 1, 0, 0, 0 } }
	}
...
---- EXPERT ----
	...
	presets.weapon.expert.mp5.aim_delay = { 0.0, 0.1 } -- 0.4, 0.5
	...
	presets.weapon.expert.mp5.FALLOFF = {
		{ r=500, acc={0.6, 0.95}, dmg_mul=4.5, recoil={0.1,0.3}, mode={ 0, 3, 3, 1 } },
		{ r=1000, acc={0.4, 0.65}, dmg_mul=4, recoil={0.35,0.5}, mode={ 0, 3, 3, 0 } },
		{ r=2000, acc={0.4, 0.6}, dmg_mul=3.5, recoil={0.35,0.7}, mode={ 0, 3, 3, 0 } },
	...
	presets.weapon.expert.raging_bull = presets.weapon.normal.raging_bull
	...
	presets.weapon.sniper.m4.FALLOFF = {
		{ r=700, acc={0.4, 0.95}, dmg_mul=5, recoil={2,4}, mode={ 1, 0, 0, 0 } },
		{ r=3500, acc={0.1, 0.75}, dmg_mul=5, recoil={3,4}, mode={ 1, 0, 0, 0 } },
		{ r=10000, acc={0, 0.25}, dmg_mul= 2.5, recoil={3,5}, mode={ 1, 0, 0, 0 } }
	}
	...
	presets.move_speed = {	--(cm/sec)
		...
		lightning = {
			stand = {
				...
				run = { hos={ fwd=900, strafe=400, bwd=350 }, cbt={ fwd=800, strafe=380, bwd=320 } }
			},
			crouch = {
				walk = { hos={ fwd=245, strafe=210, bwd=190 }, cbt={ fwd=255, strafe=190, bwd=190 } },
				run = { hos={ fwd=700, strafe=340, bwd=250 }, cbt={ fwd=512, strafe=320, bwd=280 } }
			}
		},
		...
		very_slow = {
			stand = {
				...
				run = { hos={ fwd=144, strafe=140, bwd=113 }, cbt={ fwd=144, strafe=100, bwd=125 } }
			},
			crouch = {
				walk = { hos={ fwd=144, strafe=120, bwd=113 }, cbt={ fwd=144, strafe=120, bwd=113 } },
				run = { hos={ fwd=144, strafe=130, bwd=113 }, cbt={ fwd=144, strafe=100, bwd=125 } }
			}
		},
		...
		slow = {
			stand = {
				walk = { ntl={ fwd=144, strafe=120, bwd=113 }, hos={ fwd=144, strafe=120, bwd=113 }, cbt={ fwd=144, strafe=120, bwd=113 } },
				run = { hos={ fwd=360, strafe=150, bwd=135 }, cbt={ fwd=360, strafe=150, bwd=155 } }
			},
			crouch = {
				walk = { hos={ fwd=144, strafe=120, bwd=113 }, cbt={ fwd=144, strafe=120, bwd=113 } },
				run = { hos={ fwd=360, strafe=140, bwd=150 }, cbt={ fwd=360, strafe=140, bwd=155 } }
			}
		},
		normal = {
			stand = {
...
-- TEAM MEMBERS
	...
	self.sniper.weapon.m4.FALLOFF = {
		{ r=700, acc={0.6, 1}, dmg_mul=7, recoil={3,5}, mode={ 1, 0, 0, 0 } },
		{ r=4000, acc={0.5, 0.9}, dmg_mul=6, recoil={4,5}, mode={ 1, 0, 0, 0 } },
		{ r=10000, acc={0, 0.3}, dmg_mul=3, recoil={4,6}, mode={ 1, 0, 0, 0 } }
	}
...
-- TEAM MEMBERS
	...
	self.sniper.weapon.m4.FALLOFF = {
		{ r=700, acc={0.7, 1}, dmg_mul=8, recoil={3,6}, mode={ 1, 0, 0, 0 } },
		{ r=4000, acc={0.5, 0.95}, dmg_mul=6, recoil={4,6}, mode={ 1, 0, 0, 0 } },
		{ r=10000, acc={0, 0.3}, dmg_mul=3.5, recoil={4,6}, mode={ 1, 0, 0, 0 } }
	}
...
function CharacterTweakData:_set_overkill_145()
	...
	self:_multiply_all_speeds( 1.05, 1.05 ) -- WALK, RUN
...
-- TEAM MEMBERS
	...
	self.sniper.weapon.m4.FALLOFF = {
		{ r=700, acc={0.7, 1}, dmg_mul=10, recoil={3,5}, mode={ 1, 0, 0, 0 } },
		{ r=4000, acc={0.6, 0.95}, dmg_mul=10, recoil={3,5}, mode={ 1, 0, 0, 0 } },
		{ r=10000, acc={0.2, 0.5}, dmg_mul=5, recoil={3,5}, mode={ 1, 0, 0, 0 } }
	}
