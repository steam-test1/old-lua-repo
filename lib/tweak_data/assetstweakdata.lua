...
function AssetsTweakData:init( tweak_data )
	...
	-- self:_init_debug_assets( tweak_data )
end


function AssetsTweakData:_init_empty_asset( tweak_data )
	self.none = {}
	self.none.name_id = nil							-- STRING			localization string_id for asset name
	self.none.unlock_desc_id = nil			-- STRING			localization string id for what this asset will do when unlocked, if this is nil then "menu_asset_unknown_unlock_desc" will be used
	self.none.texture = nil							-- STRING			mission briefing gui texture path
	self.none.stages = nil							-- TABLE			all stages that uses this asset, CAN ALSO BE STRING "all" FOR ALL
	self.none.require_to_unlock = nil		-- STRING			"all", "any"				-- "all" by default
	self.none.visible_if_locked = nil		-- BOOLEAN		still visible if you are unable to unlock it, if locked "menu_briefing_unable_to_unlock" will be used
	self.none.no_mystery = nil					-- BOOLEAN		when true, the asset will not be blacked-out when locked in mission briefing screen.
	self.none.saved_job_lock = nil			-- STRING			checks with the profile
	self.none.job_lock = nil						-- STRING			checks with the job
	self.none.money_lock = nil					-- NUMBER			buy to enable, links to MoneyTweakData		tweak_data.money_manager
	self.none.upgrade_lock = nil				-- TABLE			unlocks from skill		{ category="player", upgrade="additional_assets" }  //this can be any skill if so desired
	self.none.achievment_lock = nil			-- STRING			unlocks from achievment
...
function AssetsTweakData:_init_assets( tweak_data )
	...
	self.safe_escape.stages =
					{
						"framing_frame_1", "framing_frame_2",
	...
	self.safe_escape.upgrade_lock = { category = "player", upgrade = "additional_assets" }
	...
	self.grenade_crate.stages = { "watchdogs_1", "watchdogs_2", "welcome_to_the_jungle_1", "welcome_to_the_jungle_2", "alex_1", "firestarter_1", "firestarter_2", "firestarter_3", "branchbank", "arm_for" }
	...
	-- self.ukrainian_job_tiara.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 1 )
	...
	-- self.ukrainian_job_front.visible_if_locked = true
	-- self.ukrainian_job_front.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 1 )
	...
	-- self.ukrainian_job_metal_detector.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 4 )
	...
	self.watchdogs_1_hatch.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 2 )        ]]
	...
	--self.firestarter_2_ammo.visible_if_locked = true
	--self.firestarter_2_ammo.unlock_desc_id = "menu_asset_ammo_desc"
	--self.firestarter_2_ammo.no_mystery = true
	--self.firestarter_2_ammo.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 2 )
	...
	--self.firestarter_2_health.visible_if_locked = true
	--self.firestarter_2_health.unlock_desc_id = "menu_asset_health_desc"
	--self.firestarter_2_health.no_mystery = true
	--self.firestarter_2_health.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 2 )
	...
	--self.firestarter_3_ammo.visible_if_locked = true
	--self.firestarter_3_ammo.unlock_desc_id = "menu_asset_ammo_desc"
	--self.firestarter_3_ammo.no_mystery = true
	--self.firestarter_3_ammo.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 3 )
	...
	--self.firestarter_3_health.visible_if_locked = true
	--self.firestarter_3_health.unlock_desc_id = "menu_asset_health_desc"
	--self.firestarter_3_health.no_mystery = true
	--self.firestarter_3_health.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 3 )
	...
	--self.firestarter_3_cam.visible_if_locked = true
	--self.firestarter_3_cam.unlock_desc_id = "menu_asset_cam_desc"
	--self.firestarter_3_cam.no_mystery = true
	--self.firestarter_3_cam.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 6 )
	...
	--self.jungle_2_health.visible_if_locked = true
	--self.jungle_2_health.unlock_desc_id = "menu_asset_health_desc"
	--self.jungle_2_health.no_mystery = true
	--self.jungle_2_health.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 2 )
	...
	--self.jungle_1_ammo.visible_if_locked = true
	--self.jungle_1_ammo.unlock_desc_id = "menu_asset_ammo_desc"
	--self.jungle_1_ammo.no_mystery = true
	--self.jungle_1_ammo.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 2 )
	...
	--self.jungle_1_health.visible_if_locked = true
	--self.jungle_1_health.unlock_desc_id = "menu_asset_health_desc"
	--self.jungle_1_health.no_mystery = true
	--self.jungle_1_health.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 2 )
	...
	-- self.branchbank_map_basic.desc_id = "menu_asset_branchbank_blueprint_desc"
	self.branchbank_map_basic.no_mystery = true
	-- self.branchbank_map_basic.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 2 )
	...
	-- self.nightclub_goodmusic.money_lock = tweak_data:get_value( "money_manager", "mission_asset_cost_small", 2 )
	...
	self.arm_for_ammo.stages = { "arm_for", "arm_cro", "arm_und", "arm_par", "arm_fac", "arm_hcm" }
	...
	self.arm_for_health.stages = { "arm_for", "arm_cro", "arm_und", "arm_par", "arm_fac", "arm_hcm" }
