...
function MissionDoorTweakData:init()
	...
	self.atm.devices.ecm = {
										{ align = "a_ecm_hack", unit = Idstring( "units/payday2/props/gen_prop_bank_atm_standing/gen_prop_bank_atm_jammer" ) },
									}
	...
	self.arm_trans.devices.drill = { 
									{ align = "a_drill", unit = Idstring( "units/payday2/equipment/item_door_drill_small/item_door_drill_small" ), can_jam = true, timer = 200 },
								}
