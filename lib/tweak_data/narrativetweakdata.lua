...
-- Value used to curve the chances, fixing the distribution problems experienced earlier
	self.STARS_CURVES = { 1.6, 1.5, 1.5, 1.5, 1.5, 1.5, 1.5, 1.4, 1.3, 1.2 } -- OK
	
	self.JC_CHANCE = 0.01 	-- Chance to get something from forst JC in STARS table
	self.JC_PICKS = 35 		-- Amount of jobs to pick to be displayed to the player. On launch there are 65 variations
...
-----------------
	...
	self.jobs.firestarter.payout = { 70000, 95000, 125000, 200000 }
...
-- PRO
	...
	self.jobs.firestarter_prof.payout = { 80000, 110000, 160000, 250000 }
...
-------------------
	...
	self.jobs.framing_frame.payout = { 60000, 75000, 125000, 185000 }
...
-- PRO
	...
	self.jobs.framing_frame_prof.payout = { 80000, 100000, 150000, 200000 }
...
---------------	
	...
	self.jobs.watchdogs.payout = { 60000, 74000, 125000, 185000 }
...
-- PRO
	...
	self.jobs.watchdogs_prof.payout = { 75000, 85000, 150000, 200000 }
...
---------------
	...
	self.jobs.nightclub.crimenet_callouts = { "vld_nightclub_cnc_01", "vld_nightclub_cnc_02", "vld_nightclub_cnc_03" }
	self.jobs.nightclub.crimenet_videos = { "cn_nightc1", "cn_nightc2", "cn_nightc3" }
	self.jobs.nightclub.payout = { 20000, 22500, 40000, 60000 }
...
-- PRO
	...
	self.jobs.nightclub_prof.payout = { 20000, 40000, 60000, 80000 }
...
------------------
	...
	self.jobs.ukrainian_job.crimenet_callouts = { "vld_ukranian_cnc_01", "vld_ukranian_cnc_02", "vld_ukranian_cnc_03", "vld_ukranian_cnc_04" }
	self.jobs.ukrainian_job.crimenet_videos = { "cn_ukr1", "cn_ukr2", "cn_ukr3" }
	self.jobs.ukrainian_job.payout = { 20000, 21000, 23000, 25000 }
...
-- PRO
	...
	self.jobs.ukrainian_job_prof.payout = { 21000, 24000, 26000, 30000 }
...
-------------------
	...
	self.jobs.jewelry_store.crimenet_callouts = { "pln_jewelrystore_stage1_cnc_01", "pln_jewelrystore_stage1_cnc_02", "pln_jewelrystore_stage1_cnc_03" }
	self.jobs.jewelry_store.crimenet_videos = { "cn_jewel1", "cn_jewel2", "cn_jewel3" }
	self.jobs.jewelry_store.payout = { 6000, 12000, 30000, 50000 }
...
-- PRO	
	...
	self.jobs.jewelry_store_prof.payout = { 10000, 20000, 38000, 50000 }
...
-----------------
	...
	self.jobs.four_stores.crimenet_callouts = { "vld_fourstores_cnc_01", "vld_fourstores_cnc_02", "vld_fourstores_cnc_03" }
	self.jobs.four_stores.crimenet_videos = { "cn_fours1", "cn_fours2", "cn_fours3" }
	self.jobs.four_stores.payout = { 15000, 25000, 40000, 60000 }
...
-- PRO	
	...
	self.jobs.four_stores_prof.payout = { 24000, 38000, 46000, 70000 }
...
------------------
	...
	self.jobs.mallcrasher.crimenet_callouts = { "vld_mallcrashers_cnc_01", "vld_mallcrashers_cnc_02", "vld_mallcrashers_cnc_03" }
	self.jobs.mallcrasher.crimenet_videos = { "cn_mallcrash1", "cn_mallcrash2", "cn_mallcrash3" }
	self.jobs.mallcrasher.payout = { 35000, 40000, 50000, 60000 }
...
-- PRO	
	...
	self.jobs.mallcrasher_prof.payout = { 40000, 46000, 56000, 68000 }
...
-----------------								
	...
	self.jobs.branchbank.payout = { 20000, 30000, 40000, 70000 }
...
-- PRO
	...
	self.jobs.branchbank_prof.payout = { 26000, 40000, 48000, 70000 }
...
------------------
	...
	self.jobs.branchbank_deposit.payout = { 30000, 35000, 44000, 68000 }
...
-- PRO
	...
	self.jobs.branchbank_deposit_prof.payout = { 36000, 40000, 54000, 76000 }
...
---------------									
	...
	self.jobs.branchbank_cash.crimenet_callouts = {  "pln_branchbank_cash_cnc_01", "pln_branchbank_cash_cnc_02", "pln_branchbank_cash_cnc_03", "pln_branchbank_cash_cnc_04", "pln_branchbank_cash_cnc_05", "pln_branchbank_cash_cnc_06", "pln_branchbank_cash_cnc_07"}
	self.jobs.branchbank_cash.crimenet_videos = { "cn_branchbank1", "cn_branchbank2", "cn_branchbank3" }
	self.jobs.branchbank_cash.payout = { 10000, 15000, 40000, 60000 }
...
-- PRO
	...
	self.jobs.branchbank_cash_prof.payout = { 26000, 40000, 44000, 68000 }
...
---------------	
	...
	self.jobs.branchbank_gold.crimenet_callouts = {  "pln_branchbank_gold_cnc_01", "pln_branchbank_gold_cnc_02", "pln_branchbank_gold_cnc_03", "pln_branchbank_gold_cnc_04", "pln_branchbank_gold_cnc_05", "pln_branchbank_gold_cnc_06", "pln_branchbank_gold_cnc_07"}
	self.jobs.branchbank_gold.crimenet_videos = { "cn_branchbank1", "cn_branchbank2", "cn_branchbank3" }
	self.jobs.branchbank_gold.payout = { 20000, 25000, 50000, 75000 }
...
-- PRO
	...
	self.jobs.branchbank_gold_prof.payout = { 26000, 40000, 54000, 76000 }
...
------------------
	...
	self.jobs.election_day.chain			= {
												{ level_id = "election_day_1", type_id = "heist_type_assault", type = "e", mission_filter = { 1,} }, 
												{
													...
													{ level_id = "election_day_3_skip1", type_id = "heist_type_knockover", type = "e", mission_filter = { 1,} },
													{ level_id = "election_day_3_skip2", type_id = "heist_type_knockover", type = "e", mission_filter = { 1,} }
												}
											}
	...
	self.jobs.election_day.payout = { 10000, 20000, 30000, 40000 }
...
-- PRO
	...
	self.jobs.election_day_prof.payout = { 10000, 20000, 30000, 40000 }
...
-- SAFEHOUSE					
	...
	self.jobs.safehouse.chain			= { 
												{ level_id = "safehouse", type_id = "heist_type_assault", type = "d", briefing_id = Global.mission_manager and Global.mission_manager.saved_job_values.playedSafeHouseBefore and "heist_safehouse_briefing_2" or nil },
												
											}
	self.jobs.safehouse.briefing_event = nil
	self.jobs.safehouse.debrief_event = nil
	self.jobs.safehouse.crimenet_callouts = {  }
	-- self.jobs.safehouse.is_safehouse	= true
		
	--[[self.jobs.safehouse_part2				= deep_clone( self.jobs.safehouse )
	self.jobs.safehouse_part2.briefing_id	= "heist_safehouse_briefing_2"]]
	...
	self.jobs.arm_wrapper.job_wrapper = { "arm_cro", "arm_und", "arm_hcm", "arm_par", "arm_fac" }
	self.jobs.arm_wrapper.briefing_event = "pln_at1_brf_01"
	self.jobs.arm_wrapper.crimenet_callouts = { "pln_at1_cnc_01" }
	self.jobs.arm_wrapper.crimenet_videos = { "cn_branchbank1", "cn_branchbank3" }
	self.jobs.arm_wrapper.payout = { 8500, 11000, 30000, 32000 }
	...
	self.jobs.arm_cro.chain = {
												{ level_id = "arm_cro", type_id = "heist_type_assault", type = "d", mission_filter = {4}, briefing_dialog = nil }
											}
	self.jobs.arm_cro.briefing_event = "pln_at1_cbf_01"
	self.jobs.arm_cro.debrief_event = nil
	self.jobs.arm_cro.crimenet_callouts = { "pln_at1_cnc_01_01" }
	self.jobs.arm_cro.crimenet_videos = { "cn_branchbank1", "cn_branchbank3" }
	self.jobs.arm_cro.payout = { 30500, 34000, 50000, 62000 }
	...
	self.jobs.arm_und.chain = {
												{ level_id = "arm_und", type_id = "heist_type_assault", type = "d", mission_filter = {4}, briefing_dialog = nil }
											}
	self.jobs.arm_und.briefing_event = "pln_at1_cbf_01"
	self.jobs.arm_und.debrief_event = nil
	self.jobs.arm_und.crimenet_callouts = { "pln_at1_cnc_05_01" }
	self.jobs.arm_und.crimenet_videos = { "cn_branchbank1", "cn_branchbank3" }
	self.jobs.arm_und.payout = { 27500, 31000, 48000, 53000 }
	...
	self.jobs.arm_bri.chain = {
												{ level_id = "arm_bri", type_id = "heist_type_assault", type = "d", mission_filter = {4}, briefing_dialog = nil }
											}
	self.jobs.arm_bri.briefing_event = "Play_pln_at1_cbf_01"
	self.jobs.arm_bri.debrief_event = nil
	self.jobs.arm_bri.crimenet_callouts = { "pln_at1_cnc_01_01", "pln_at1_cnc_01_02", "pln_at1_cnc_01_03" }
	self.jobs.arm_bri.crimenet_videos = { "cn_branchbank1", "cn_branchbank3" }
	self.jobs.arm_bri.payout = { 28500, 33000, 54000, 60000 }
	...
	self.jobs.arm_hcm.chain = {
												{ level_id = "arm_hcm", type_id = "heist_type_assault", type = "d", mission_filter = {4}, briefing_dialog = nil }
											}
	self.jobs.arm_hcm.briefing_event = "pln_at1_cbf_01"
	self.jobs.arm_hcm.debrief_event = nil
	self.jobs.arm_hcm.crimenet_callouts = { "pln_at1_cnc_02_01" }
	self.jobs.arm_hcm.crimenet_videos = { "cn_branchbank1", "cn_branchbank3" }
	self.jobs.arm_hcm.payout = { 26500, 31000, 50000, 52000 }
	...
	self.jobs.arm_par.chain = {
												{ level_id = "arm_par", type_id = "heist_type_assault", type = "d", mission_filter = {4}, briefing_dialog = nil }
											}
	self.jobs.arm_par.briefing_event = "pln_at1_cbf_01"
	self.jobs.arm_par.debrief_event = nil
	self.jobs.arm_par.crimenet_callouts = { "pln_at1_cnc_04_01" }
	self.jobs.arm_par.crimenet_videos = { "cn_branchbank1", "cn_branchbank3" }
	self.jobs.arm_par.payout = { 28500, 31000, 40000, 43000 }
	...
	self.jobs.arm_fac.chain = {
												{ level_id = "arm_fac", type_id = "heist_type_assault", type = "d", mission_filter = {4}, briefing_dialog = nil }
											}
	self.jobs.arm_fac.briefing_event = "pln_at1_cbf_01"
	self.jobs.arm_fac.debrief_event = nil
	self.jobs.arm_fac.crimenet_callouts = { "pln_at1_cnc_03_01" }
	self.jobs.arm_fac.crimenet_videos = { "cn_branchbank1", "cn_branchbank3" }
	self.jobs.arm_fac.payout = { 22500, 29000, 40000, 42000 }
	...
	self.jobs.arm_for.chain = {
												{ level_id = "arm_for", type_id = "heist_type_assault", type = "d", mission_filter = {4}, briefing_dialog = nil }
											}
	self.jobs.arm_for.briefing_event = "pln_at1_brf_01"
	self.jobs.arm_for.debrief_event = nil
	self.jobs.arm_for.crimenet_callouts = { "pln_at1_cnc_01_01", "pln_at1_cnc_01_02", "pln_at1_cnc_01_03" }
	self.jobs.arm_for.crimenet_videos = { "cn_jewel1", "cn_jewel2", "cn_jewel1" }
	self.jobs.arm_for.payout = { 40, 56, 80, 100 }
	...
	self.jobs.family_prof.payout = { 40000, 44000, 62000, 70000 }
	...
	self.jobs.on_time.chain = {
											{ level_id = "on_time_1", type_id = "heist_type_survive", type = "d" },
											{ level_id = "on_time_2", type_id = "heist_type_survive", type = "d" }
										}
	self.jobs.on_time.briefing_event = "hct_watchdogs_brf_speak"
	self.jobs.on_time.debrief_event = "hct_watchdogs_debrief"
	self.jobs.on_time.crimenet_callouts = { "hct_watchdogs_cnc_01", "hct_watchdogs_cnc_02", "hct_watchdogs_cnc_03" }
	self.jobs.on_time.crimenet_videos = { "cn_watchdog1", "cn_watchdog2", "cn_watchdog3" }
	self.jobs.on_time.payout = { 20000, 24000, 35000, 50000 }
	
	
	self.jobs.on_time_prof = deep_clone( self.jobs.on_time )
	self.jobs.on_time_prof.jc = 60
	self.jobs.on_time_prof.professional = true
	self.jobs.on_time_prof.payout = { 30000, 35000, 40000, 65000 }
	...
	self.jobs.big.crimenet_callouts = { "pln_fj1_cnc_01_01", "pln_fj1_cnc_01_02", "pln_fj1_cnc_01_03" }
	self.jobs.big.crimenet_videos = { "cn_jewel1", "cn_jewel2", "cn_jewel3" }
	self.jobs.big.payout = { 37000, 43000, 60000, 70000 }
	...
	self.jobs.big_prof.payout = { 40000, 44000, 62000, 70000 }
	...
	self.jobs.roberts.payout = { 26000, 37000, 81000, 101000 }
	...
	self.jobs.roberts_prof.payout = { 40000, 44000, 62000, 70000 }
	...
	self.jobs.haunted.crimenet_videos = { "cn_branchbank1", "cn_branchbank2", "cn_branchbank3" }
	self.jobs.haunted.payout = { 10000, 20000, 30000, 40000 }
	...
	self.jobs.monolithic.chain = {
												{ level_id = "monolithic_1", type_id = "heist_type_assault", type = "d" }
											}
	self.jobs.monolithic.briefing_event = nil
	self.jobs.monolithic.debrief_event = nil
	
	self.jobs.monolithic.crimenet_videos = { "cn_branchbank1", "cn_branchbank2", "cn_branchbank3" }
	self.jobs.monolithic.payout = { 10000, 20000, 30000, 40000 }
	...
	self.jobs.monolithic_prof.payout = { 10000, 20000, 30000, 40000 }
	...
	self.jobs.blueharvest.chain = {
												{ level_id = "blueharvest_2", type_id = "heist_type_assault", type = "d" }
											}
	self.jobs.blueharvest.briefing_event = nil
	self.jobs.blueharvest.debrief_event = nil
	
	self.jobs.blueharvest.crimenet_videos = { "cn_branchbank1", "cn_branchbank2", "cn_branchbank3" }
	self.jobs.blueharvest.payout = { 10000, 20000, 30000, 40000 }
	...
	self.jobs.blueharvest_prof.payout = { 10000, 20000, 30000, 40000 }
