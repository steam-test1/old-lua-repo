...
-----------------
	...
	self.jobs.firestarter.payout = { 10000, 12500, 20000, 25000 }
...
-- PRO
	...
	self.jobs.firestarter_prof.payout = { 10000, 20000, 30000, 40000 }
...
----------	
	...
	self.jobs.alex.payout = { 1000, 1500, 3000, 5000 }
...
-------------
	...
	self.jobs.welcome_to_the_jungle.payout = { 60000, 80000, 100000, 200000 }
...
-- PRO
	...
	self.jobs.welcome_to_the_jungle_prof.payout = { 70000, 90000, 120000, 240000 }
...
-------------------
	...
	self.jobs.framing_frame.payout = { 10000, 12500, 17500, 25000 }
...
-- PRO
	...
	self.jobs.framing_frame_prof.payout = { 10000, 20000, 30000, 40000 }
...
---------------	
	...
	self.jobs.watchdogs.payout = { 20000, 24000, 35000, 50000 }
...
-- PRO
	...
	self.jobs.watchdogs_prof.payout = { 30000, 35000, 40000, 65000 }
...
---------------
	...
	self.jobs.nightclub.payout = { 10000, 12500, 20000, 30000 }
...
-- PRO
	...
	self.jobs.nightclub_prof.payout = { 10000, 20000, 30000, 40000 }
...
------------------
	...
	self.jobs.ukrainian_job.payout = { 500, 1000, 2000, 3000 }
...
-- PRO
	...
	self.jobs.ukrainian_job_prof.payout = { 500, 2000, 3000, 5000 }
...
-------------------
	...
	self.jobs.jewelry_store.payout = { 1500, 3000, 4500, 5000 }
...
-- PRO	
	...
	self.jobs.jewelry_store_prof.payout = { 3000, 5000, 9000, 15000 }
...
-----------------
	...
	self.jobs.four_stores.payout = { 4000, 6000, 8000, 12000 }
...
-- PRO	
	...
	self.jobs.four_stores_prof.payout = { 7000, 9000, 13000, 20000 }
...
------------------
	...
	self.jobs.mallcrasher.payout = { 7500, 10000, 15000, 20000 }
...
-- PRO	
	...
	self.jobs.mallcrasher_prof.payout = { 10000, 13000, 18000, 24000 }
...
-----------------								
	...
	self.jobs.branchbank.payout = { 10000, 15000, 20000, 35000 }
...
-- PRO
	...
	self.jobs.branchbank_prof.payout = { 13000, 20000, 24000, 35000 }
...
------------------
	...
	self.jobs.branchbank_deposit.payout = { 10000, 12500, 22000, 34000 }
...
-- PRO
	...
	self.jobs.branchbank_deposit_prof.payout = { 13000, 20000, 26000, 38000 }
...
---------------									
	...
	self.jobs.branchbank_cash.payout = { 5000, 7500, 20000, 30000 }
...
-- PRO
	...
	self.jobs.branchbank_cash_prof.payout = { 13000, 20000, 24000, 34000 }
...
---------------	
	...
	self.jobs.branchbank_gold.payout = { 10000, 12500, 25000, 37500 }
...
-- PRO
	...
	self.jobs.branchbank_gold_prof.payout = { 13000, 20000, 26000, 38000 }
...
-- SAFEHOUSE					
	...
	self.jobs.escape_chain_test_prof.professional = true]]
  	...
  	self.jobs.arm_wrapper.job_wrapper = { "arm_cro", "arm_und", "arm_bri", "arm_hcm", "arm_par", "arm_fac" }

  	self.jobs.arm_wrapper.crimenet_callouts = {"pln_branchbank_random_cnc_01", "pln_branchbank_random_cnc_02", "pln_branchbank_random_cnc_03", "pln_branchbank_random_cnc_04", "pln_branchbank_random_cnc_05", "pln_branchbank_random_cnc_06"}
  	...
  	self.jobs.arm_cro.crimenet_callouts = {"pln_branchbank_random_cnc_01", "pln_branchbank_random_cnc_02", "pln_branchbank_random_cnc_03", "pln_branchbank_random_cnc_04", "pln_branchbank_random_cnc_05", "pln_branchbank_random_cnc_06"}
  	...
  	self.jobs.arm_und.crimenet_callouts = {"pln_branchbank_random_cnc_01", "pln_branchbank_random_cnc_02", "pln_branchbank_random_cnc_03", "pln_branchbank_random_cnc_04", "pln_branchbank_random_cnc_05", "pln_branchbank_random_cnc_06"}
  	...
  	self.jobs.arm_bri.crimenet_callouts = {"pln_branchbank_random_cnc_01", "pln_branchbank_random_cnc_02", "pln_branchbank_random_cnc_03", "pln_branchbank_random_cnc_04", "pln_branchbank_random_cnc_05", "pln_branchbank_random_cnc_06"}
  	...
  	self.jobs.arm_hcm.crimenet_callouts = {"pln_branchbank_random_cnc_01", "pln_branchbank_random_cnc_02", "pln_branchbank_random_cnc_03", "pln_branchbank_random_cnc_04", "pln_branchbank_random_cnc_05", "pln_branchbank_random_cnc_06"}
  	...
  	self.jobs.arm_par.crimenet_callouts = {"pln_branchbank_random_cnc_01", "pln_branchbank_random_cnc_02", "pln_branchbank_random_cnc_03", "pln_branchbank_random_cnc_04", "pln_branchbank_random_cnc_05", "pln_branchbank_random_cnc_06"}
  	...
  	self.jobs.arm_fac.crimenet_callouts = {"pln_branchbank_random_cnc_01", "pln_branchbank_random_cnc_02", "pln_branchbank_random_cnc_03", "pln_branchbank_random_cnc_04", "pln_branchbank_random_cnc_05", "pln_branchbank_random_cnc_06"}
	...
	self.jobs.family.payout = { 8500, 11000, 30000, 32000 }
	...
	self.jobs.family_prof.payout = { 10000, 12000, 32000, 35000 }
...
-- TEST JOB FOR MR PATRICK --
	...
	self._jobs_index = {			 "welcome_to_the_jungle_prof",
						 "framing_frame",
						 "framing_frame_prof",
						 "watchdogs",
						 "watchdogs_prof",
