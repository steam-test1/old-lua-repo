...
function InteractionTweakData:init()
	...
	self.requires_ecm_jammer.contour = "interactable_icon"
	self.requires_ecm_jammer.text_id = "hud_int_use_ecm_jammer"
	self.requires_ecm_jammer.required_deployable = "ecm_jammer"
	self.requires_ecm_jammer.deployable_consume = true
	self.requires_ecm_jammer.timer = 4
	self.requires_ecm_jammer.sound_start = "bar_c4_apply"
	self.requires_ecm_jammer.sound_interupt = "bar_c4_apply_cancel"
	self.requires_ecm_jammer.sound_done = "bar_c4_apply_finished"
	self.requires_ecm_jammer.axis = "y"
	self.requires_ecm_jammer.action_text_id = "hud_action_placing_ecm_jammer"
	self.requires_ecm_jammer.requires_upgrade = {
		category = "ecm_jammer",
	...
	self.key.text_id = "hud_int_equipment_keycard"
	self.key.equipment_text_id = "hud_int_equipment_no_keycard"
	self.key.special_equipment = "bank_manager_key"
	self.key.equipment_consume = true
	self.key.axis = "x"
	self.key.interact_distance = 100
	self.numpad = {}
	...
	self.invisible_interaction_searching.icon = "interactable_icon"
