...
function BlackMarketTweakData:init( tweak_data )
	...
	self.clothing.jacket1 = {}
	self.clothing.jacket1.name_id = "bm_c_jacket1"
	self.clothing.jacket1.objects = { "g_jacket_01" }
	self.clothing.jacket1.type = "upper_body"
	
	self.clothing.jacket2 = {}
	self.clothing.jacket2.name_id = "bm_c_jacket2"
	self.clothing.jacket2.objects = { "g_jacket_02" }
	self.clothing.jacket2.type = "upper_body"
	
	self.clothing.jacket3 = {}
	self.clothing.jacket3.name_id = "bm_c_jacket3"
	self.clothing.jacket3.objects = { "g_jacket_03" }
	self.clothing.jacket3.type = "upper_body"
	
	self.clothing.jacket4 = {}
	self.clothing.jacket4.name_id = "bm_c_jacket4"
	self.clothing.jacket4.objects = { "g_jacket_04" }
	self.clothing.jacket4.type = "upper_body"
	
	-- self.lower_bodies = {}
	
	self.clothing.trousers1 = {}
	self.clothing.trousers1.name_id = "bm_c_trousers1"
	self.clothing.trousers1.objects = { "g_trousers_01" }
	self.clothing.trousers1.type = "lower_body"
	
	self.clothing.trousers2 = {}
	self.clothing.trousers2.name_id = "bm_c_trousers2"
	self.clothing.trousers2.objects = { "g_trousers_02" }
	self.clothing.trousers2.type = "lower_body"
	
	self.clothing.trousers3 = {}
	self.clothing.trousers3.name_id = "bm_c_trousers3"
	self.clothing.trousers3.objects = { "g_trousers_03" }
	self.clothing.trousers3.type = "lower_body"
	
	self.clothing.trousers4 = {}
	self.clothing.trousers4.name_id = "bm_c_trousers4"
	self.clothing.trousers4.objects = { "g_trousers_04" }
	self.clothing.trousers4.type = "lower_body"]]
...
function BlackMarketTweakData:print_missing_strings( skip_print_id )
	if Application:production_build() then
		...
		local ignore_desc = { "xp", "cash", "weapon_mods" }
...
function BlackMarketTweakData:_add_desc_from_name_macro( tweak_data )
	for id, data in pairs( tweak_data ) do
		...
		if not data.name_id then
			-- Application:error( "BlackMarketTweakData: No name_id for entry ", id, inspect(data) )
		end
	end
end
...
function BlackMarketTweakData:_init_weapon_mods( tweak_data )
	-- Created from data in tweak_data.weapon.factory.parts
	self.weapon_mods = {}
...
function BlackMarketTweakData:_init_masks()
	self.masks = {}
	-- self.masks._global_value = true			-- if the item type uses global_value, ( normal, superior, exceptional, infamous ), ie RPG item quality ( normal, magic, rare, unique, etc. )
	...
	self.masks.skull = {}														
	self.masks.skull.unit = "units/payday2/masks/msk_skull/msk_skull"									-- preorder
	self.masks.skull.name_id = "bm_msk_skull"
	self.masks.skull.pcs = {10, 20, 30, 40}
	...
	self.masks.wolf_clean.unit = "units/payday2/masks/msk_wolf_clean/msk_wolf_clean"					-- crew	clean
	self.masks.wolf_clean.name_id = "bm_msk_wolf_clean"
	self.masks.wolf_clean.pcs = {10, 20, 30, 40}
	...
	self.masks.hoxton_clean.unit = "units/payday2/masks/msk_hoxton_clean/msk_hoxton_clean"				-- crew	clean
	self.masks.hoxton_clean.name_id = "bm_msk_hoxton_clean"
	self.masks.hoxton_clean.pcs = {10, 20, 30, 40} 
	...
	self.masks.dallas_clean.unit = "units/payday2/masks/msk_dallas_clean/msk_dallas_clean"				-- crew	clean
	self.masks.dallas_clean.name_id = "bm_msk_dallas_clean"
	self.masks.dallas_clean.pcs = {10, 20, 30, 40}
	...
	self.masks.chains_clean.unit = "units/payday2/masks/msk_chains_clean/msk_chains_clean"				-- crew	clean
	self.masks.chains_clean.name_id = "bm_msk_chains_clean"
	self.masks.chains_clean.pcs = {10, 20, 30, 40}
	...
	self.masks.grin = {}
	self.masks.grin.unit = "units/payday2/masks/msk_grin/msk_grin"    													-- unique	infamous
	self.masks.grin.name_id = "bm_msk_grin"
	self.masks.grin.pcs = {10, 20, 30, 40}
	...
	self.masks.anonymous.unit = "units/payday2/masks/msk_anonymous/msk_anonymous"    									-- unique	infamous
	self.masks.anonymous.name_id = "bm_msk_anonymous"
	self.masks.anonymous.pcs = {10, 20, 30, 40}
	...
	self.masks.dillinger_death_mask.unit = "units/payday2/masks/msk_dillinger_death_mask/msk_dillinger_death_mask"		-- unique	infamous
	self.masks.dillinger_death_mask.name_id = "bm_msk_dillinger_death_mask"
	self.masks.dillinger_death_mask.pcs = {10, 20, 30, 40}
	...
	self.masks.alienware.unit = "units/payday2/masks/msk_alienware/msk_alienware"										-- unique
	self.masks.alienware.name_id = "bm_msk_alienware"
	self.masks.alienware.pcs = {10, 20, 30, 40}
	self.masks.alienware.value = 3
	self.masks.alienware.statistics = true
	
	self.masks.greek_tragedy = {}
	self.masks.greek_tragedy.unit = "units/payday2/masks/msk_greek_tragedy/msk_greek_tragedy"							-- unique
	self.masks.greek_tragedy.name_id = "bm_msk_greek_tragedy"
	self.masks.greek_tragedy.pcs = {10, 20, 30, 40}
	self.masks.greek_tragedy.value = 7
	self.masks.greek_tragedy.qlvl = 0
	self.masks.greek_tragedy.statistics = true
	
	self.masks.jaw = {}
	self.masks.jaw.unit = "units/payday2/masks/msk_jaw/msk_jaw"															-- unique
	self.masks.jaw.name_id = "bm_msk_jaw"
	self.masks.jaw.pcs = {10, 20, 30, 40}
	self.masks.jaw.value = 4
	self.masks.jaw.statistics = true
	
	self.masks.hockey = {}
	self.masks.hockey.unit = "units/payday2/masks/msk_hockey_a/msk_hockey_a_mask"										-- unique
	self.masks.hockey.name_id = "bm_msk_hockey"
	self.masks.hockey.pcs = {10, 20, 30, 40}
	self.masks.hockey.value = 5
	self.masks.hockey.statistics = true
	
	self.masks.troll = {}
	self.masks.troll.unit = "units/payday2/masks/msk_troll/msk_troll"													-- unique
	self.masks.troll.name_id = "bm_msk_troll"
	self.masks.troll.pcs = {10, 20, 30, 40}
	self.masks.troll.value = 3
	self.masks.troll.statistics = true
	
	self.masks.gagball = {}
	self.masks.gagball.unit = "units/payday2/masks/msk_gagball/msk_gagball"						-- Sadist Sex
	self.masks.gagball.name_id = "bm_msk_gagball"
	self.masks.gagball.pcs = {10, 20, 30, 40}	
	self.masks.gagball.value = 4
	self.masks.gagball.statistics = true
	
	self.masks.tounge = {}
	self.masks.tounge.unit = "units/payday2/masks/msk_tounge/msk_tounge"						-- Sadist Sex
	self.masks.tounge.name_id = "bm_msk_tounge"
	self.masks.tounge.pcs = {10, 20, 30, 40}	
	self.masks.tounge.value = 2
	self.masks.tounge.statistics = true
	
	self.masks.zipper = {}
	self.masks.zipper.unit = "units/payday2/masks/msk_zipper/msk_zipper"						-- Sadist Sex
	self.masks.zipper.name_id = "bm_msk_zipper"
	self.masks.zipper.pcs = {10, 20, 30, 40}
	self.masks.zipper.value = 5
	self.masks.zipper.statistics = true
	
	self.masks.biglips = {}
	self.masks.biglips.unit = "units/payday2/masks/msk_biglips/msk_biglips"						-- Clowns
	self.masks.biglips.name_id = "bm_msk_biglips"
	self.masks.biglips.pcs = {10, 20, 30, 40}			                                    
	self.masks.biglips.value = 3
	self.masks.biglips.statistics = true
	
	self.masks.clowncry = {}
	self.masks.clowncry.unit = "units/payday2/masks/msk_clowncry/msk_clowncry"					-- Clowns
	self.masks.clowncry.name_id = "bm_msk_clowncry"
	self.masks.clowncry.pcs = {10, 20, 30, 40}
	self.masks.clowncry.value = 4
	self.masks.clowncry.statistics = true
	
	self.masks.mr_sinister = {}
	self.masks.mr_sinister.unit = "units/payday2/masks/msk_mr_sinister/msk_mr_sinister"			-- Clowns
	self.masks.mr_sinister.name_id = "bm_msk_mr_sinister"
	self.masks.mr_sinister.pcs = {10, 20, 30, 40}
	self.masks.mr_sinister.value = 5
	self.masks.mr_sinister.statistics = true
	
	self.masks.clown_56 = {}
	self.masks.clown_56.unit = "units/payday2/masks/msk_clown_56/msk_clown_56"					-- Clowns
	self.masks.clown_56.name_id = "bm_msk_clown_56"
	self.masks.clown_56.pcs = {10, 20, 30, 40}
	self.masks.clown_56.value = 3
	self.masks.clown_56.statistics = true
	
	self.masks.dripper = {}
	self.masks.dripper.unit = "units/payday2/masks/msk_dripper/msk_dripper"						-- Clowns
	self.masks.dripper.name_id = "bm_msk_dripper"				-- clown dripping face
	self.masks.dripper.pcs = {10, 20, 30, 40}
	self.masks.dripper.value = 8
	self.masks.dripper.qlvl = 0
	self.masks.dripper.statistics = true
	
	self.masks.buha = {}
	self.masks.buha.unit = "units/payday2/masks/msk_buha/msk_buha"								--  Clowns
	self.masks.buha.name_id = "bm_msk_buha"
	self.masks.buha.pcs = {10, 20, 30, 40}
	self.masks.buha.value = 5
	self.masks.buha.statistics = true
	
	self.masks.shogun = {}
	self.masks.shogun.unit = "units/payday2/masks/msk_shogun/msk_shogun"						--  japan
	self.masks.shogun.name_id = "bm_msk_shogun"
	self.masks.shogun.pcs = {10, 20, 30, 40}	
	self.masks.shogun.value = 6
	self.masks.shogun.statistics = true
	
	self.masks.oni = {}
	self.masks.oni.unit = "units/payday2/masks/msk_oni/msk_oni"									-- japan
	self.masks.oni.name_id = "bm_msk_oni"
	self.masks.oni.pcs = {10, 20, 30, 40}
	self.masks.oni.value = 4
	self.masks.oni.statistics = true
	
	self.masks.monkeybiss = {}
	self.masks.monkeybiss.unit = "units/payday2/masks/msk_monkeybiss/msk_monkeybiss"			--  animal
	self.masks.monkeybiss.name_id = "bm_msk_monkeybiss"
	self.masks.monkeybiss.pcs = {10, 20, 30, 40}
	self.masks.monkeybiss.value = 5
	self.masks.monkeybiss.statistics = true
	
	self.masks.babyrhino = {}
	self.masks.babyrhino.unit = "units/payday2/masks/msk_babyrhino/msk_babyrhino"				--  animal
	self.masks.babyrhino.name_id = "bm_msk_babyrhino"
	self.masks.babyrhino.pcs = {10, 20, 30, 40}	
	self.masks.babyrhino.value = 3
	self.masks.babyrhino.statistics = true
	
	self.masks.hog = {}
	self.masks.hog.unit = "units/payday2/masks/msk_hog/msk_hog"									-- 	animal
	self.masks.hog.name_id = "bm_msk_hog"
	self.masks.hog.pcs = {10, 20, 30, 40}
	self.masks.hog.value = 3
	self.masks.hog.qlvl = 0
	self.masks.hog.statistics = true
	
	self.masks.outlandish_a = {}
	self.masks.outlandish_a.unit = "units/payday2/masks/msk_outlandish_a/msk_outlandish_a"		-- industrial
	self.masks.outlandish_a.name_id = "bm_msk_outlandish_a"		-- clean army of 2 mask
	self.masks.outlandish_a.pcs = {10, 20, 30, 40}
	self.masks.outlandish_a.value = 2
	self.masks.outlandish_a.statistics = true
	
	self.masks.outlandish_b = {}
	self.masks.outlandish_b.unit = "units/payday2/masks/msk_outlandish_b/msk_outlandish_b"		-- industrial
	self.masks.outlandish_b.name_id = "bm_msk_outlandish_b"		-- bumps
	self.masks.outlandish_b.pcs = {10, 20, 30, 40}
	self.masks.outlandish_b.value = 3
	self.masks.outlandish_b.statistics = true
	
	self.masks.outlandish_c = {}
	self.masks.outlandish_c.unit = "units/payday2/masks/msk_outlandish_c/msk_outlandish_c"		-- industrial
	self.masks.outlandish_c.name_id = "bm_msk_outlandish_c"		-- perfect stranger with nose
	self.masks.outlandish_c.pcs = {10, 20, 30, 40}
	self.masks.outlandish_c.value = 4
	self.masks.outlandish_c.statistics = true
	
	self.masks.bullet = {}
	self.masks.bullet.unit = "units/payday2/masks/msk_bullet/msk_bullet"						-- industrial
	self.masks.bullet.name_id = "bm_msk_bullet"
	self.masks.bullet.pcs = {10, 20, 30, 40}
	self.masks.bullet.value = 3
	self.masks.bullet.statistics = true

	self.masks.shrunken = {}
	self.masks.shrunken.unit = "units/payday2/masks/msk_shrunken/msk_shrunken"							-- undead
	self.masks.shrunken.name_id = "bm_msk_shrunken"
	self.masks.shrunken.pcs = {10, 20, 30, 40}
	self.masks.shrunken.value = 3
	self.masks.shrunken.statistics = true
	
	self.masks.brainiack = {}
	self.masks.brainiack.unit = "units/payday2/masks/msk_brainiack/msk_brainiack"    					-- undead
	self.masks.brainiack.name_id = "bm_msk_brainiack"
	self.masks.brainiack.pcs = {10, 20, 30, 40}
	self.masks.brainiack.value = 6
	self.masks.brainiack.statistics = true
	
	self.masks.zombie = {}
	self.masks.zombie.unit = "units/payday2/masks/msk_zombie/msk_zombie"								-- undead
	self.masks.zombie.name_id = "bm_msk_zombie"
	self.masks.zombie.pcs = {10, 20, 30, 40}
	self.masks.zombie.value = 3
	self.masks.zombie.statistics = true
	
	self.masks.scarecrow = {}
	self.masks.scarecrow.unit = "units/payday2/masks/msk_scarecrow/msk_scarecrow"						-- undead
	self.masks.scarecrow.name_id = "bm_msk_scarecrow"
	self.masks.scarecrow.pcs = {10, 20, 30, 40}
	self.masks.scarecrow.value = 7
	self.masks.scarecrow.qlvl = 0
	self.masks.scarecrow.statistics = true
	
	self.masks.mummy = {}
	self.masks.mummy.unit = "units/payday2/masks/msk_mummy/msk_mummy"									-- undead
	self.masks.mummy.name_id = "bm_msk_mummy"
	self.masks.mummy.pcs = {10, 20, 30, 40}
	self.masks.mummy.value = 3
	self.masks.mummy.statistics = true
	
	self.masks.vampire = {}
	self.masks.vampire.unit = "units/payday2/masks/msk_vampire/msk_vampire"								-- undead
	self.masks.vampire.name_id = "bm_msk_vampire"
	self.masks.vampire.pcs = {10, 20, 30, 40}
	self.masks.vampire.value = 2
	self.masks.vampire.statistics = true
	
	self.masks.day_of_the_dead = {}
	self.masks.day_of_the_dead.unit = "units/payday2/masks/msk_day_of_the_dead/msk_day_of_the_dead"		-- undead
	self.masks.day_of_the_dead.name_id = "bm_msk_day_of_the_dead"
	self.masks.day_of_the_dead.pcs = {10, 20, 30, 40}
	...
	self.masks.dawn_of_the_dead.unit = "units/payday2/masks/msk_dawn_of_the_dead/msk_dawn_of_the_dead"  -- undead
	self.masks.dawn_of_the_dead.name_id = "bm_msk_dawn_of_the_dead"
	self.masks.dawn_of_the_dead.pcs = {10, 20, 30, 40}
	self.masks.dawn_of_the_dead.value = 2
	self.masks.dawn_of_the_dead.statistics = true
	
	self.masks.demon = {}
	self.masks.demon.unit = "units/payday2/masks/msk_demon/msk_demon"									-- demon
	self.masks.demon.name_id = "bm_msk_demon"
	self.masks.demon.pcs = {10, 20, 30, 40}
	self.masks.demon.value = 10
	self.masks.demon.qlvl = 0
	self.masks.demon.statistics = true

	self.masks.stonekisses = {}
	self.masks.stonekisses.unit = "units/payday2/masks/msk_stonekisses/msk_stonekisses"					-- demon
	self.masks.stonekisses.name_id = "bm_msk_stonekisses"
	self.masks.stonekisses.pcs = {10, 20, 30, 40}
	self.masks.stonekisses.value = 4
	self.masks.stonekisses.statistics = true
	
	self.masks.demonictender = {}
	self.masks.demonictender.unit = "units/payday2/masks/msk_demonictender/msk_demonictender" 			-- demon
	...
	self.masks.kawaii.pcs = {10, 20, 30, 40}
	...
	self.masks.irondoom.pcs = {10, 20, 30, 40}
	...
	self.masks.rubber_male.pcs = {10, 20, 30, 40}
	...
	self.masks.heat.pcs = { 10, 20, 30, 40 }
	...
	self.masks.bear.pcs = {10, 20, 30, 40}
	...
	self.masks.clinton.pcs = {10, 20, 30, 40}
	...
	self.masks.bush.pcs = {10, 20, 30, 40}
	...
	self.masks.obama.pcs = {10, 20, 30, 40}
	...
	self.masks.nixon.pcs = {10, 20, 30, 40}
	...
	self.masks.goat.pcs = {10, 20, 30, 40}
	...
	self.masks.panda.pcs = {10, 20, 30, 40}
	...
	self.masks.pitbull.pcs = {10, 20, 30, 40}
	...
	self.masks.eagle.pcs = {10, 20, 30, 40}
	...
	self.masks.santa_happy.pcs = {10, 20, 30, 40}
	...
	self.masks.santa_mad.pcs = {10, 20, 30, 40}
	...
	self.masks.santa_drunk.pcs = {10, 20, 30, 40}
	...
	self.masks.santa_surprise.pcs = {10, 20, 30, 40}
	...
	if SystemInfo:platform() == Idstring( "PS3" ) then
		...
		self.masks.sweettooth.pcs = {10, 20, 30, 40}
...
function BlackMarketTweakData:_init_characters()
	...
	self.characters.locked.dallas = { sequence = "var_mtr_dallas" }
	self.characters.locked.wolf = { sequence = "var_mtr_wolf" }
	self.characters.locked.hoxton = { sequence = "var_mtr_hoxton" }
	self.characters.locked.chains = { sequence = "var_mtr_chains" }
	...
	--[[self.characters.npc_criminal_casual_1_var01 = {}
	self.characters.npc_criminal_casual_1_var01.fps_unit = "units/multiplayer/mp_fps_mover/mp_fps_mover_casual"
	self.characters.npc_criminal_casual_1_var01.npc_unit = "units/payday2/characters/npc_criminal_casual_1/npc_criminal_casual_1"
	self.characters.npc_criminal_casual_1_var01.menu_unit = "units/payday2/characters/npc_criminal_casual_1/npc_criminal_casual_1_menu"
	self.characters.npc_criminal_casual_1_var01.sequence = "var_material_01"
	self.characters.npc_criminal_casual_1_var01.name_id = "bm_casual_1_var01"
	
	self.characters.npc_criminal_casual_1_var02 = {}
	self.characters.npc_criminal_casual_1_var02.fps_unit = "units/multiplayer/mp_fps_mover/mp_fps_mover_casual"
	self.characters.npc_criminal_casual_1_var02.npc_unit = "units/payday2/characters/npc_criminal_casual_1/npc_criminal_casual_1"
	self.characters.npc_criminal_casual_1_var02.menu_unit = "units/payday2/characters/npc_criminal_casual_1/npc_criminal_casual_1_menu"
	self.characters.npc_criminal_casual_1_var02.sequence = "var_material_02"
	self.characters.npc_criminal_casual_1_var02.name_id = "bm_casual_1_var02"
	
	self.characters.npc_criminal_casual_1_var03 = {}
	self.characters.npc_criminal_casual_1_var03.fps_unit = "units/multiplayer/mp_fps_mover/mp_fps_mover_casual"
	self.characters.npc_criminal_casual_1_var03.npc_unit = "units/payday2/characters/npc_criminal_casual_1/npc_criminal_casual_1"
	self.characters.npc_criminal_casual_1_var03.menu_unit = "units/payday2/characters/npc_criminal_casual_1/npc_criminal_casual_1_menu"
	self.characters.npc_criminal_casual_1_var03.sequence = "var_material_03"
	self.characters.npc_criminal_casual_1_var03.name_id = "bm_casual_1_var03"
	
	self.characters.npc_criminal_suit_1_var01 = {}
	self.characters.npc_criminal_suit_1_var01.fps_unit = "units/payday2/characters/fps_mover/fps_mover"
	self.characters.npc_criminal_suit_1_var01.npc_unit = "units/payday2/characters/npc_criminal_suit_1/npc_criminal_suit_1"
	self.characters.npc_criminal_suit_1_var01.menu_unit = "units/payday2/characters/npc_criminal_suit_1/npc_criminal_suit_1_menu"
	self.characters.npc_criminal_suit_1_var01.sequence = "var_material_01"
	self.characters.npc_criminal_suit_1_var01.name_id = "bm_suit_1_var01"
	
	self.characters.npc_criminal_suit_1_var02 = {}
	self.characters.npc_criminal_suit_1_var02.fps_unit = "units/payday2/characters/fps_mover/fps_mover"
	self.characters.npc_criminal_suit_1_var02.npc_unit = "units/payday2/characters/npc_criminal_suit_1/npc_criminal_suit_1"
	self.characters.npc_criminal_suit_1_var02.menu_unit = "units/payday2/characters/npc_criminal_suit_1/npc_criminal_suit_1_menu"
	self.characters.npc_criminal_suit_1_var02.sequence = "var_material_02"
	self.characters.npc_criminal_suit_1_var02.name_id = "bm_suit_1_var02"
	
	self.characters.npc_criminal_suit_1_var03 = {}
	self.characters.npc_criminal_suit_1_var03.fps_unit = "units/payday2/characters/fps_mover/fps_mover"
	self.characters.npc_criminal_suit_1_var03.npc_unit = "units/payday2/characters/npc_criminal_suit_1/npc_criminal_suit_1"
	self.characters.npc_criminal_suit_1_var03.menu_unit = "units/payday2/characters/npc_criminal_suit_1/npc_criminal_suit_1_menu"
	self.characters.npc_criminal_suit_1_var03.sequence = "var_material_03"
	self.characters.npc_criminal_suit_1_var03.name_id = "bm_suit_1_var03"]]
...
--	Solids
	...
	self.colors.white_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.black_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.red_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.blue_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.green_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.cyan_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.magenta_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.yellow_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.light_gray_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.dark_gray_solid.pcs = {10, 20, 30, 40}	
	...
	self.colors.gray_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.pink_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.purple_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.blood_red_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.orange_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.light_brown_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.brown_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.navy_blue_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.light_blue_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.leaf_green_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.warm_yellow_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.dark_red_solid.pcs = {10, 20, 30, 40}
	...
	self.colors.dark_green_solid.pcs = {10, 20, 30, 40}
...
--	Color mixes
	...
	self.colors.black_white.pcs = {10, 20, 30, 40}
	...
	self.colors.red_black.pcs = {10, 20, 30, 40}
	...
	self.colors.yellow_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.red_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.light_gray_dark_gray.pcs = {10, 20, 30, 40}
	...
	self.colors.magenta_cyan.pcs = {10, 20, 30, 40}
	...
	self.colors.green_red.pcs = {10, 20, 30, 40}
	...
	self.colors.orange_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.green_olive_green.pcs = {10, 20, 30, 40}
	...
	self.colors.yellow_orange.pcs = {10, 20, 30, 40}
	...
	self.colors.light_brown_matte_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.turquoise_purple.pcs = {10, 20, 30, 40}
	...
	self.colors.orange_gray_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.coral_red_matte_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.toxic_green_dark_green.pcs = {10, 20, 30, 40}
	...
	self.colors.warm_yellow_matte_purple.pcs = {10, 20, 30, 40}
	...
	self.colors.bright_yellow_brown.pcs = {10, 20, 30, 40}
	...
	self.colors.coral_red_lime_green.pcs = {10, 20, 30, 40}
	...
	self.colors.white_matte_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.red_dark_red.pcs = {10, 20, 30, 40}
	...
	self.colors.bone_white_magenta.pcs = {10, 20, 30, 40}
	...
	self.colors.cobalt_blue_navy_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.toxic_green_leaf_green.pcs = {10, 20, 30, 40}
	...
	self.colors.light_brown_brown.pcs = {10, 20, 30, 40}
	...
	self.colors.bright_yellow_turquoise.pcs = {10, 20, 30, 40}
	...
	self.colors.light_blue_gray_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.pink_matte_purple.pcs = {10, 20, 30, 40}
	...
	self.colors.bone_white_purple.pcs = {10, 20, 30, 40}
	...
	self.colors.light_blue_cobalt_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.coral_red_gray_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.leaf_green_blood_red.pcs = {10, 20, 30, 40}
	...
	self.colors.cobalt_blue_pink.pcs = {10, 20, 30, 40}
	...
	self.colors.bright_yellow_olive_green.pcs = {10, 20, 30, 40}
	...
	self.colors.bone_white_light_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.coral_red_dark_red.pcs = {10, 20, 30, 40}
	...
	self.colors.turquoise_pink.pcs = {10, 20, 30, 40}
	...
	self.colors.white_brown.pcs = {10, 20, 30, 40}
	...
	self.colors.blue_light_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.toxic_green_matte_purple.pcs = {10, 20, 30, 40}
	...
	self.colors.orange_matte_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.warm_yellow_navy_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.bright_yellow_dark_gray.pcs = {10, 20, 30, 40}
	...
	self.colors.white_magenta.pcs = {10, 20, 30, 40}
	...
	self.colors.cyan_purple.pcs = {10, 20, 30, 40}
	...
	self.colors.white_black.pcs = {10, 20, 30, 40} 	
	...
	self.colors.light_gray_blood_red.pcs = {10, 20, 30, 40}
	...
	self.colors.blood_red_white.pcs = {10, 20, 30, 40}
	...
	self.colors.bone_white_navy_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.warm_yellow_olive_green.pcs = {10, 20, 30, 40}
	...
	self.colors.cyan_orange.pcs = {10, 20, 30, 40}
	...
	self.colors.dark_gray_orange.pcs = {10, 20, 30, 40}
	...
	self.colors.light_brown_navy_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.orange_purple.pcs = {10, 20, 30, 40}
	...
	self.colors.light_blue_brown.pcs = {10, 20, 30, 40}
	...
	self.colors.green_blood_red.pcs = {10, 20, 30, 40}
	...
	self.colors.cyan_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.gray_black.pcs = {10, 20, 30, 40}
	...
	self.colors.white_dark_gray.pcs = {10, 20, 30, 40}
	...
	self.colors.white_navy_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.white_purple.pcs = {10, 20, 30, 40}
	...
	self.colors.black_coral_red.pcs = {10, 20, 30, 40}
	...
	self.colors.black_orange.pcs = {10, 20, 30, 40}
	...
	self.colors.black_cobalt_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.black_leaf_green.pcs = {10, 20, 30, 40}
	...
	self.colors.red_white.pcs = {10, 20, 30, 40}
	...
	self.colors.leaf_green_white.pcs = {10, 20, 30, 40}
	...
	self.colors.orange_white.pcs = {10, 20, 30, 40}
	...
	self.colors.cobalt_blue_white.pcs = {10, 20, 30, 40}
	...
	self.colors.warm_yellow_white.pcs = {10, 20, 30, 40}
	...
	self.colors.black_bright_yellow.pcs = {10, 20, 30, 40}
	...
	self.colors.warm_yellow_bright_yellow.pcs = {10, 20, 30, 40}
	...
	self.colors.black_magenta.pcs = {10, 20, 30, 40}
	...
	self.colors.navy_blue_light_blue.pcs = {10, 20, 30, 40}
	...
	self.colors.dark_red_orange.pcs = {10, 20, 30, 40}
...
function BlackMarketTweakData:_init_materials()
	...
	self.materials.titanium.pcs = {10, 20, 30, 40} 
	...
	self.materials.mercury.pcs = {10, 20, 30, 40}
	...
	self.materials.oxide_bronze.pcs = {10, 20, 30, 40} 
	...
	self.materials.deep_bronze.pcs = {10, 20, 30, 40}
	...
	self.materials.slime.pcs = {10, 20, 30, 40}
	...
	self.materials.gold_clean.pcs = {10, 20, 30, 40}
	...
	self.materials.concrete1.pcs = {10, 20, 30, 40}
	...
	self.materials.rock1.pcs = {10, 20, 30, 40}
	...
	self.materials.rock2.pcs = {10, 20, 30, 40}
	...
	self.materials.rock3.pcs = {10, 20, 30, 40}
	...
	self.materials.whiterock.pcs = {10, 20, 30, 40}
	...
	self.materials.metal1.pcs = {10, 20, 30, 40}
	...
	self.materials.cracks1.pcs = {10, 20, 30, 40}
	...
	self.materials.wicker1.pcs = {10, 20, 30, 40}
	...
	self.materials.scales.pcs = {10, 20, 30, 40} 
	...
	self.materials.oldbronze.pcs = {10, 20, 30, 40}
	...
	self.materials.bark1.pcs = {10, 20, 30, 40}
	...
	self.materials.bark2.pcs = {10, 20, 30, 40}
	...
	self.materials.bark3.pcs = {10, 20, 30, 40} 
	...
	self.materials.carbon.pcs = {10, 20, 30, 40}
	...
	self.materials.leather.pcs = {10, 20, 30, 40}
	...
	self.materials.bloodred.pcs = {10, 20, 30, 40}
	...
	self.materials.waterblue.pcs = {10, 20, 30, 40}
	...
	self.materials.matteblack.pcs = {10, 20, 30, 40}
	...
	self.materials.pianoblack.pcs = {10, 20, 30, 40}
	...
	self.materials.twoblue.pcs = {10, 20, 30, 40}
	...
	self.materials.rainbow.pcs = {10, 20, 30, 40} 
	...
	self.materials.magma.pcs = {10, 20, 30, 40}
	...
	self.materials.radioactive.pcs = {10, 20, 30, 40}
	...
	self.materials.bismuth.pcs = {10, 20, 30, 40}
	...
	self.materials.greygloss.pcs = {10, 20, 30, 40}
	...
	self.materials.finewood.pcs = {10, 20, 30, 40}
	...
	self.materials.skin.pcs = {10, 20, 30, 40}
	...
	self.materials.alligator.pcs = {10, 20, 30, 40}
	...
	self.materials.denim.pcs = {10, 20, 30, 40} 
	...
	self.materials.candy.pcs = {10, 20, 30, 40}
	...
	self.materials.chrome_purple.pcs = {10, 20, 30, 40}
	...
	self.materials.orchish.pcs = {10, 20, 30, 40}
	...
	self.materials.cash.pcs = {10, 20, 30, 40}
	...
	self.materials.jade.pcs = {10, 20, 30, 40}
	...
	self.materials.redwhiteblue.pcs = {10, 20, 30, 40}
	...
	self.materials.marble.pcs = {10, 20, 30, 40}
	...
	self.materials.fur.pcs = {10, 20, 30, 40}
	...
	self.materials.galvanized.pcs = {10, 20, 30, 40}
	...
	self.materials.heavymetal.pcs = {10, 20, 30, 40}
	...
	self.materials.oilmetal.pcs = {10, 20, 30, 40}
...
function BlackMarketTweakData:_init_textures()
	...
	self.textures.big_skull.pcs = {10, 20, 30, 40}
	...
	self.textures.eightball.pcs = {10, 20, 30, 40}
	...
	self.textures.zebra.pcs = {10, 20, 30, 40}
	...
	self.textures.overkill.pcs = {10, 20, 30, 40}
	...
	self.textures.spawn.pcs = {10, 20, 30, 40}
	...
	self.textures.marv.pcs = {10, 20, 30, 40}
	...
	self.textures.starbreeze.pcs = {10, 20, 30, 40}
	...
	self.textures.cobrakai.pcs = {10, 20, 30, 40}
	...
	self.textures.flames.pcs = {10, 20, 30, 40}
	...
	self.textures.tribal.pcs = {10, 20, 30, 40}
	...
	self.textures.skull.pcs = {10, 20, 30, 40}
	...
	self.textures.arrow.pcs = {10, 20, 30, 40}
	...
	self.textures.usa.pcs = {10, 20, 30, 40}
	...
	self.textures.unionjack.pcs = {10, 20, 30, 40}
	...
	self.textures.fleur.pcs = {10, 20, 30, 40}
	...
	self.textures.hearts.pcs = {10, 20, 30, 40}
	...
	self.textures.electric.pcs = {10, 20, 30, 40}
	...
	self.textures.puzzle.pcs = {10, 20, 30, 40}
	...
	self.textures.swe_camo.pcs = {10, 20, 30, 40}
	...
	self.textures.japan.pcs = {10, 20, 30, 40}
	...
	self.textures.celtic1.pcs = {10, 20, 30, 40}
	...
	self.textures.dragon_full.pcs = {10, 20, 30, 40}
	...
	self.textures.dragon_split.pcs = {10, 20, 30, 40}
	...
	self.textures.horizon_circle.pcs = {10, 20, 30, 40}
	...
	self.textures.tribal2.pcs = {10, 20, 30, 40}
	...
	self.textures.vertical.pcs = {10, 20, 30, 40}
	...
	self.textures.celtic2.pcs = {10, 20, 30, 40}
	...
	self.textures.beast.pcs = {10, 20, 30, 40}
	...
	self.textures.headshot.pcs = {10, 20, 30, 40}
	...
	self.textures.circuit.pcs = {10, 20, 30, 40}
	...
	self.textures.paint1.pcs = {10, 20, 30, 40}
	...
	self.textures.chains.pcs = {10, 20, 30, 40}
	...
	self.textures.yinyang.pcs = {10, 20, 30, 40}
	...
	self.textures.rorschach.pcs = {10, 20, 30, 40}
	...
	self.textures.zipper.pcs = {10, 20, 30, 40}
	...
	self.textures.daniel.pcs = {10, 20, 30, 40}
	...
	self.textures.ouroboros.pcs = {10, 20, 30, 40}
	...
	self.textures.ouro.pcs = {10, 20, 30, 40}
	...
	self.textures.cat.pcs = {10, 20, 30, 40}
	...
	self.textures.clown.pcs = {10, 20, 30, 40}
	...
	self.textures.paint2.pcs = {10, 20, 30, 40}
	...
	self.textures.spider.pcs = {10, 20, 30, 40}
	...
	self.textures.target.pcs = {10, 20, 30, 40}
	...
	self.textures.illuminati.pcs = {10, 20, 30, 40}
	...
	self.textures.hypnotic.pcs = {10, 20, 30, 40}
	...
	self.textures.hexagon.pcs = {10, 20, 30, 40}
	...
	self.textures.messatsu.pcs = {10, 20, 30, 40}
	...
	self.textures.shazam.pcs = {10, 20, 30, 40}
	...
	self.textures.emblem1.pcs = {10, 20, 30, 40}
	...
	self.textures.emblem2.pcs = {10, 20, 30, 40}
	...
	self.textures.emblem3.pcs = {10, 20, 30, 40}
	...
	self.textures.swirl.pcs = {10, 20, 30, 40}
	...
	self.textures.kabuki1.pcs = {10, 20, 30, 40}
	...
	self.textures.ultimaterobber.pcs = {10, 20, 30, 40}
	...
	self.textures.nuclear.pcs = {10, 20, 30, 40}
	...
	self.textures.gearhead.pcs = {10, 20, 30, 40}
	...
	self.textures.atom.pcs = {10, 20, 30, 40}
	...
	self.textures.hand.pcs = {10, 20, 30, 40}
	...
	self.textures.scars.pcs = {10, 20, 30, 40}
	...
	self.textures.pirate.pcs = {10, 20, 30, 40}
	...
	self.textures.foot.pcs = {10, 20, 30, 40}
	...
	self.textures.star.pcs = {10, 20, 30, 40}
	...
	self.textures.portal.pcs = {10, 20, 30, 40}
	...
	self.textures.aperture.pcs = {10, 20, 30, 40}
	...
	self.textures.girlsandboys.pcs = {10, 20, 30, 40}
	...
	self.textures.loverboy.pcs = {10, 20, 30, 40}
	...
	self.textures.cogs.pcs = {10, 20, 30, 40}
	...
	self.textures.ace.pcs = {10, 20, 30, 40}
	...
	self.textures.compass.pcs = {10, 20, 30, 40}
	...
	self.textures.fan.pcs = {10, 20, 30, 40}
	...
	self.textures.pd2.pcs = {10, 20, 30, 40}
	...
	self.textures.fingerprint.pcs = {10, 20, 30, 40}
	...
	self.textures.biohazard.pcs = {10, 20, 30, 40}
	...
	self.textures.tf2.pcs = {10, 20, 30, 40}
	...
	self.textures.cake.pcs = {10, 20, 30, 40}
	...
	self.textures.companioncube.pcs = {10, 20, 30, 40}
	...
	self.textures.two.pcs = {10, 20, 30, 40}
	...
	self.textures.striped.pcs = {10, 20, 30, 40}
	...
	self.textures.solidfirst.pcs = {10, 20, 30, 40}
	...
	self.textures.solidsecond.pcs = {10, 20, 30, 40}
	...
	self.textures.mantis.pcs = {10, 20, 30, 40}
	...
	self.textures.bite.pcs = {10, 20, 30, 40}
	...
	self.textures.wtf.pcs = {10, 20, 30, 40}
	...
	self.textures.bloodsucker.pcs = {10, 20, 30, 40}
	...
	self.textures.hawk.pcs = {10, 20, 30, 40}
	...
	self.textures.magnet.pcs = {10, 20, 30, 40}
	...
	self.textures.diamond.pcs = {10, 20, 30, 40}
	...
	self.textures.luchador.pcs = {10, 20, 30, 40}
	...
	self.textures.maskedfalcon.pcs = {10, 20, 30, 40}
	...
	self.textures.grayson.pcs = {10, 20, 30, 40}
	...
	self.textures.sidestripe.pcs = {10, 20, 30, 40}
	...
	self.textures.gradient.pcs = {10, 20, 30, 40}
	...
	self.textures.spikes.pcs = {10, 20, 30, 40}
	...
	self.textures.barbarian.pcs = {10, 20, 30, 40}
	...
	self.textures.reaper.pcs = {10, 20, 30, 40}
	...
	self.textures.whiner.pcs = {10, 20, 30, 40}
	...
	self.textures.emblem4.pcs = {10, 20, 30, 40}
	...
	self.textures.daft_heart.pcs = {10, 20, 30, 40}
	...
	self.textures.anarchy.pcs = {10, 20, 30, 40}
	...
	self.textures.molecule.pcs = {10, 20, 30, 40}
	...
	self.textures.fleur2.pcs = {10, 20, 30, 40}
	...
	self.textures.trekronor.pcs = {10, 20, 30, 40}
	...
	self.textures.raster.pcs = {10, 20, 30, 40}
	...
	self.textures.flag.pcs = {10, 20, 30, 40}
	...
	self.textures.cracker.pcs = {10, 20, 30, 40}
	...
	self.textures.poison.pcs = {10, 20, 30, 40}
	...
	self.textures.racestripes.pcs = {10, 20, 30, 40}
	...
	self.textures.americaneagle.pcs = {10, 20, 30, 40}
	...
	self.textures.stars.pcs = {10, 20, 30, 40}
	...
	self.textures.forestcamo.pcs = {10, 20, 30, 40}
	...
	self.textures.army.pcs = {10, 20, 30, 40}
	...
	self.textures.commando.pcs = {10, 20, 30, 40}
	...
	self.textures.hunter.pcs = {10, 20, 30, 40}
	...
	self.textures.digitalcamo.pcs = {10, 20, 30, 40}
...
function BlackMarketTweakData:_init_cash()
	...
	--[[self.cash.cash5 = {}
	self.cash.cash5.name_id = "bm_csh_cash5"
	self.cash.cash5.value_id = "cash05"
	self.cash.cash5.multiplier = 1.05
	self.cash.cash5.pc = 5]]
	...
	--[[self.cash.cash15 = {}
	self.cash.cash15.name_id = "bm_csh_cash15"
	self.cash.cash15.value_id = "cash15"
	self.cash.cash15.multiplier = 1.15
	self.cash.cash15.pc = 15]]
	...
	--[[self.cash.cash25 = {}
	self.cash.cash25.name_id = "bm_csh_cash25"
	self.cash.cash25.value_id = "cash25"
	self.cash.cash25.multiplier = 1.25
	self.cash.cash25.pc = 25]]
	...
	--[[self.cash.cash35 = {}
	self.cash.cash35.name_id = "bm_csh_cash35"
	self.cash.cash35.multiplier = 1.35
	self.cash.cash35.value_id = "cash35"
	self.cash.cash35.pc = 35]]
	
	self.cash.cash40 = {}
	self.cash.cash40.name_id = "bm_csh_cash40"
	self.cash.cash40.multiplier = 1
	self.cash.cash40.value_id = "cash40"
	self.cash.cash40.pcs = {20, 30, 40}
	
	--[[self.cash.cash45 = {}
	self.cash.cash45.name_id = "bm_csh_cash45"
	self.cash.cash45.multiplier = 1.45
	self.cash.cash45.value_id = "cash45"
	self.cash.cash45.pc = 45]]
	
	self.cash.cash50 = {}
	self.cash.cash50.name_id = "bm_csh_cash50"
	self.cash.cash50.multiplier = 1
	self.cash.cash50.value_id = "cash50"
	self.cash.cash50.pcs = {30, 40, 50}
	
	--[[self.cash.cash55 = {}
	self.cash.cash55.name_id = "bm_csh_cash55"
	self.cash.cash55.multiplier = 1.55
	self.cash.cash55.value_id = "cash55"
	self.cash.cash55.pc = 55]]
	
	self.cash.cash60 = {}
	self.cash.cash60.name_id = "bm_csh_cash60"
	self.cash.cash60.value_id = "cash60"
	self.cash.cash60.multiplier = 1
	self.cash.cash60.pcs = {40, 50, 60}
	
	--[[self.cash.cash65 = {}
	self.cash.cash65.name_id = "bm_csh_cash65"
	self.cash.cash65.value_id = "cash65"
	self.cash.cash65.multiplier = 1.65
	self.cash.cash65.pc = 65]]
	
	self.cash.cash70 = {}
	self.cash.cash70.name_id = "bm_csh_cash70"
	self.cash.cash70.value_id = "cash70"
	self.cash.cash70.multiplier = 1
	self.cash.cash70.pcs = {50, 60, 70}
	
	--[[self.cash.cash75 = {}
	self.cash.cash75.name_id = "bm_csh_cash75"
	self.cash.cash75.value_id = "cash75"
	self.cash.cash75.multiplier = 1.75
	self.cash.cash75.pc = 75]]
	
	self.cash.cash80 = {}
	self.cash.cash80.name_id = "bm_csh_cash80"
	self.cash.cash80.value_id = "cash80"
	self.cash.cash80.multiplier = 1
	self.cash.cash80.pcs = {60, 70, 80}
	
	--[[self.cash.cash85 = {}
	self.cash.cash85.name_id = "bm_csh_cash85"
	self.cash.cash85.value_id = "cash85"
	self.cash.cash85.multiplier = 1.85
	self.cash.cash85.pc = 85]]
	
	self.cash.cash90 = {}
	self.cash.cash90.name_id = "bm_csh_cash90"
	self.cash.cash90.value_id = "cash90"
	self.cash.cash90.multiplier = 1
	self.cash.cash90.pcs = {70, 80, 90}
	
	--[[self.cash.cash95 = {}
	self.cash.cash95.name_id = "bm_csh_cash95"
	self.cash.cash95.value_id = "cash95"
	self.cash.cash95.multiplier = 1.95
	self.cash.cash95.pc = 95]]
	
	self.cash.cash100 = {}
	self.cash.cash100.name_id = "bm_csh_cash100"
	self.cash.cash100.value_id = "cash100"
	self.cash.cash100.multiplier = 1
	self.cash.cash100.pcs = {80, 90, 100}
...
function BlackMarketTweakData:_init_deployables( tweak_data )		-- equipments
	self.deployables = {}
