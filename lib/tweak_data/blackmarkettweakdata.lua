...
function BlackMarketTweakData:_init_masks()
	...
	self.masks.silverback.statistics = false
	self.masks.mandril = {}
	...
	self.masks.mandril.statistics = false
	...
	self.masks.skullmonkey.statistics = false
	...
	self.masks.orangutang.statistics = false
	self.masks.galax = {}
	...
	self.masks.galax.statistics = false
	...
	self.masks.crowgoblin.statistics = false
	self.masks.evil = {}
	...
	self.masks.evil.statistics = false
	self.masks.volt = {}
	...
	self.masks.volt.statistics = false
