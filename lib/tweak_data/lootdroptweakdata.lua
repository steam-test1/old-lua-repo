...
--[[
	...
	for i = min, max, 10 do
		...
		self.WEIGHTED_TYPE_CHANCE[ i ] = { cash = cash, weapon_mods = weapon_mods, colors = colors, textures = textures, materials = materials, masks = masks, xp = xp }
	end
	...
	self.global_value_list_index = { "normal", "infamous", "pre_order", "pd2_clan", "halloween", "xmas", "armored_transport", "gage_pack" }
