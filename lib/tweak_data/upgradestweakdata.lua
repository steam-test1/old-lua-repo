...
function UpgradesTweakData:_init_pd2_values()
	...
	self.values.player.body_armor.skill_ammo_mul = { 1, 1.02, 1.04, 1.06, 1.8, 1.1, 1.12 }
	...
	self.values.team.weapon.recoil_multiplier							= { 0.50 }	-- ACE
	...
	self.values.player.long_dis_revive										= { 0.75, 1 }	-- ACE
	...
	self.values.player.armor_regen_timer_multiplier				= { 0.85 }	-- ACE
			...
			-- UNDERDOG
	self.values.temporary.dmg_multiplier_outnumbered			= { { 1.15, 7 } }	-- BASIC. { value, time }
	...
	self.values.saw.hip_fire_spread_multiplier						= { 0.80 }		-- ACE
			...
			-- CARBON_BLADE
	self.values.player.saw_speed_multiplier								= { 0.95, 0.65 }	-- BASIC, ACE
	...
	self.values.assault_rifle.zoom_increase								= { 2.0 }		-- ACE. increase in the tweak_data.weapon.stats.zoom
	...
	self.values.sentry_gun.armor_multiplier								= { 2.5 }		-- ACE
			...
			-- SHARPSHOOTER
	self.values.weapon.single_spread_multiplier						= { 0.8 }		-- BASIC
	...
	self.values.weapon.armor_piercing_chance_silencer				= { 0.15 } -- ACE
	...
	self.values.temporary.berserker_damage_multiplier				= { { 2, 6 } }
	...
	self.values.player.tier_armor_multiplier								= { 1.1, 1.25, 1.5 }
	...
	self.values.player.level_interaction_timer_multiplier		= { { 0.01, 10 } }
