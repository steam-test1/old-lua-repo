...
function WeaponFactoryTweakData:init()
	...
	self:_init_m4()			-- wpn_fps_ass_m4
	self:_init_g18c()		-- wpn_fps_pis_g18c
	self:_init_amcar()		-- wpn_fps_ass_amcar
	self:_init_m16()		-- wpn_fps_ass_m16
	self:_init_olympic()	-- wpn_fps_smg_olympic
	self:_init_ak_parts()
	self:_init_ak74()		-- wpn_fps_ass_74
	self:_init_akm()		-- wpn_fps_ass_akm
	self:_init_akmsu()		-- wpn_fps_smg_akmsu
	self:_init_saiga()		-- wpn_fps_shot_saiga
	self:_init_ak5()		-- wpn_fps_ass_ak5
	self:_init_aug()		-- wpn_fps_ass_aug
	self:_init_g36()		-- wpn_fps_ass_g36
	self:_init_p90()		-- wpn_fps_smg_p90
	self:_init_m14()		-- wpn_fps_ass_m14
	self:_init_mp9()		-- wpn_fps_smg_mp9
	self:_init_deagle()		-- wpn_fps_pis_deagle
	self:_init_mp5()		-- wpn_fps_smg_mp5
	self:_init_colt_1911()	-- wpn_fps_pis_1911
	self:_init_mac10()		-- wpn_fps_smg_mac10
	self:_init_r870()		-- wpn_fps_shot_r870
	self:_init_g17()		-- wpn_fps_pis_g17
	self:_init_b92fs()		-- wpn_fps_pis_beretta
	self:_init_huntsman()	-- wpn_fps_shot_huntsman
	self:_init_raging_bull()-- wpn_fps_pis_rage
	self:_init_saw()		-- wpn_fps_saw
	self:_init_serbu()		-- wpn_fps_shot_serbu
	self:_init_usp()		-- wpn_fps_pis_usp
...
function WeaponFactoryTweakData:_init_silencers()
	...
	self.parts.wpn_fps_upg_ns_ass_smg_large 				= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", sub_type = "silencer", name_id = "bm_wp_upg_ns_ass_smg_large", a_obj = "a_ns", parent = "barrel", unit = "units/payday2/weapons/wpn_fps_upg_ns_ass_smg_large/wpn_fps_upg_ns_ass_smg_large",
																stats = { value = 5, suppression = 12, alert_size = 12, damage = -1, recoil = 3, spread_moving = -3, concealment = -3}, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_c" }
															}
	-- Silencer, Rifles, Medium and quite concealable
	self.parts.wpn_fps_upg_ns_ass_smg_medium 				= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", sub_type = "silencer", name_id = "bm_wp_upg_ns_ass_smg_medium", a_obj = "a_ns", parent = "barrel", unit = "units/payday2/weapons/wpn_fps_upg_ns_ass_smg_medium/wpn_fps_upg_ns_ass_smg_medium",
																stats = { value = 2, suppression = 12, alert_size = 12, damage = -3, recoil = 1, spread_moving = -2, concealment = -2 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_b" }
															}
	-- Silencer, Rifles, small and very concealable
	self.parts.wpn_fps_upg_ns_ass_smg_small 				= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", sub_type = "silencer", name_id  = "bm_wp_upg_ns_ass_smg_small", a_obj = "a_ns", parent = "barrel", unit = "units/payday2/weapons/wpn_fps_upg_ns_ass_smg_small/wpn_fps_upg_ns_ass_smg_small",
																stats = { value = 3, suppression = 12, alert_size = 12, damage = -5, recoil = 0, spread_moving = -1, concealment = 0 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_a" }
															}
	-- Silencer, Pistols, Large and not concealable														
	self.parts.wpn_fps_upg_ns_pis_large 					= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", sub_type = "silencer", name_id = "bm_wp_upg_ns_pis_large", a_obj = "a_ns", parent = "slide", unit = "units/payday2/weapons/wpn_fps_upg_ns_pis_large/wpn_fps_upg_ns_pis_large",
																stats = { value = 5, suppression = 12, alert_size = 12, damage = -1, recoil = 2, spread_moving = -2, concealment = -3 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_c" }
															}
	-- Silencer, Pistols, Medium and quite concealable												
	self.parts.wpn_fps_upg_ns_pis_medium 					= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", sub_type = "silencer", name_id = "bm_wp_upg_ns_pis_medium", a_obj = "a_ns", parent = "slide", unit = "units/payday2/weapons/wpn_fps_upg_ns_pis_medium/wpn_fps_upg_ns_pis_medium",
																stats = { value = 1, suppression = 12, alert_size = 12, damage = -2, recoil = 1, spread_moving = -2, concealment = -2 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_b" }
															}
	-- Silencer, Pistols, small and very concealable															
	self.parts.wpn_fps_upg_ns_pis_small 					= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", sub_type = "silencer", name_id = "bm_wp_upg_ns_pis_small", a_obj = "a_ns", parent = "slide", unit = "units/payday2/weapons/wpn_fps_upg_ns_pis_small/wpn_fps_upg_ns_pis_small",
																stats = { value = 3, suppression = 12, alert_size = 12, damage = -4, recoil = 0, spread_moving = -1, concealment = 0 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_a" }
															}
	-- Silencer, Shotgun, Medium and quite concealable															
	self.parts.wpn_fps_upg_ns_shot_thick 					= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", sub_type = "silencer", name_id = "bm_wp_upg_ns_shot_thick", a_obj = "a_ns", parent = "barrel", unit = "units/payday2/weapons/wpn_fps_upg_ns_shot_thick/wpn_fps_upg_ns_shot_thick",
																stats = { value = 7, suppression = 12, alert_size = 12, damage = -4, recoil = 1, spread_moving = -2, concealment = -2 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_a" }
															}
...
function WeaponFactoryTweakData:_init_nozzles()
	...
	self.parts.wpn_fps_upg_ns_shot_shark 					= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id = "bm_wp_upg_ns_shot_shark", a_obj = "a_ns", parent = "barrel", unit = "units/payday2/weapons/wpn_fps_upg_ns_shot_shark/wpn_fps_upg_ns_shot_shark",
																stats = { value = 5, suppression = -2, damage = 2, recoil = 2, spread = -2, concealment = -2 }
															}
...
function WeaponFactoryTweakData:_init_gadgets()
	...
	-- Gadgets addons
	self.parts.wpn_fps_addon_ris 							= { type = "extra", name_id = "bm_wp_upg_fl_pis_tlr1", a_obj = "a_fl", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_addon_ris",
																stats = { value = 1 }
															}	
	self.parts.wpn_fps_addon_ris.third_unit = "units/payday2/weapons/wpn_third_upg_m4_reusable/wpn_third_addon_ris"	
	
	-- Gadgets
	-- FLASHLIGHT, small, Rifles
	self.parts.wpn_fps_upg_fl_ass_smg_sho_surefire 			= { pcs = { 10, 20, 30, 40 } , type = "gadget", sub_type = "flashlight", name_id = "bm_wp_upg_fl_ass_smg_sho_surefire", a_obj = "a_fl", unit = "units/payday2/weapons/wpn_fps_upg_fl_ass_smg_sho_surefire/wpn_fps_upg_fl_ass_smg_sho_surefire",
																stats = { value = 3, spread_moving = -1, concealment = -1 },
																adds = { "wpn_fps_addon_ris" }
															}
	-- LASER, small, Rifles
	self.parts.wpn_fps_upg_fl_ass_smg_sho_peqbox 			= { pcs = { 20, 30, 40 } , type = "gadget", sub_type = "laser", name_id = "bm_wp_upg_fl_ass_smg_sho_peqbox", a_obj = "a_fl", unit = "units/payday2/weapons/wpn_fps_upg_fl_ass_smg_sho_peqbox/wpn_fps_upg_fl_ass_smg_sho_peqbox",
																stats = { value = 5, spread_moving = -1, concealment = -1 },
																adds = { "wpn_fps_addon_ris" }
															}
	-- LASER, small, Pistols
	self.parts.wpn_fps_upg_fl_pis_laser 					= { pcs = { 20, 30, 40 } , type = "gadget", sub_type = "laser", name_id = "bm_wp_upg_fl_pis_laser", a_obj = "a_fl", unit = "units/payday2/weapons/wpn_fps_upg_fl_pis_laser/wpn_fps_upg_fl_pis_laser",
																stats = { value = 5, spread_moving = -1, concealment = -1 }
															}
	-- FLASHLIGHT, small, Pistols
	self.parts.wpn_fps_upg_fl_pis_tlr1 						= { pcs = { 10, 20, 30, 40 } , type = "gadget", sub_type = "flashlight", name_id = "bm_wp_upg_fl_pis_tlr1", a_obj = "a_fl", unit = "units/payday2/weapons/wpn_fps_upg_fl_pis_tlr1/wpn_fps_upg_fl_pis_tlr1",
																stats = { value = 2, spread_moving = -1, concealment = -1 }
															}
...
function WeaponFactoryTweakData:_init_vertical_grips()
	-- Vertical Grips
	self.parts.wpn_fps_upg_vg_ass_smg_verticalgrip 			= { type = "vertical_grip", name_id = "bm_wp_upg_vg_ass_smg_verticalgrip", a_obj = "a_vg", unit = "units/payday2/weapons/wpn_fps_upg_vg_ass_smg_verticalgrip/wpn_fps_upg_vg_ass_smg_verticalgrip",
																stats = { value = 2, spread = 1, spread_moving = 2, concealment = -1 }
															}
	self.parts.wpn_fps_upg_vg_ass_smg_stubby 				= { type = "vertical_grip", name_id = "bm_wp_upg_vg_ass_smg_stubby", a_obj = "a_vg", unit = "units/payday2/weapons/wpn_fps_upg_vg_ass_smg_stubby/wpn_fps_upg_vg_ass_smg_stubby",
																stats = { value = 2, spread = 1, spread_moving = 2, concealment = 1 }
															}
	self.parts.wpn_fps_upg_vg_ass_smg_afg 					= { type = "vertical_grip", name_id = "bm_wp_upg_vg_ass_smg_afg", a_obj = "a_vg", unit = "units/payday2/weapons/wpn_fps_upg_vg_ass_smg_afg/wpn_fps_upg_vg_ass_smg_afg",
																stats = { value = 2, spread = 1, spread_moving = 2, concealment = -1 }
															}	
...
function WeaponFactoryTweakData:_init_sights()
	-- Sights
	-- Sight, Heavyweight, Best zoom, normal silhouette
	self.parts.wpn_fps_upg_o_specter 					= { pcs = { 30, 40 } , type = "sight", name_id = "bm_wp_upg_o_specter", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_specter/wpn_fps_upg_o_specter",
															stats = { value = 8, zoom = 4, recoil = 1, spread_moving = -3, concealment = -3 }, perks = { "scope" },
															stance_mod = { 	wpn_fps_ass_m4 = { translation = Vector3( 0,0,-0.45 ) },
																			wpn_fps_ass_m16 = { translation = Vector3( 0,0,-0.01 ) },
																			wpn_fps_smg_olympic = { translation = Vector3( 0,0,-0.01 ) },
																			wpn_fps_ass_74 = { translation = Vector3( 0,0,-3 ) },
																			wpn_fps_ass_akm = { translation = Vector3( 0,0,-3 ) },
																			wpn_fps_shot_saiga = { translation = Vector3( 0,0,-3 ) },
																			wpn_fps_shot_r870 = { translation = Vector3( 0,0,-3 ) },
																			wpn_fps_shot_serbu = { translation = Vector3( 0,0,-3 ) },
																			wpn_fps_smg_akmsu = { translation = Vector3( 0,0,-2.7 ) },
																			...
																			wpn_fps_ass_m14 = { translation = Vector3( 0,0,-3.8 ) },
																			wpn_fps_smg_mp9 = { translation = Vector3( 0,0,-3.4 ) },
																			wpn_fps_smg_mp5 = { translation = Vector3( 0,0,-3 ) },
																			wpn_fps_smg_mac10 = { translation = Vector3( 0,0,-4.5 ) },
																			
																			
																			wpn_fps_ass_s552 = { translation = Vector3( 0,0,-2 ) },
																			wpn_fps_smg_m45 = { translation = Vector3( 0,0,-4 ) },
	...
	self.parts.wpn_fps_upg_o_aimpoint 					= { pcs = { 30, 40 } , type = "sight", name_id = "bm_wp_upg_o_aimpoint", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_aimpoint/wpn_fps_upg_o_aimpoint",
															stats = { value = 8, zoom = 4, recoil = 1, spread_moving = -3, concealment = -3}, perks = { "scope" },
	...
	self.parts.wpn_fps_upg_o_aimpoint_2					= { pcs = { 10, 20, 30, 40}, dlc = "preorder", type = "sight", name_id = "bm_wp_upg_o_aimpoint", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_aimpoint/wpn_fps_upg_o_aimpoint_preorder",
															stats = { value = 1, zoom = 4, recoil = 1, spread_moving = -3, concealment = -3 }, perks = { "scope" },
															stance_mod = deep_clone( self.parts.wpn_fps_upg_o_specter.stance_mod ), 
															forbids = { "wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_ass_m16_os_frontsight", "wpn_fps_ass_scar_o_flipups_up" }
														}
	-- Sight, Lightweight, Bad zoom, small silhouette
	self.parts.wpn_fps_upg_o_docter 					= { pcs = { 20, 30, 40 } , type = "sight", name_id = "bm_wp_upg_o_docter", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_docter/wpn_fps_upg_o_docter",
															stats = { value = 5, zoom = 2, recoil = 1, spread_moving = -1, concealment = -1 }, perks = { "scope" },
															stance_mod = deep_clone( self.parts.wpn_fps_upg_o_specter.stance_mod ), 
															forbids = { "wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_ass_m16_os_frontsight", "wpn_fps_ass_scar_o_flipups_up" }
														}
	-- Sight, Normal weight, Normal zoom, normal silhouette
	self.parts.wpn_fps_upg_o_eotech 					= { pcs = { 10, 20, 30, 40 } , type = "sight", name_id = "bm_wp_upg_o_eotech", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_eotech/wpn_fps_upg_o_eotech",
															stats = { value = 3, zoom = 3, recoil = 1, spread_moving = -2, concealment = -2 }, perks = { "scope" },
															stance_mod = deep_clone( self.parts.wpn_fps_upg_o_specter.stance_mod ), 
															forbids = { "wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_ass_m16_os_frontsight", "wpn_fps_ass_scar_o_flipups_up" }
														}
	-- Sight, Lightweight, Normal zoom, small silhouette
	self.parts.wpn_fps_upg_o_t1micro 					= { pcs = { 10, 20, 30, 40 } , type = "sight", name_id = "bm_wp_upg_o_t1micro", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_t1micro/wpn_fps_upg_o_t1micro",
															stats = { value = 3, zoom = 3, recoil = 1, spread_moving = -1, concealment = -1 }, perks = { "scope" },
															stance_mod = deep_clone( self.parts.wpn_fps_upg_o_specter.stance_mod ), 
															forbids = { "wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_ass_m16_os_frontsight", "wpn_fps_ass_scar_o_flipups_up" }
														}
	-- Sight, Lightweight, For pistols
	self.parts.wpn_upg_o_marksmansight_rear 			= { pcs = { 10, 20, 30, 40 } , type = "sight", name_id = "bm_wp_upg_o_marksmansight_rear", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_marksmansight/wpn_upg_o_marksmansight_rear",
															stats = { value = 3, zoom = 1, recoil = 1, spread = 1 }, perks = { "scope" },
															adds = { "wpn_upg_o_marksmansight_front" },
																	stance_mod = { wpn_fps_smg_mac10 = { translation = Vector3( 0,0,-1 ) },
																	},
														}
	self.parts.wpn_upg_o_marksmansight_front 			= { type = "extra", name_id = "bm_wp_upg_o_marksmansight_front", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_marksmansight/wpn_upg_o_marksmansight_front",
														}
...
function WeaponFactoryTweakData:_init_content_dlc1()
	...
	self.parts.wpn_fps_upg_o_cmore 					= { pcs = { 10, 20, 30, 40 }, type = "sight", name_id = "bm_wp_upg_o_cmore", texture_bundle_folder = "dlc1", a_obj = "a_o", unit = "units/pd2_dlc1/weapons/wpn_fps_upg_o_cmore/wpn_fps_upg_o_cmore",
															stats = { value = 5, zoom = 3, recoil = 1, spread_moving = -1, concealment = -1 }, perks = { "scope" },
															stance_mod = deep_clone( self.parts.wpn_fps_upg_o_specter.stance_mod ),
															forbids = { "wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_ass_m16_os_frontsight", "wpn_fps_ass_scar_o_flipups_up" },
...
function WeaponFactoryTweakData:_init_content_dlc2()
	self.parts.wpn_fps_upg_i_singlefire					= { pcs = { 10, 20, 30, 40 }, type = "custom", sub_type = "singlefire", name_id = "bm_wp_upg_i_singlefire", a_obj = "a_body", unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy", third_unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
																stats = { value = 5, spread = 1, recoil = -2 }, perks = { "fire_mode_single" },
																dlc = "gage_pack"
															}
	self.parts.wpn_fps_upg_i_autofire					= { pcs = { 10, 20, 30, 40 }, type = "custom", sub_type = "autofire", name_id = "bm_wp_upg_i_autofire", a_obj = "a_body", unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy", third_unit = "units/payday2/weapons/wpn_upg_dummy/wpn_upg_dummy",
																stats = { value = 8, damage = 1, spread = -1, recoil = 2, spread_moving = 2 }, perks = { "fire_mode_auto" },
																dlc = "gage_pack"
															}
	
	self.parts.wpn_fps_upg_m4_g_hgrip  					= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_upg_m4_g_hgrip", a_obj = "a_g", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_upg_m4_g_hgrip/wpn_fps_upg_m4_g_hgrip",
																stats = { value = 2, spread_moving = 2, recoil = 1, spread = 1 },
																dlc = "gage_pack", texture_bundle_folder = "gage_pack"
															}
	...
	self.parts.wpn_fps_upg_m4_g_mgrip  					= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_upg_m4_g_mgrip", a_obj = "a_g", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_upg_m4_g_mgrip/wpn_fps_upg_m4_g_mgrip",
																stats = { value = 2, spread_moving = 2, concealment = 2 },
																dlc = "gage_pack", texture_bundle_folder = "gage_pack"
															}
...
function WeaponFactoryTweakData:_init_content_dlc2_dec16()
	self.parts.wpn_fps_upg_o_acog 					= { pcs = { 10, 20, 30, 40 }, type = "sight", name_id = "bm_wp_upg_o_acog", a_obj = "a_o", unit = "units/pd2_dlc2/weapons/wpn_fps_upg_o_acog/wpn_fps_upg_o_acog",
															stats = { value = 6, zoom = 5, recoil = 1, spread_moving = -1, concealment = -3 }, perks = { "scope" },
															stance_mod = { 	wpn_fps_ass_m4 = { translation = Vector3( 0,0,-0.45 ) },
																			wpn_fps_ass_m16 = { translation = Vector3( 0,0,-0.01 ) },
																			wpn_fps_smg_olympic = { translation = Vector3( 0,0,-0.01 ) },
																			wpn_fps_ass_74 = { translation = Vector3( 0,0,-3 ) },
																			...
																			wpn_fps_ass_g36 = { translation = Vector3( 0,0,-3 ) },
																			wpn_fps_smg_p90 = { translation = Vector3( 0,0,-2.97 ) },
																			wpn_fps_ass_m14 = { translation = Vector3( 0,-15,-3.8 ) },
																			wpn_fps_smg_mp9 = { translation = Vector3( 0,0,-3.4 ) },
																			wpn_fps_smg_mp5 = { translation = Vector3( 0,0,-3 ) },
																			wpn_fps_smg_mac10 = { translation = Vector3( 0,0,-4.5 ) },
...
function WeaponFactoryTweakData:_init_content_unfinished()
	...
	self.parts.wpn_fps_upg_o_eotech_xps 					= { pcs = { 10, 20, 30, 40 }, type = "sight", name_id = "bm_wp_upg_o_eotech_xps", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_eotech_xps/wpn_fps_upg_o_eotech_xps",
															stats = { value = 5, zoom = 3, recoil = 1, spread_moving = -1, concealment = -2 }, perks = { "scope" },
															stance_mod = deep_clone( self.parts.wpn_fps_upg_o_specter.stance_mod ),
															forbids = { "wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_ass_m16_os_frontsight", "wpn_fps_ass_scar_o_flipups_up" }
														}
	
	self.parts.wpn_fps_upg_o_reflex 					= { pcs = { 10, 20, 30, 40 }, type = "sight", name_id = "bm_wp_upg_o_reflex", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_reflex/wpn_fps_upg_o_reflex",
															stats = { value = 5, zoom = 3, recoil = 1, spread_moving = -1, concealment = -1 }, perks = { "scope" },
															stance_mod = deep_clone( self.parts.wpn_fps_upg_o_specter.stance_mod ),
															forbids = { "wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_ass_m16_os_frontsight", "wpn_fps_ass_scar_o_flipups_up" }
														}
	
	self.parts.wpn_fps_upg_o_rx01 					= { pcs = { 10, 20, 30, 40 }, type = "sight", name_id = "bm_wp_upg_o_rx01", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_rx01/wpn_fps_upg_o_rx01",
															stats = { value = 5, zoom = 4, recoil = 1, spread_moving = -1, concealment = -1 }, perks = { "scope" },
															stance_mod = deep_clone( self.parts.wpn_fps_upg_o_specter.stance_mod ),
															forbids = { "wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_ass_m16_os_frontsight", "wpn_fps_ass_scar_o_flipups_up" }
														}
	
	self.parts.wpn_fps_upg_o_rx30 					= { pcs = { 10, 20, 30, 40 }, type = "sight", name_id = "bm_wp_upg_o_rx30", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_upg_o_rx30/wpn_fps_upg_o_rx30",
															stats = { value = 5, zoom = 4, recoil = 1, spread_moving = -1, concealment = -2 }, perks = { "scope" },
															stance_mod = deep_clone( self.parts.wpn_fps_upg_o_specter.stance_mod ),
															forbids = { "wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_ass_m16_os_frontsight", "wpn_fps_ass_scar_o_flipups_up" }
														}
	...
	self.parts.wpn_fps_upg_ak_g_hgrip  					= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_upg_ak_g_hgrip", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_upg_ak_g_hgrip/wpn_fps_upg_ak_g_hgrip",
																stats = { value = 2, spread_moving = -2, recoil = 2 }, forbids = { "wpn_upg_ak_g_standard" }
															}
	
	self.parts.wpn_fps_upg_ak_g_pgrip  					= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_upg_ak_g_pgrip", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_upg_ak_g_pgrip/wpn_fps_upg_ak_g_pgrip",
																stats = { value = 2, spread_moving = 2, spread = 2 }, forbids = { "wpn_upg_ak_g_standard" }
															}
	
	self.parts.wpn_fps_upg_ak_g_wgrip  					= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_upg_ak_g_wgrip", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_upg_ak_g_wgrip/wpn_fps_upg_ak_g_wgrip",
																stats = { value = 2, spread_moving = 1, recoil = 1, suppression = 1 }, forbids = { "wpn_upg_ak_g_standard" }
															}
	...
	self.parts.wpn_fps_upg_m4_s_crane						= { pcs = { 10, 20, 30, 40 }, type = "stock", name_id = "bm_wp_upg_m4_s_crane", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_upg_m4_s_crane/wpn_fps_upg_m4_s_crane",
																stats = { value = 5, recoil = 1, concealment = -1, spread_moving = 2, spread = 1},
																adds_type = { "stock_adapter" },
																forbids = { "wpn_fps_shot_r870_ris_special" }
															}
	
	self.parts.wpn_fps_upg_m4_s_mk46						= { pcs = { 10, 20, 30, 40 }, type = "stock", name_id = "bm_wp_upg_m4_s_mk46", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_upg_m4_s_mk46/wpn_fps_upg_m4_s_mk46",
																stats = { value = 5, recoil = 2, concealment = -3, spread = 2},
																adds_type = { "stock_adapter" },
																forbids = { "wpn_fps_shot_r870_ris_special" }
															}
	...
	self.parts.wpn_fps_upg_ns_pis_medium_gem		= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", sub_type = "silencer", name_id = "bm_wp_upg_ns_pis_medium_gem", a_obj = "a_ns", parent = "slide", unit = "units/payday2/weapons/wpn_fps_upg_ns_pis_medium_gem/wpn_fps_upg_ns_pis_medium_gem",
																stats = { value = 3, suppression = 12, alert_size = 12, damage = -1, recoil = 1, spread_moving = -1, concealment = -1 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_b" }
																
															}
	
	self.parts.wpn_fps_upg_ns_pis_large_kac			= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", sub_type = "silencer", name_id = "bm_wp_upg_ns_pis_large_kac", a_obj = "a_ns", parent = "slide", unit = "units/payday2/weapons/wpn_fps_upg_ns_pis_large_kac/wpn_fps_upg_ns_pis_large_kac",
																stats = { value = 5, suppression = 12, alert_size = 12, damage = -1, recoil = 3, spread_moving = -3, concealment = -3 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_c" }
															}
...
function WeaponFactoryTweakData:_init_m4()
	-- Parts
	self.parts.wpn_fps_m4_lower_reciever 					= { type = "lower_reciever", name_id = "bm_wp_m4_lower_reciever", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_lower_reciever",
																stats = { value = 1 }
															}
	...
	self.parts.wpn_fps_m4_uupg_b_short 						= { pcs = { 10, 20, 30, 40 } , type = "barrel", name_id = "bm_wp_m4_uupg_b_short", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_b_short",
																stats = { value = 5, spread = -1, spread_moving = 2, concealment = 2 }
															}
	-- Barrel, normal
	self.parts.wpn_fps_m4_uupg_b_medium 					= { pcs = { 10, 20, 30, 40 } , type = "barrel", name_id = "bm_wp_m4_uupg_b_medium", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_b_medium",
																stats = { value = 1, spread = 1, concealment = -1 }
															}
	-- Barrel, Silenced barrel
	self.parts.wpn_fps_m4_uupg_b_sd 						= { pcs = { 20, 30, 40 } , type = "barrel", sub_type = "silencer", name_id = "bm_wp_m4_uupg_b_sd", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_b_sd",
																stats = { value = 6, suppression = 12, alert_size = 12, spread = -1, damage = -2, recoil = 1, spread_moving = 1, concealment = 1 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_c" },
	...
	-- Foregrip, Better grip and concealable looks
	self.parts.wpn_fps_m4_uupg_fg_lr300 					= { pcs = { 10, 20, 30, 40 } , type = "foregrip", name_id = "bm_wp_m4_uupg_fg_lr300", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_fg_lr300",
																stats = { value = 5, spread_moving = 1, concealment = 1, recoil = 1 },
																}
	self.parts.wpn_fps_m4_uupg_fg_rail 						= { type = "foregrip", name_id = "bm_wp_m4_uupg_fg_rail", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_fg_rail",
																stats = { value = 1, concealment = -1 },
																adds = { "wpn_fps_m4_uupg_fg_rail_ext" },
																forbids = { "wpn_fps_addon_ris"},
																}
	-- Magazine, standard m4 mag, 30 bullets
	self.parts.wpn_fps_m4_uupg_m_std 						= { pcs = { 10, 20, 30, 40 } , type = "magazine", name_id = "bm_wp_m4_uupg_m_std", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_m_std",
																stats = { value = 1, extra_ammo = 4, concealment = -1 },
																-- animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	-- Stock, Foldable skeletal stock 
	self.parts.wpn_fps_m4_uupg_s_fold						= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_m4_uupg_s_fold", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_s_fold",
																stats = { value = 5, recoil = -1, concealment = 2, spread_moving = 2 }
															}
	self.parts.wpn_fps_m4_uupg_o_flipup 					= { type = "sight", name_id = "bm_wp_m4_uupg_o_flipup", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_o_flipup",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_m4_uupg_draghandle 					= { type = "drag_handle", name_id = "bm_wp_m4_uupg_draghandle", a_obj = "a_dh", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_draghandle",
																stats = { value = 1 },
																-- animations = { reload = "reload" }
															}
	self.parts.wpn_fps_m4_uupg_fg_rail_ext 					= { type = "foregrip_ext", name_id = "bm_wp_m4_uupg_fg_rail_ext", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_m4_pts/wpn_fps_m4_uupg_fg_rail_ext",
																stats = { value = 1 }
															}			
	self.parts.wpn_fps_upg_m4_g_standard  					= { type = "grip", name_id = "bm_wp_m4_g_standard", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_g_standard",
																stats = { value = 1 }
															}
	-- Grip, Ergo grip, best spread_moving
	self.parts.wpn_fps_upg_m4_g_ergo 						= { pcs = { 10, 20, 30, 40 } , type = "grip", name_id = "bm_wp_m4_g_ergo", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_g_ergo",
																stats = { value = 2, spread_moving = 2, recoil = 1 }
															}
	...
	self.parts.wpn_fps_upg_m4_g_sniper 						= { pcs = { 10, 20, 30, 40 } , type = "grip", name_id = "bm_wp_m4_g_sniper", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_g_sniper",
																stats = { value = 6, spread = 1, recoil = 1, spread_moving = -2, concealment = -1 }
															}	
	self.parts.wpn_fps_upg_m4_m_drum 						= { type = "magazine", name_id = "bm_wp_m4_m_drum", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_m_drum",
																stats = { value = 9, extra_ammo = 20, concealment = -5 },
																-- animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	-- Mag, lightweight mag, 30 bullets
	self.parts.wpn_fps_upg_m4_m_pmag 						= { pcs = { 10, 20, 30, 40 } , type = "magazine", name_id = "bm_wp_m4_m_pmag", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_m_pmag",
																stats = { value = 3, spread_moving = 1, concealment = 0, extra_ammo = 2},
																-- animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	-- Mag, straight mag, 20
	self.parts.wpn_fps_upg_m4_m_straight 					= { pcs = { 10, 20, 30, 40 } , type = "magazine", name_id = "bm_wp_m4_m_straight", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_m_straight",
	...
	self.parts.wpn_fps_upg_m4_s_standard 					= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_m4_s_standard", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_s_standard",
																stats = { value = 1, spread_moving = -1, concealment = -1, recoil = 1 },
																adds_type = { "stock_adapter" },
																forbids = { "wpn_fps_shot_r870_ris_special"},
															}
	...
	self.parts.wpn_fps_upg_m4_s_pts 						= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_m4_s_pts", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_s_pts",
																stats = { value = 3, spread = 0, spread_moving = 1, recoil = 1, concealment = -1 },
																adds_type = { "stock_adapter" },
																forbids = { "wpn_fps_shot_r870_ris_special"},
															}
	self.parts.wpn_fps_upg_m4_s_adapter 					= { type = "stock_adapter", name_id = "bm_wp_m4_s_adapter", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_upg_m4_reusable/wpn_fps_upg_m4_s_adapter",
																stats = { value = 1 }
															}
	...
	-- Weapon
	self.wpn_fps_ass_m4 = {}
	self.wpn_fps_ass_m4.optional_types = { "barrel_ext", "gadget", "vertical_grip" }
	...
	self.wpn_fps_ass_m4.uses_parts = {
										"wpn_fps_m4_lower_reciever", "wpn_fps_m4_upper_reciever_edge", "wpn_fps_m4_upper_reciever_round",
										"wpn_fps_m4_uupg_b_long", "wpn_fps_m4_uupg_b_medium_vanilla", "wpn_fps_m4_uupg_b_short", "wpn_fps_m4_uupg_b_sd",
										"wpn_fps_upg_ns_ass_smg_large", "wpn_fps_upg_ns_ass_smg_medium", "wpn_fps_upg_ns_ass_smg_small",
										"wpn_fps_m4_uupg_fg_rail", "wpn_fps_m4_uupg_fg_lr300",
										"wpn_fps_m4_uupg_m_std_vanilla", "wpn_fps_upg_m4_m_drum", "wpn_fps_upg_m4_m_pmag", "wpn_fps_upg_m4_m_straight",
										"wpn_fps_m4_uupg_s_fold", "wpn_fps_upg_m4_s_standard_vanilla", "wpn_fps_upg_m4_s_pts",
										"wpn_fps_m4_uupg_draghandle",
										"wpn_fps_m4_uupg_o_flipup", "wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
										"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
										"wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg",
										"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
										"wpn_fps_upg_m4_g_standard_vanilla", "wpn_fps_upg_m4_g_ergo", "wpn_fps_upg_m4_g_sniper",
										"wpn_fps_upg_ns_ass_smg_firepig", "wpn_fps_upg_ns_ass_smg_stubby", "wpn_fps_upg_ns_ass_smg_tank",
										
										"wpn_fps_upg_m4_g_hgrip", "wpn_fps_upg_m4_g_mgrip",
										"wpn_fps_upg_m4_s_crane", "wpn_fps_upg_m4_s_mk46",
...
function WeaponFactoryTweakData:_init_g18c()
	-- Parts
	self.parts.wpn_fps_pis_g18c_body_frame 					= { type = "lower_reciever", name_id = "bm_wp_g18c_body_frame", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_pis_g18c_pts/wpn_fps_pis_g18c_body_frame",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_pis_g18c_b_standard 					= { type = "slide", name_id = "bm_wp_g18c_b_standard", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_g18c_pts/wpn_fps_pis_g18c_b_standard",
																stats = { value = 1 },
	...
	self.parts.wpn_fps_pis_g18c_m_mag_33rnd 				= { pcs = { 30, 40 } , type = "magazine", name_id = "bm_wp_g18c_m_mag_33rnd", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_g18c_pts/wpn_fps_pis_g18c_m_mag_33rnd",
																stats = { value = 6, spread_moving = -3, extra_ammo = 6, concealment = -2 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" } 
															}
	self.parts.wpn_fps_pis_g18c_m_mag_17rnd 				= { type = "magazine", name_id = "bm_wp_g18c_m_mag_17rnd", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_g18c_pts/wpn_fps_pis_g18c_m_mag_17rnd",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" } 
															}
	-- Stock, Lightweight stock
	self.parts.wpn_fps_pis_g18c_s_stock 					= { pcs = { 30, 40 } , type = "stock", name_id = "bm_wp_g18c_s_stock", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_pis_g18c_pts/wpn_fps_pis_g18c_s_stock",
																stats = { value = 8, recoil = 2, concealment = -2 } 
															}
	-- Grip, Ergo grip, best spread_moving
	...
	-- self.parts.wpn_fps_pis_g18c_body_frame.third_unit =  
	
	-- Weapon																	
	self.wpn_fps_pis_g18c = {}
	self.wpn_fps_pis_g18c.unit = "units/payday2/weapons/wpn_fps_pis_g18c/wpn_fps_pis_g18c"
	self.wpn_fps_pis_g18c.optional_types = { "barrel_ext", "gadget", "stock", "grip" }
	...
	self.wpn_fps_pis_g18c.uses_parts = {
										"wpn_fps_pis_g18c_body_frame",
										"wpn_fps_pis_g18c_b_standard",
										"wpn_fps_pis_g18c_co_1", "wpn_fps_pis_g18c_co_comp_2",
										"wpn_fps_pis_g18c_m_mag_33rnd", "wpn_fps_pis_g18c_m_mag_17rnd",
										"wpn_fps_pis_g18c_s_stock",
										
										"wpn_fps_upg_fl_pis_laser", "wpn_fps_upg_fl_pis_tlr1",
										"wpn_fps_upg_ns_pis_large", "wpn_fps_upg_ns_pis_medium", "wpn_fps_upg_ns_pis_small", "wpn_fps_upg_ns_pis_large_kac", "wpn_fps_upg_ns_pis_medium_gem",
...
function WeaponFactoryTweakData:_init_amcar()
	-- Parts
	self.parts.wpn_fps_amcar_uupg_body_upperreciever = { type = "sight", name_id = "bm_wp_g18c_m_mag_17rnd", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_amcar_pts/wpn_fps_amcar_uupg_body_upperreciever",
																	-- animations = { reload = "reload" },
																	adds = { "wpn_fps_ass_m16_os_frontsight" },
																	forbids = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" }
													 			}	
	self.parts.wpn_fps_amcar_uupg_fg_amcar = { type = "foregrip", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_amcar_pts/wpn_fps_amcar_uupg_fg_amcar" }
	...
	self.wpn_fps_ass_amcar.adds = {	wpn_fps_upg_o_specter = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_aimpoint = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_aimpoint_2 = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_docter = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_eotech = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_t1micro = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_cmore = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_eotech_xps = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_reflex = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_rx01 = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_rx30 = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" },
					wpn_fps_upg_o_acog = { "wpn_fps_m4_upper_reciever_round_vanilla", "wpn_fps_m4_uupg_draghandle_vanilla", "wpn_fps_m4_uupg_fg_rail_ext" }
					}
	...
	self.wpn_fps_ass_amcar.uses_parts = {
										"wpn_fps_m4_uupg_b_medium_vanilla",
										"wpn_fps_m4_lower_reciever",
										"wpn_fps_amcar_uupg_body_upperreciever", "wpn_fps_m4_upper_reciever_round_vanilla",
										"wpn_fps_amcar_uupg_fg_amcar",
										"wpn_fps_upg_m4_m_straight_vanilla", "wpn_fps_m4_uupg_m_std",
										"wpn_fps_upg_m4_s_standard_vanilla",
										"wpn_fps_upg_m4_g_standard_vanilla",
										
										"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro",
										"wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore", "wpn_fps_upg_o_acog",
...
function WeaponFactoryTweakData:_init_m16()
	...
	self.parts.wpn_fps_m16_fg_railed 						= { pc = 40 , type = "foregrip", name_id = "bm_wp_m16_fg_railed", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_m16_pts/wpn_fps_m16_fg_railed",
																stats = { value = 7, spread_moving = -2, recoil = 2, concealment = -2 },
																forbids = { "wpn_fps_addon_ris"},
															}
	self.parts.wpn_fps_m16_fg_standard 						= { type = "foregrip", name_id = "bm_wp_m16_fg_standard", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_m16_pts/wpn_fps_m16_fg_standard",
																stats = { value = 1 },
															}
	-- Foregrip, Better grip and concealable looks (INFAMOUS)
	self.parts.wpn_fps_m16_fg_vietnam 						= { pc = 40 , type = "foregrip", name_id = "bm_wp_m16_fg_vietnam", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_m16_pts/wpn_fps_m16_fg_vietnam",
																stats = { value = 10, spread_moving = 1, recoil = 1, concealment = 2 },
															}	
	
	self.parts.wpn_fps_m16_s_solid 							= { type = "stock", name_id = "bm_wp_m16_s_solid", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_ass_m16_pts/wpn_fps_m16_s_solid",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_m16_o_handle_sight 				= { type = "sight", name_id = "bm_wp_m16_o_handle_sight", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_ass_m16_pts/wpn_fps_ass_m16_o_handle_sight",
																stats = { value = 1 },
																adds = { "wpn_fps_ass_m16_os_frontsight" }
															}
	self.parts.wpn_fps_ass_m16_os_frontsight 				= { type = "sight_special", name_id = "bm_wp_m16_os_frontsight", a_obj = "a_os", unit = "units/payday2/weapons/wpn_fps_ass_m16_pts/wpn_fps_ass_m16_os_frontsight",
																stats = { value = 1 }
															}
	...
	self.wpn_fps_ass_m16.optional_types = { "barrel_ext", "gadget", "vertical_grip" }
	...
	self.wpn_fps_ass_m16.uses_parts = {
										"wpn_fps_m16_fg_railed", "wpn_fps_m16_fg_standard",	"wpn_fps_m16_fg_vietnam",
										...
										"wpn_fps_m16_s_solid_vanilla",
										"wpn_fps_m4_uupg_m_std", "wpn_fps_upg_m4_m_drum", "wpn_fps_upg_m4_m_pmag", "wpn_fps_upg_m4_m_straight_vanilla",
										"wpn_fps_upg_m4_g_standard_vanilla", "wpn_fps_upg_m4_g_ergo", "wpn_fps_upg_m4_g_sniper",
										"wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg",
										"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
										"wpn_fps_ass_m16_o_handle_sight", "wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
										"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
										"wpn_fps_upg_ns_ass_smg_large", "wpn_fps_upg_ns_ass_smg_medium", "wpn_fps_upg_ns_ass_smg_small",
										"wpn_fps_upg_ns_ass_smg_firepig", "wpn_fps_upg_ns_ass_smg_stubby", "wpn_fps_upg_ns_ass_smg_tank",
...
function WeaponFactoryTweakData:_init_olympic()
	-- Parts
	-- Foregrip, Heavyweight and NOT concealable looks
	self.parts.wpn_fps_smg_olympic_fg_railed 				= { pcs = { 20, 30, 40 } , type = "foregrip", name_id = "bm_wp_olympic_fg_railed", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_smg_olympic_pts/wpn_fps_smg_olympic_fg_railed",
																stats = { value = 4, spread_moving = -1, recoil = 1, concealment = -1},
																forbids = { "wpn_fps_addon_ris"},
															}
	self.parts.wpn_fps_smg_olympic_fg_olympic 				= { type = "foregrip", name_id = "bm_wp_olympic_fg_olympic", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_smg_olympic_pts/wpn_fps_smg_olympic_fg_olympic",
																stats = { value = 1, },
															}
	...
	self.wpn_fps_smg_olympic.optional_types = { "barrel_ext", "gadget", "vertical_grip" }
	...
	self.wpn_fps_smg_olympic.uses_parts = {
										"wpn_fps_m4_lower_reciever", "wpn_fps_m4_upper_reciever_edge", "wpn_fps_m4_upper_reciever_round", 
										"wpn_fps_m4_uupg_draghandle",
										"wpn_fps_smg_olympic_fg_olympic", "wpn_fps_smg_olympic_fg_railed",
										"wpn_fps_smg_olympic_s_short", "wpn_fps_smg_olympic_s_adjust","wpn_fps_upg_m4_s_standard", "wpn_fps_upg_m4_s_pts",									
										"wpn_fps_m4_uupg_b_short_vanilla", "wpn_fps_m4_uupg_b_medium",
										"wpn_fps_m4_uupg_m_std", "wpn_fps_upg_m4_m_drum", "wpn_fps_upg_m4_m_pmag", "wpn_fps_upg_m4_m_straight_vanilla",
										"wpn_fps_ass_m16_o_handle_sight", "wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
										"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
										"wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg",					
...
function WeaponFactoryTweakData:_init_ak_parts()
	self.parts.wpn_upg_ak_fg_combo1 						= { type = "foregrip", name_id = "bm_wp_ak_fg_combo1", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_upg_ak_reusable/wpn_upg_ak_fg_combo1",
																stats = { value = 1 }
															}
	...
	self.parts.wpn_upg_ak_fg_combo4 						= { type = "foregrip", name_id = "bm_wp_ak_fg_combo4", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_upg_ak_reusable/wpn_upg_ak_fg_combo4",
																stats = { value = 1 },
																--forbids = { "wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_aimpoint_2", },
															}
	self.parts.wpn_upg_ak_fg_standard 						= { type = "foregrip", name_id = "bm_wp_ak_fg_standard", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_upg_ak_reusable/wpn_upg_ak_fg_standard",
																stats = { value = 1 },
																override = {  
	...
	self.parts.wpn_upg_ak_g_standard 						= { type = "grip", name_id = "bm_wp_ak_g_standard", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_upg_ak_reusable/wpn_upg_ak_g_standard" ,
																stats = { value = 1 },
															}
	self.parts.wpn_upg_ak_m_akm 							= { type = "magazine", name_id = "bm_wp_ak_m_akm", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_upg_ak_reusable/wpn_upg_ak_m_akm",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_upg_ak_m_drum 							= { type = "magazine", name_id = "bm_wp_ak_m_drum", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_upg_ak_reusable/wpn_upg_ak_m_drum",
																stats = { value = 5, concealment = -4 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_upg_ak_s_adapter 						= { type = "stock_adapter", name_id = "bm_wp_ak_s_adapter", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_upg_ak_reusable/wpn_upg_ak_s_adapter",
																stats = { value = 1 },
																adds = { "wpn_upg_ak_g_standard" },
															}
	-- Stock, lightweight Foldable stock
	self.parts.wpn_upg_ak_s_folding 						= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_ak_s_folding", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_upg_ak_reusable/wpn_upg_ak_s_folding",
																stats = { value = 3, spread_moving = 2, recoil = -1, concealment = 2 },
																adds = { "wpn_upg_ak_g_standard" },
															}
	...
	self.parts.wpn_upg_ak_s_psl 							= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_ak_s_psl", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_upg_ak_reusable/wpn_upg_ak_s_psl",
																stats = { value = 6, spread = 3, spread_moving = -3, recoil = 0, concealment = -3 },
																forbids = { "wpn_upg_ak_g_standard", "wpn_fps_upg_ak_g_hgrip", "wpn_fps_upg_ak_g_wgrip", "wpn_fps_upg_ak_g_pgrip" }
															}
	...
	-- AKM PARTS
	self.parts.wpn_fps_ass_akm_body_upperreceiver 			= { type = "upper_reciever", name_id = "bm_wp_akm_body_upperreceiver", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_akm_pts/wpn_fps_ass_akm_body_upperreceiver",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_ak_body_lowerreceiver 			= { type = "lower_reciever", name_id = "bm_wp_ak_body_lowerreceiver", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_akm_pts/wpn_fps_ass_ak_body_lowerreceiver",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" }
															}								
	self.parts.wpn_fps_ass_akm_b_standard 					= { type = "barrel", name_id = "bm_wp_akm_b_standard", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_akm_pts/wpn_fps_ass_akm_b_standard",
																stats = { value = 1 }
															}
...
function WeaponFactoryTweakData:_init_ak74()
	-- Parts	
	self.parts.wpn_fps_ass_74_b_standard 					= { type = "barrel", name_id = "bm_wp_74_b_standard", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_74_pts/wpn_fps_ass_74_b_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_74_body_upperreceiver 			= { type = "upper_reciever", name_id = "bm_wp_74_body_upperreceiver", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_74_pts/wpn_fps_ass_74_body_upperreceiver",
																stats = { value = 1 } 
															}
	self.parts.wpn_fps_ass_74_m_standard 					= { type = "magazine", name_id = "bm_wp_74_m_standard", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_ass_74_pts/wpn_fps_ass_74_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	...
	self.wpn_fps_ass_74.optional_types = { "barrel_ext", "gadget", "vertical_grip" }
	self.wpn_fps_ass_74.adds = { 			wpn_fps_upg_o_specter = { "wpn_fps_ak_extra_ris" },
	...
	self.wpn_fps_ass_74.uses_parts = {
											"wpn_fps_ass_74_b_standard",
											"wpn_fps_ass_74_body_upperreceiver", "wpn_fps_ass_akm_body_upperreceiver",
											"wpn_fps_ass_ak_body_lowerreceiver",
											"wpn_fps_ass_74_m_standard", "wpn_upg_ak_m_drum",
											"wpn_upg_ak_fg_standard", "wpn_upg_ak_fg_combo2", "wpn_upg_ak_fg_combo3", "wpn_upg_ak_fg_combo1", "wpn_upg_ak_fg_combo4",
											"wpn_upg_ak_g_standard",
											"wpn_fps_upg_m4_s_standard", "wpn_fps_upg_m4_s_pts", "wpn_upg_ak_s_folding", "wpn_upg_ak_s_psl", "wpn_upg_ak_s_skfoldable_vanilla",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg",					
											"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
											"wpn_fps_upg_ns_ass_smg_large", "wpn_fps_upg_ns_ass_smg_medium", "wpn_fps_upg_ns_ass_smg_small",
											...
											"wpn_fps_upg_ak_g_hgrip", "wpn_fps_upg_ak_g_pgrip", "wpn_fps_upg_ak_g_wgrip",
											"wpn_fps_upg_m4_s_crane", "wpn_fps_upg_m4_s_mk46",
...
function WeaponFactoryTweakData:_init_akm()
	...
	self.wpn_fps_ass_akm.optional_types = { "barrel_ext", "gadget", "vertical_grip", "sight" }
	self.wpn_fps_ass_akm.adds = { 			wpn_fps_upg_o_specter = { "wpn_fps_ak_extra_ris" },
											wpn_fps_upg_o_aimpoint = { "wpn_fps_ak_extra_ris" },
											wpn_fps_upg_o_aimpoint_2 = { "wpn_fps_ak_extra_ris" },
											wpn_fps_upg_o_docter = { "wpn_fps_ak_extra_ris" },
											wpn_fps_upg_o_eotech = { "wpn_fps_ak_extra_ris" },
	...
	self.wpn_fps_ass_akm.default_blueprint = {										
											"wpn_upg_ak_s_folding_vanilla", "wpn_upg_ak_fg_standard", "wpn_upg_ak_m_akm", "wpn_upg_ak_g_standard",
											"wpn_fps_ass_akm_b_standard", "wpn_fps_ass_akm_body_upperreceiver_vanilla", "wpn_fps_ass_ak_body_lowerreceiver",
											}
	...
	self.wpn_fps_ass_akm.uses_parts = {
											...
											"wpn_upg_ak_fg_standard", "wpn_upg_ak_fg_combo2", "wpn_upg_ak_fg_combo3", --"wpn_upg_ak_fg_combo1", "wpn_upg_ak_fg_combo4",
											"wpn_upg_ak_g_standard",
											"wpn_fps_upg_m4_s_standard", "wpn_fps_upg_m4_s_pts", "wpn_upg_ak_s_folding_vanilla", "wpn_upg_ak_s_psl", "wpn_upg_ak_s_skfoldable",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg",					
											"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
...
function WeaponFactoryTweakData:_init_akmsu()
	-- Parts
	self.parts.wpn_fps_smg_akmsu_b_standard 				= { type = "barrel", name_id = "bm_wp_akmsu_b_standard", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_smg_akmsu_pts/wpn_fps_smg_akmsu_b_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_akmsu_body_lowerreceiver 		= { type = "lower_receiver", name_id = "bm_wp_akmsu_body_lowerreceiver", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_smg_akmsu_pts/wpn_fps_smg_akmsu_body_lowerreceiver",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" }
															}
	-- Foregrip, Heavyweight and NOT concealable looks
	...
	self.wpn_fps_smg_akmsu.optional_types = { "barrel_ext", "gadget", "vertical_grip" }
	self.wpn_fps_smg_akmsu.adds = { 			wpn_fps_upg_o_specter = { "wpn_fps_ak_extra_ris" },
											wpn_fps_upg_o_aimpoint = { "wpn_fps_ak_extra_ris" },
											wpn_fps_upg_o_aimpoint_2 = { "wpn_fps_ak_extra_ris" },
											wpn_fps_upg_o_docter = { "wpn_fps_ak_extra_ris" },
											wpn_fps_upg_o_eotech = { "wpn_fps_ak_extra_ris" },
	...
	self.wpn_fps_smg_akmsu.uses_parts = {
											...
											"wpn_fps_ass_akm_body_upperreceiver_vanilla",
											"wpn_fps_smg_akmsu_b_standard",
											"wpn_fps_smg_akmsu_fg_standard", "wpn_fps_smg_akmsu_fg_rail",
											"wpn_upg_ak_g_standard",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_upg_ak_m_akm",
...
function WeaponFactoryTweakData:_init_saiga()
	-- Parts
	self.parts.wpn_fps_shot_saiga_b_standard 				= { type = "barrel", name_id = "bm_wp_saiga_b_standard", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_shot_saiga_pts/wpn_fps_shot_saiga_b_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_shot_saiga_m_5rnd 					= { type = "magazine", name_id = "bm_wp_saiga_m_5rnd", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_shot_saiga_pts/wpn_fps_shot_saiga_m_5rnd",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_upg_saiga_fg_standard 					= { type = "foregrip", name_id = "bm_wp_saiga_fg_standard", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_shot_saiga_pts/wpn_upg_saiga_fg_standard",
																stats = { value = 1 } ,
																override = {  
																wpn_fps_upg_o_specter = {  a_obj = "a_of", },
																wpn_fps_upg_o_aimpoint = {  a_obj = "a_of", },
	...
	-- Foregrip, Heavyweight and NOT concealable looks
	self.parts.wpn_upg_saiga_fg_lowerrail 					= { pcs = { 30, 40 } , type = "foregrip", name_id = "bm_wp_saiga_fg_lowerrail", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_shot_saiga_pts/wpn_upg_saiga_fg_lowerrail",
																stats = { value = 5, recoil = 2, spread_moving = -2, concealment = -2 },
																forbids = { "wpn_fps_addon_ris", "wpn_fps_smg_mac10_body_ris_special"},
															}
	self.parts.wpn_upg_saiga_m_20rnd 						= { type = "magazine", name_id = "bm_wp_saiga_m_20rnd", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_shot_saiga_pts/wpn_upg_saiga_m_20rnd",
	...
	self.wpn_fps_shot_saiga.optional_types = { "barrel_ext", "gadget", "vertical_grip" }
	self.wpn_fps_shot_saiga.override = {	wpn_upg_o_marksmansight_rear_vanilla = { a_obj = "a_or", },
	...
	self.wpn_fps_shot_saiga.uses_parts = {
											"wpn_fps_smg_akmsu_body_lowerreceiver",
											"wpn_fps_ass_akm_body_upperreceiver_vanilla",
											"wpn_upg_saiga_fg_standard","wpn_upg_saiga_fg_lowerrail",
											"wpn_fps_shot_saiga_b_standard",
											"wpn_fps_shot_saiga_m_5rnd", "wpn_upg_saiga_m_20rnd",
											"wpn_upg_ak_g_standard",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_upg_o_marksmansight_rear_vanilla",
											"wpn_fps_upg_m4_s_standard", "wpn_fps_upg_m4_s_pts", "wpn_upg_ak_s_folding_vanilla", "wpn_upg_ak_s_psl", "wpn_upg_ak_s_skfoldable",
											"wpn_fps_upg_ns_shot_thick", "wpn_fps_upg_ns_shot_shark",
...
function WeaponFactoryTweakData:_init_ak5()
	-- Parts
	self.parts.wpn_fps_ass_ak5_b_std 						= { type = "barrel", name_id = "bm_wp_ak5_b_std", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_ak5_pts/wpn_fps_ass_ak5_b_std",
																stats = { value = 1 } 
															}
	self.parts.wpn_fps_ass_ak5_body_ak5 					= { type = "lower_reciever", name_id = "bm_wp_ak5_body_ak5", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_ak5_pts/wpn_fps_ass_ak5_body_ak5",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil"  }
																
															}
	self.parts.wpn_fps_ass_ak5_body_rail 					= { type = "extra", name_id = "bm_wp_ak5_body_rail", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_ak5_pts/wpn_fps_ass_ak5_body_rail",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_ak5_fg_ak5a 						= { type = "foregrip", name_id = "bm_wp_ak5_fg_ak5a", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_ak5_pts/wpn_fps_ass_ak5_fg_ak5a",
																stats = { value = 1 },
															}
	...
	self.parts.wpn_fps_ass_ak5_fg_fnc 						= { pc = 40 , type = "foregrip", name_id = "bm_wp_ak5_fg_fnc", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_ak5_pts/wpn_fps_ass_ak5_fg_fnc",
																stats = { value = 10, spread_moving = 2, recoil = -1, concealment = 1},
															}
	self.parts.wpn_fps_ass_ak5_s_ak5a 						= { type = "stock", name_id = "bm_wp_ak5_s_ak5a", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_ass_ak5_pts/wpn_fps_ass_ak5_s_ak5a",
																stats = { value = 1 } 
															}
	-- Stock, mediumweight, best spread and bad moving spread
	...
	self.wpn_fps_ass_ak5.optional_types = { "barrel_ext", "gadget", "vertical_grip", "sight" }
	self.wpn_fps_ass_ak5.adds = { 	wpn_fps_upg_o_specter = { "wpn_fps_ass_ak5_body_rail" },
	...
	self.wpn_fps_ass_ak5.uses_parts = {
											...
											"wpn_fps_ass_ak5_fg_ak5a", "wpn_fps_ass_ak5_fg_ak5c", "wpn_fps_ass_ak5_fg_fnc",
											"wpn_fps_ass_ak5_s_ak5a", "wpn_fps_ass_ak5_s_ak5b", "wpn_fps_ass_ak5_s_ak5c",
											"wpn_fps_m4_uupg_m_std_vanilla", "wpn_fps_upg_m4_m_drum", "wpn_fps_upg_m4_m_pmag", "wpn_fps_upg_m4_m_straight",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg",					
...
function WeaponFactoryTweakData:_init_aug()
	-- Parts
	-- Barrel, long
	self.parts.wpn_fps_aug_b_long 							= { pcs = { 10, 20, 30, 40 }, type = "barrel", name_id = "bm_wp_aug_b_long", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_aug_pts/wpn_fps_aug_b_long",
																stats = { value = 7, spread_moving = -2, spread = 1, recoil = 1, concealment = -3, damage = 1 }
															}
	self.parts.wpn_fps_aug_b_medium 						= { type = "barrel", name_id = "bm_wp_aug_b_medium", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_aug_pts/wpn_fps_aug_b_medium",
																stats = { value = 1 }
															}
	-- Barrel. short
	self.parts.wpn_fps_aug_b_short 							= { pcs = { 10, 20, 30, 40 }, type = "barrel", name_id = "bm_wp_aug_b_short", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_aug_pts/wpn_fps_aug_b_short",
																stats = { value = 5, spread_moving = 3, spread = -1, recoil = 2, concealment = 2 },
															}									
	self.parts.wpn_fps_aug_m_pmag 							= { type = "magazine", name_id = "bm_wp_aug_m_pmag", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_ass_aug_pts/wpn_fps_aug_m_pmag",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_aug_body_aug 						= { type = "lower_reciever", name_id = "bm_wp_aug_body_aug", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_aug_pts/wpn_fps_aug_body_aug",
																stats = { value = 1 },
																animations = { reload = "reload" }
															}
	...
	self.wpn_fps_ass_aug.adds = { wpn_fps_upg_fl_ass_smg_sho_peqbox = { "wpn_fps_aug_ris_special" }, wpn_fps_upg_fl_ass_smg_sho_surefire = { "wpn_fps_aug_ris_special" } }
	self.wpn_fps_ass_aug.override = { 	wpn_upg_o_marksmansight_rear_vanilla = { a_obj = "a_or", },
	...
	self.wpn_fps_ass_aug.uses_parts = {
											"wpn_fps_aug_body_aug",
											"wpn_fps_aug_fg_a3", "wpn_fps_aug_ris_special",
											"wpn_fps_aug_b_long", "wpn_fps_aug_b_medium", "wpn_fps_aug_b_short",
											"wpn_fps_aug_m_pmag",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_upg_o_marksmansight_rear_vanilla", "wpn_upg_o_marksmansight_front_vanilla",
											"wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg",
											"wpn_fps_upg_ns_ass_smg_large", "wpn_fps_upg_ns_ass_smg_medium", "wpn_fps_upg_ns_ass_smg_small",
											"wpn_fps_upg_ns_ass_smg_firepig", "wpn_fps_upg_ns_ass_smg_stubby", "wpn_fps_upg_ns_ass_smg_tank",				
											"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
...
function WeaponFactoryTweakData:_init_g36()
	-- Parts
	self.parts.wpn_fps_ass_g36_body_sl8 					= { type = "lower_reciever", name_id = "bm_wp_g36_body_sl8", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_body_sl8",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" },
															}
	self.parts.wpn_fps_ass_g36_body_standard 				= { type = "lower_reciever", name_id = "bm_wp_g36_body_standard", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_body_standard",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" },
															}
	self.parts.wpn_fps_ass_g36_g_standard 					= { type = "grip", name_id = "bm_wp_g36_g_standard", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_g_standard",
																stats = { value = 1 } 
															}
	self.parts.wpn_fps_ass_g36_m_standard 					= { type = "magazine", name_id = "bm_wp_g36_m_standard", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_ass_g36_b_long 						= { type = "barrel", name_id = "bm_wp_g36_b_long", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_b_long",
																stats = { value = 1 },
															}
	self.parts.wpn_fps_ass_g36_b_short 						= { type = "barrel", name_id = "bm_wp_g36_b_short", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_b_short",
																stats = { value = 1 },
															}
	-- foregrip, Lightweight, Better moving_spread, Concealable
	self.parts.wpn_fps_ass_g36_fg_c 						= { pcs = { 20, 30, 40 } , type = "foregrip", name_id = "bm_wp_g36_fg_c", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_fg_c",
																stats = { value = 4, spread_moving = 2, recoil = -1, concealment = 2 },
																forbids = { "wpn_fps_ass_g36_b_long" },
																adds = { "wpn_fps_ass_g36_b_short",},
															}
	self.parts.wpn_fps_ass_g36_fg_k 						= { type = "foregrip", name_id = "bm_wp_g36_fg_k", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_fg_k",
																stats = { value = 1 },
	...
	-- Stock, Lightweight, Normal spread and Best moving_spread
	self.parts.wpn_fps_ass_g36_s_kv 						= { pcs = { 20, 30, 40 } , type = "stock", name_id = "bm_wp_g36_s_kv", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_s_kv",
																stats = { value = 4, spread_moving = 2, concealment = 2 },
																adds = { "wpn_fps_ass_g36_body_standard", "wpn_fps_ass_g36_g_standard", },
																forbids = { "wpn_fps_ass_g36_body_sl8", },
															}
	-- Stock, Heavyweight, Best spread and Bad moving_spread  (INFAMOUS)
	self.parts.wpn_fps_ass_g36_s_sl8 						= { pcs = { 20, 30, 40 } , type = "stock", name_id = "bm_wp_g36_s_sl8", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_s_sl8",
																stats = { value = 9, recoil = 2, spread = 1, spread_moving = -3, concealment = -3 },
																adds = { "wpn_fps_ass_g36_body_sl8", },
																forbids = { "wpn_fps_ass_g36_body_standard", "wpn_fps_ass_g36_g_standard", },
															}
	self.parts.wpn_fps_ass_g36_s_standard 					= { type = "stock", name_id = "bm_wp_g36_s_standard", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_ass_g36_pts/wpn_fps_ass_g36_s_standard",
																stats = { value = 1 },
																adds = { "wpn_fps_ass_g36_body_standard", "wpn_fps_ass_g36_g_standard", },
																forbids = { "wpn_fps_ass_g36_body_sl8", },
															}
	...
	self.wpn_fps_ass_g36.optional_types = { "barrel_ext", "gadget", "sight" }
	...
	self.wpn_fps_ass_g36.default_blueprint = {										
											"wpn_fps_ass_g36_s_standard", "wpn_fps_ass_g36_m_standard",
											"wpn_fps_ass_g36_b_long","wpn_fps_ass_g36_fg_k",
											}
	self.wpn_fps_ass_g36.uses_parts = {
											"wpn_fps_ass_g36_body_standard", "wpn_fps_ass_g36_body_sl8",
											"wpn_fps_ass_g36_g_standard",
											"wpn_fps_ass_g36_m_standard",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_ass_g36_b_long", "wpn_fps_ass_g36_b_short",
											"wpn_fps_ass_g36_fg_c", "wpn_fps_ass_g36_fg_k", "wpn_fps_ass_g36_fg_ksk",
											"wpn_fps_ass_g36_s_standard", "wpn_fps_ass_g36_s_kv", "wpn_fps_ass_g36_s_sl8",
											"wpn_fps_upg_ns_ass_smg_large", "wpn_fps_upg_ns_ass_smg_medium", "wpn_fps_upg_ns_ass_smg_small",
											"wpn_fps_upg_ns_ass_smg_firepig", "wpn_fps_upg_ns_ass_smg_stubby", "wpn_fps_upg_ns_ass_smg_tank",
											"wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby", "wpn_fps_upg_vg_ass_smg_afg",					
											"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
...
function WeaponFactoryTweakData:_init_p90()
	...
	self.parts.wpn_fps_smg_p90_body_p90 					= { type = "lower_reciever", name_id = "bm_wp_p90_body_p90", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_smg_p90_pts/wpn_fps_smg_p90_body_p90",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_smg_p90_m_std 						= { type = "magazine", name_id = "bm_wp_p90_m_std", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_smg_p90_pts/wpn_fps_smg_p90_m_std",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	...
	self.wpn_fps_smg_p90.override = { 	wpn_upg_o_marksmansight_rear_vanilla = { a_obj = "a_or", },
												wpn_upg_o_marksmansight_front = { a_obj = "a_of", }
											 }
	...
	self.wpn_fps_smg_p90.default_blueprint = {
											"wpn_fps_smg_p90_body_p90",	"wpn_fps_smg_p90_b_short", "wpn_fps_smg_p90_m_std",
											"wpn_upg_o_marksmansight_rear_vanilla",
											}
	self.wpn_fps_smg_p90.uses_parts = {
											"wpn_fps_smg_p90_body_p90",
											"wpn_fps_smg_p90_m_std",
											"wpn_fps_smg_p90_b_short", "wpn_fps_smg_p90_b_long",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_upg_ns_ass_smg_large", "wpn_fps_upg_ns_ass_smg_medium", "wpn_fps_upg_ns_ass_smg_small",
											"wpn_fps_upg_ns_ass_smg_firepig", "wpn_fps_upg_ns_ass_smg_stubby", "wpn_fps_upg_ns_ass_smg_tank",
											"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
											"wpn_upg_o_marksmansight_rear_vanilla", "wpn_upg_o_marksmansight_front",
...
function WeaponFactoryTweakData:_init_m14()
	-- Parts
	self.parts.wpn_fps_ass_m14_b_standard 					= { type = "barrel", name_id = "bm_wp_m14_b_standard", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_ass_m14_pts/wpn_fps_ass_m14_b_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_m14_body_dmr 					= { type = "stock", name_id = "bm_wp_m14_body_dmr", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_m14_pts/wpn_fps_ass_m14_body_dmr",
																stats = { value = 1 },
															}
	-- BODY, Heavyweight, Best spread and Bad moving_spread
	self.parts.wpn_fps_ass_m14_body_ebr 					= { pcs = { 30, 40 } , type = "stock", name_id = "bm_wp_m14_body_ebr", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_m14_pts/wpn_fps_ass_m14_body_ebr",
																stats = { value = 6, spread_moving = 3, recoil = 2, concealment = 2 },
																forbids = { "wpn_fps_addon_ris"},
															}
	-- BODY, Lightweight, bad spread and Best moving_spread (INFAMOUS)
	self.parts.wpn_fps_ass_m14_body_jae 					= { pcs = { 30, 40 } , type = "stock", name_id = "bm_wp_m14_body_jae", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_m14_pts/wpn_fps_ass_m14_body_jae",
																stats = { value = 10, spread_moving = -2, recoil = 3, concealment = -2, spread = 1 },
																forbids = { "wpn_fps_addon_ris"},													
															}
	self.parts.wpn_fps_ass_m14_body_lower 					= { type = "lower_body", name_id = "bm_wp_m14_body_lower", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_m14_pts/wpn_fps_ass_m14_body_lower",
																stats = { value = 1 } 
															}
	self.parts.wpn_fps_ass_m14_body_upper 					= { type = "upper_body", name_id = "bm_wp_m14_body_upper", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_ass_m14_pts/wpn_fps_ass_m14_body_upper",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" }
															}
	self.parts.wpn_fps_ass_m14_m_standard 					= { type = "magazine", name_id = "bm_wp_m14_m_standard", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_ass_m14_pts/wpn_fps_ass_m14_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	...
	self.wpn_fps_ass_m14.optional_types = { "barrel_ext", "gadget", "sight" }
	self.wpn_fps_ass_m14.default_blueprint = {
											"wpn_fps_ass_m14_b_standard",
											"wpn_fps_ass_m14_body_lower", "wpn_fps_ass_m14_body_upper",
											"wpn_fps_ass_m14_body_dmr",
											"wpn_fps_ass_m14_m_standard",
											}
	self.wpn_fps_ass_m14.uses_parts = {
											"wpn_fps_ass_m14_b_standard",
											"wpn_fps_ass_m14_body_dmr", "wpn_fps_ass_m14_body_ebr", "wpn_fps_ass_m14_body_jae", "wpn_fps_ass_m14_body_lower",
...
function WeaponFactoryTweakData:_init_mp9()
	-- Parts
	self.parts.wpn_fps_smg_mp9_body_mp9 					= { type = "lower_reciever", name_id = "bm_wp_mp9_body_mp9", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_smg_mp9_pts/wpn_fps_smg_mp9_body_mp9",
																stats = { value = 1 },
																animations = { reload = "reload" }
															}
	-- Mag, Heavyweight, 30 rounds
	self.parts.wpn_fps_smg_mp9_m_extended 					= { pcs = { 20, 30, 40 } , type = "magazine", name_id = "bm_wp_mp9_m_extended", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_smg_mp9_pts/wpn_fps_smg_mp9_m_extended",
																stats = { value = 4, concealment = -2, spread_moving = -2, extra_ammo = 6 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_smg_mp9_m_short 						= { type = "magazine", name_id = "bm_wp_mp9_m_short", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_smg_mp9_pts/wpn_fps_smg_mp9_m_short",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_smg_mp9_s_fold 						= { type = "stock", name_id = "bm_wp_mp9_s_fold", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_smg_mp9_pts/wpn_fps_smg_mp9_s_fold",
																stats = { value = 1 }
															}
	...
	self.wpn_fps_smg_mp9.optional_types = { "barrel_ext", "gadget", "sight", "vertical_grip" }
	...
	self.wpn_fps_smg_mp9.uses_parts = {
											"wpn_fps_smg_mp9_body_mp9",
											"wpn_fps_smg_mp9_m_short", "wpn_fps_smg_mp9_m_extended",
											"wpn_fps_smg_mp9_s_skel", "wpn_fps_smg_mp9_s_fold",
											"wpn_fps_smg_mp9_b_dummy",
											"wpn_fps_upg_vg_ass_smg_verticalgrip", "wpn_fps_upg_vg_ass_smg_stubby",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_upg_ns_ass_smg_large", "wpn_fps_upg_ns_ass_smg_medium", "wpn_fps_upg_ns_ass_smg_small",
											"wpn_fps_upg_ns_ass_smg_firepig", "wpn_fps_upg_ns_ass_smg_stubby", "wpn_fps_upg_ns_ass_smg_tank",
...
function WeaponFactoryTweakData:_init_deagle()
	-- Parts
	self.parts.wpn_fps_pis_deagle_body_standard 			= { type = "lower_reciever", name_id = "bm_wp_deagle_body_standard", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_body_standard",
																stats = { value = 1 },
	...
	self.parts.wpn_fps_pis_deagle_b_standard 				= { type = "slide", name_id = "bm_wp_deagle_b_standard", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_b_standard",
																stats = { value = 1 }
															}
	-- Compensator, Barrelextension, bad spread moving, Best Recoil since heavy (INFAMOUS)
	self.parts.wpn_fps_pis_deagle_co_long 					= { pc = 40 , type = "barrel_ext", name_id = "bm_wp_deagle_co_long", a_obj = "a_co", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_co_long",
																stats = { value = 8, damage = 2, recoil = 2, spread_moving = -2, concealment = -2 }
															}
	-- Compensator, Barrelextension, Best Suppression, Bad spread moving, better recoil.
	self.parts.wpn_fps_pis_deagle_co_short					= { pc = 40 , type = "barrel_ext", name_id = "bm_wp_deagle_co_short", a_obj = "a_co", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_co_short",
																stats = { value = 6, damage = 1, recoil = 1, spread_moving = -1, concealment = -1, suppression = -5, }
															}
	self.parts.wpn_fps_pis_deagle_fg_rail 					= { type = "extra", name_id = "bm_wp_deagle_fg_rail", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_fg_rail",
																stats = { value = 1 }
															}
	-- Grip, Lightweight, Vanity (INFAMOUS)
	self.parts.wpn_fps_pis_deagle_g_bling 					= { pc = 40 , type = "grip", name_id = "bm_wp_deagle_g_bling", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_g_bling",
																stats = { value = 10, spread_moving = -2, recoil = 2, concealment = 1 }
															}
	-- Grip, Lightweight, Best spread_moving
	self.parts.wpn_fps_pis_deagle_g_ergo 					= { pc = 40 , type = "grip", name_id = "bm_wp_deagle_g_ergo", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_g_ergo",
																stats = { value = 6, spread_moving = 2, recoil = -1, spread = 1, concealment = -1 }
															}
	self.parts.wpn_fps_pis_deagle_g_standard 				= { type = "grip", name_id = "bm_wp_deagle_g_standard", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_g_standard",
																stats = { value = 1 }
															}
	-- Mag, Heavyweight
	self.parts.wpn_fps_pis_deagle_m_extended 				= { pc = 40 , type = "magazine", name_id = "bm_wp_deagle_m_extended", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_m_extended",
																stats = { value = 7, concealment = -2, spread_moving = -2, extra_ammo = 3 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_pis_deagle_m_standard 				= { type = "magazine", name_id = "bm_wp_deagle_m_standard", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_pis_deagle_o_standard_rear 			= { type = "extra", name_id = "bm_wp_deagle_o_standard_rear", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_o_standard_rear",
																stats = { value = 1 },
																-- animations = { fire = "recoil", reload = "reload", reload_not_empty = "reload" }
															}
	self.parts.wpn_fps_pis_deagle_o_standard_front 			= { type = "extra", name_id = "bm_wp_deagle_o_standard_front", a_obj = "a_os", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_o_standard_front",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_pis_deagle_o_standard_front_long 	= { type = "extra", name_id = "bm_wp_deagle_o_standard_front_long", a_obj = "a_ol", unit = "units/payday2/weapons/wpn_fps_pis_deagle_pts/wpn_fps_pis_deagle_o_standard_front_long",
																stats = { value = 1 }
															}
	...
	self.wpn_fps_pis_deagle.animations = { fire = "recoil", reload = "reload", fire_steelsight = "recoil", }
	self.wpn_fps_pis_deagle.optional_types = { "barrel_ext", "gadget", "sight" } -- , "sight", "vertical_grip" }
	self.wpn_fps_pis_deagle.adds = { wpn_fps_upg_fl_pis_laser = { "wpn_fps_pis_deagle_fg_rail" }, wpn_fps_upg_fl_pis_tlr1 = { "wpn_fps_pis_deagle_fg_rail" }, 
	...
	self.wpn_fps_pis_deagle.override = { wpn_upg_o_marksmansight_rear = { a_obj = "a_o", forbids = { "wpn_fps_pis_deagle_o_standard_front", "wpn_fps_pis_deagle_o_standard_front_long", "wpn_fps_pis_deagle_o_standard_rear" } },
	...
	self.wpn_fps_pis_deagle.uses_parts = {
											"wpn_fps_pis_deagle_body_standard",
											"wpn_fps_pis_deagle_b_standard", "wpn_fps_pis_deagle_b_long",
											"wpn_fps_pis_deagle_co_long", "wpn_fps_pis_deagle_co_short",
											"wpn_fps_pis_deagle_fg_rail",
											"wpn_fps_pis_deagle_g_bling", "wpn_fps_pis_deagle_g_ergo", "wpn_fps_pis_deagle_g_standard",
											"wpn_fps_pis_deagle_m_extended", "wpn_fps_pis_deagle_m_standard",
											"wpn_fps_pis_deagle_o_standard_rear", "wpn_fps_pis_deagle_o_standard_front", "wpn_fps_pis_deagle_o_standard_front_long",
											"wpn_upg_o_marksmansight_rear",
											
											"wpn_fps_upg_fl_pis_laser", "wpn_fps_upg_fl_pis_tlr1",
											"wpn_fps_upg_ns_pis_large", "wpn_fps_upg_ns_pis_medium", "wpn_fps_upg_ns_pis_small", "wpn_fps_upg_ns_pis_large_kac",
											"wpn_fps_upg_ns_pis_medium_gem" }
...
function WeaponFactoryTweakData:_init_mp5()
	-- Parts
	self.parts.wpn_fps_smg_mp5_b_m5k 						= { type = "barrel", name_id = "bm_wp_mp5_b_m5k", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_b_m5k",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_mp5_b_mp5a4 						= { type = "barrel", name_id = "bm_wp_mp5_b_mp5a4", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_b_mp5a4",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_mp5_b_mp5a5 						= { type = "barrel", name_id = "bm_wp_mp5_b_mp5a5", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_b_mp5a5",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_mp5_b_mp5sd 						= { type = "barrel", name_id = "bm_wp_mp5_b_mp5sd", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_b_mp5sd",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_mp5_body_mp5  					= { type = "lower_reciever", name_id = "bm_wp_mp5_body_mp5", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_body_mp5",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_mp5_body_rail 					= { type = "upper_reciever", name_id = "bm_wp_mp5_body_rail", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_body_rail",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_mp5_fg_mp5a4 					= { type = "foregrip", name_id = "bm_wp_mp5_fg_mp5a4", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_fg_mp5a4",
																stats = { value = 1 },
																adds = { "wpn_fps_smg_mp5_b_mp5a5" },
																animations = { reload = "reload"},
															}
	-- Foregrip, negative weight, Best spread_moving, Bad recoil, concealable
	self.parts.wpn_fps_smg_mp5_fg_m5k 						= { pcs = { 20, 30, 40 } , type = "foregrip", name_id = "bm_wp_mp5_fg_m5k", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_fg_m5k",
																stats = { value = 4, spread_moving = 3, recoil = -3, concealment = 3 }, 
	...
	self.parts.wpn_fps_smg_mp5_fg_mp5sd 					= { pcs = { 20, 30, 40 } , type = "foregrip", sub_type = "silencer", name_id = "bm_wp_mp5_fg_mp5sd", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_fg_mp5sd",																									
																stats = { value = 10, spread_moving = 1, suppression = 12, alert_size = 12, damage = -4, recoil = 3, concealment = 1 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_c" },
	...
	self.parts.wpn_fps_smg_mp5_m_drum 						= {  type = "magazine", name_id = "bm_wp_mp5_m_drum", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_m_drum",
																stats = { value = 5 }, 
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" } 
															}
	self.parts.wpn_fps_smg_mp5_m_std 						= { type = "magazine", name_id = "bm_wp_mp5_m_std", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_m_std",
																stats = { value = 1 }, 
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" } 
															}	
	-- Stock, lightweight, Bad recoil and Best moving_spread
	self.parts.wpn_fps_smg_mp5_s_adjust 					= { pcs = { 20, 30, 40 } , type = "stock", name_id = "bm_wp_mp5_s_adjust", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_smg_mp5_pts/wpn_fps_smg_mp5_s_adjust",
																stats = { value = 3, spread_moving = 1, concealment = 3 }
															}
	...
	self.wpn_fps_smg_mp5.optional_types = { "barrel_ext", "gadget", "sight", "vertical_grip" }
	self.wpn_fps_smg_mp5.adds = { 	wpn_fps_upg_o_specter = { "wpn_fps_smg_mp5_body_rail" },
	...
	self.wpn_fps_smg_mp5.uses_parts = {
											"wpn_fps_smg_mp5_body_mp5",
											"wpn_fps_smg_mp5_fg_m5k", "wpn_fps_smg_mp5_fg_mp5a4", "wpn_fps_smg_mp5_fg_mp5a5", "wpn_fps_smg_mp5_fg_mp5sd",
											"wpn_fps_smg_mp5_m_std", "wpn_fps_smg_mp5_m_drum",
											"wpn_fps_smg_mp5_s_ring", "wpn_fps_smg_mp5_s_adjust", "wpn_fps_smg_mp5_s_solid",
...
function WeaponFactoryTweakData:_init_colt_1911()
	-- Parts
	-- Barrel, long, Best spread
	self.parts.wpn_fps_pis_1911_b_long 						= { pcs = { 10, 20, 30, 40 } , type = "slide", name_id = "bm_wp_1911_b_long", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_b_long",
																stats = { value = 2, damage = 1, spread_moving = -2, spread = 2, recoil = 2, concealment = -2 },
																adds = { "wpn_fps_pis_1911_o_long", }, 
																override = { wpn_upg_o_marksmansight_front = { a_obj = "a_ol", } }, 
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil", } 
															}
	self.parts.wpn_fps_pis_1911_b_standard 					= { type = "slide", name_id = "bm_wp_1911_b_standard", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_b_standard",
																stats = { value = 1 },
																adds = { "wpn_fps_pis_1911_o_standard", }, 
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil", } 
															}
	-- Barrel, normal size, best spread_moving
	self.parts.wpn_fps_pis_1911_b_vented 					= { pcs = { 10, 20, 30, 40 } , type = "slide", name_id = "bm_wp_1911_b_vented", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_b_vented",
																stats = { value = 1, damage = 1, recoil = 2, spread_moving = 2, spread = -1, suppression = -2},
																adds = { "wpn_fps_pis_1911_o_standard", }, 
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil", } 
															}
	self.parts.wpn_fps_pis_1911_body_standard 				= { type = "lower_reciever", name_id = "bm_wp_1911_body_standard", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_body_standard",
																stats = { value = 1 },
																animations = { fire = "recoil", fire_steelsight = "recoil", } 
															}
	-- Compensator, Barrelextension, best Suppression, bad spread_moving (INFAMOUS)
	self.parts.wpn_fps_pis_1911_co_1 						= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id = "bm_wp_1911_co_1", a_obj = "a_co", parent = "slide", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_co_1",
																stats = { value = 5, damage = 1, suppression = -5, spread_moving = -1, recoil = 1, concealment = -1  }
															}
	-- Compensator, Barrelextension, bad Suppression, best spread_moving
	self.parts.wpn_fps_pis_1911_co_2 						= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id = "bm_wp_1911_co_2", a_obj = "a_co", parent = "slide", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_co_2",
																stats = { value = 2, damage = 2, suppression = -1, spread_moving = 1, recoil = 2, concealment = -1 }
															}
	-- Grip, Lightweight, Vanity (INFAMOUS)
	self.parts.wpn_fps_pis_1911_g_bling 					= { pcs = { 10, 20, 30, 40 } , type = "grip", name_id = "bm_wp_1911_g_bling", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_g_bling",
																stats = { value = 10, spread = 1, recoil = -1 }
															}
	-- Grip, Lightweight, Best spread_moving
	self.parts.wpn_fps_pis_1911_g_ergo 						= { pcs = { 10, 20, 30, 40 } , type = "grip", name_id = "bm_wp_1911_g_ergo", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_g_ergo",
																stats = { value = 2, spread_moving = 1, recoil = 1 }
															}
	self.parts.wpn_fps_pis_1911_g_standard 					= { type = "grip", name_id = "bm_wp_1911_g_standard", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_g_standard",
																stats = { value = 1 }
															}
	-- Mag, Heavyweight
	self.parts.wpn_fps_pis_1911_m_extended 					= { pcs = { 10, 20, 30, 40 } , type = "magazine", name_id = "bm_wp_1911_m_extended", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_m_extended",
																stats = { value = 3, spread_moving = -2, concealment = -1, extra_ammo = 3 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" } 
															}
	self.parts.wpn_fps_pis_1911_m_standard 					= { type = "magazine", name_id = "bm_wp_1911_m_standard", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" } 
															}
	self.parts.wpn_fps_pis_1911_o_long 						= { type = "extra", name_id = "bm_wp_1911_o_long", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_o_long",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_pis_1911_o_standard 					= { type = "extra", name_id = "bm_wp_1911_o_standard", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_pis_1911_pts/wpn_fps_pis_1911_o_standard",
																stats = { value = 1 }
															}
	...
	self.wpn_fps_pis_1911.optional_types = { "barrel_ext", "gadget", "sight" }
	self.wpn_fps_pis_1911.animations = { fire = "recoil", reload = "reload", }
	self.wpn_fps_pis_1911.override = { 	wpn_upg_o_marksmansight_rear = { a_obj = "a_o", forbids = { "wpn_fps_pis_1911_o_long", "wpn_fps_pis_1911_o_standard" } },
												wpn_upg_o_marksmansight_front = { a_obj = "a_os", }
											 }
	...
	self.wpn_fps_pis_1911.uses_parts = {
											"wpn_fps_pis_1911_body_standard",
											"wpn_fps_pis_1911_co_1", "wpn_fps_pis_1911_co_2",
											"wpn_fps_pis_1911_g_standard", "wpn_fps_pis_1911_g_bling", "wpn_fps_pis_1911_g_ergo",
											"wpn_fps_pis_1911_b_standard", "wpn_fps_pis_1911_b_long", "wpn_fps_pis_1911_b_vented",
											"wpn_fps_pis_1911_m_standard", "wpn_fps_pis_1911_m_extended",
											"wpn_fps_pis_1911_o_standard", "wpn_fps_pis_1911_o_long", "wpn_upg_o_marksmansight_rear",
...
function WeaponFactoryTweakData:_init_mac10()
	-- Parts
	self.parts.wpn_fps_smg_mac10_b_dummy 					= { type = "barrel", name_id = "bm_wp_mac10_b_dummy", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_smg_mac10_pts/wpn_fps_smg_mac10_b_dummy",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_mac10_body_mac10 				= { type = "lower_reciever", name_id = "bm_wp_mac10_body_mac10", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_smg_mac10_pts/wpn_fps_smg_mac10_body_mac10",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" },
															}
	-- Body, Heavyweight
	self.parts.wpn_fps_smg_mac10_body_ris 					= { pcs = { 10, 20, 30, 40 } , type = "extra", name_id = "bm_wp_mac10_body_ris", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_smg_mac10_pts/wpn_fps_smg_mac10_body_ris",
																stats = { value = 5, recoil = 2, spread_moving = -2, concealment = -2},
																adds = { "wpn_upg_o_marksmansight_rear_vanilla", }, 
																--override = { wpn_fps_smg_mac10_body_ris_special = { a_obj = "a_o", } },
																forbids = { "wpn_fps_addon_ris", "wpn_fps_smg_mac10_body_ris_special" },
															}
	self.parts.wpn_fps_smg_mac10_body_ris_special 			= { type = "extra", name_id = "bm_wp_mac10_body_ris_special", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_smg_mac10_pts/wpn_fps_smg_mac10_body_ris_special",
																stats = { value = 1 }, 
															}
	-- Mag, Heavyweight
	...
	self.parts.wpn_fps_smg_mac10_ris_dummy 					= { type = "lower_reciever", name_id = "bm_wp_mac10_ris_dummy", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_smg_mac10_pts/wpn_fps_smg_mac10_ris_dummy",
																stats = { value = 1 },
																adds = { "wpn_fps_smg_mac10_body_mac10", "wpn_fps_smg_mac10_body_ris", }
															}
	self.parts.wpn_fps_smg_mac10_s_fold 					= { type = "stock", name_id = "bm_wp_mac10_s_fold", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_smg_mac10_pts/wpn_fps_smg_mac10_s_fold",
																stats = { value = 1 }
															}
	...
	-- self.parts.wpn_fps_smg_mac10_ris_dummy.third_unit = 
	...
	self.wpn_fps_smg_mac10.override = { 	wpn_upg_o_marksmansight_rear_vanilla = { a_obj = "a_or" },
											wpn_upg_o_marksmansight_front_vanilla = { a_obj = "a_of", },
											 }

	self.wpn_fps_smg_mac10.adds = { 		wpn_fps_upg_o_specter = { "wpn_fps_smg_mac10_body_ris_special" },
	...
	self.wpn_fps_smg_mac10.uses_parts = {
											...
											"wpn_fps_smg_mac10_ris_dummy",
											"wpn_fps_smg_mac10_m_extended", "wpn_fps_smg_mac10_m_short",
											"wpn_fps_smg_mac10_body_mac10", -- "wpn_fps_smg_mac10_body_ris",
											"wpn_fps_smg_mac10_s_fold", "wpn_fps_smg_mac10_s_skel",
											
											"wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro",
											"wpn_upg_o_marksmansight_rear_vanilla",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_upg_ns_ass_smg_large", "wpn_fps_upg_ns_ass_smg_medium", "wpn_fps_upg_ns_ass_smg_small",
											"wpn_fps_upg_ns_ass_smg_firepig", "wpn_fps_upg_ns_ass_smg_stubby", "wpn_fps_upg_ns_ass_smg_tank",
...
function WeaponFactoryTweakData:_init_r870()
	-- Parts
	self.parts.wpn_fps_shot_r870_b_long 					= { type = "barrel", name_id = "bm_wp_r870_b_long", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_b_long",
																stats = { value = 1 }
															}
	...
	self.parts.wpn_fps_shot_r870_fg_big 					= { type = "foregrip", name_id = "bm_wp_r870_fg_big", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_fg_big",
																stats = { value = 1 },
																animations = { reload_exit = "reload_exit", fire = "recoil", fire_steelsight = "recoil_zoom" }
															}
	-- Should not exist.
	-- TODO : Remove this
	self.parts.wpn_fps_shot_r870_fg_railed 					= { --[[pcs = { 70, 80 } ,]] type = "foregrip", name_id = "bm_wp_r870_fg_railed", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_fg_railed",
																stats = { value = 1, spread_moving = 2 },
																animations = { reload_exit = "reload_exit", fire = "recoil", fire_steelsight = "recoil_zoom" }
														}
	self.parts.wpn_fps_shot_r870_fg_small 					= { type = "foregrip", name_id = "bm_wp_r870_fg_small", a_obj = "a_fg", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_fg_small",
																stats = { value = 1 },
																animations = { reload_exit = "reload_exit", fire = "recoil", fire_steelsight = "recoil_zoom" }
															}
	-- Foregrip, Heavyweight
	...
	-- Mag, Heavyweight
	self.parts.wpn_fps_shot_r870_m_extended 				= { pcs = { 10, 20, 30, 40 } , type = "magazine", name_id = "bm_wp_r870_m_extended", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_m_extended",
																stats = { value = 6, concealment = -1, spread_moving = -1, extra_ammo = 1 }
															}
	-- Stock, Heavyweight, Best moving_spread (INFAMOUS)	
	self.parts.wpn_fps_shot_r870_s_folding 					= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_r870_s_folding", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_s_folding",
																stats = { value = 9, spread_moving = 1, recoil = -1, concealment = 1 },
																forbids = { "wpn_fps_shot_r870_ris_special", "wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore", "wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog" },
															}
	self.parts.wpn_fps_shot_r870_s_m4 						= { type = "stock_adapter", name_id = "bm_wp_r870_s_m4", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_s_m4",
																stats = { value = 3, },
																forbids = { "wpn_fps_shot_r870_ris_special"},
															}
	-- Stock, Heavyweight, Best spread and Bad moving_spread
	self.parts.wpn_fps_shot_r870_s_solid 					= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_r870_s_solid", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_s_solid",
																stats = { value = 2, spread_moving = -2, recoil = 1, concealment = -1 },		
															}
	-- Stock, Normal weight, good moving_spread															
	self.parts.wpn_fps_shot_r870_s_nostock_big 				= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_r870_s_nostock_big", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_s_nostock_big",
																stats = { value = 4, spread_moving = 1, recoil = -3, concealment = 1 },
																forbids = { "wpn_fps_shot_r870_ris_special"},
															}
	-- Stock, lightweight, bad spread and best moving_spread
	self.parts.wpn_fps_shot_r870_s_nostock_single 			= { type = "stock", name_id = "bm_wp_r870_s_nostock_single", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_s_nostock_single",
																stats = { value = 3, spread_moving = 2, recoil = -3, concealment = 2 },
																forbids = { "wpn_fps_shot_r870_ris_special"},
															}	
	-- Stock, No weight, best moving_spread
	self.parts.wpn_fps_shot_r870_s_nostock 					= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_r870_s_nostock", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_s_nostock",
																stats = { value = 2, spread_moving = 1, recoil = -3, concealment = 3 },
															}
	-- Stock, Heavyweight, Best spread and Bad moving_spread	
	self.parts.wpn_fps_shot_r870_s_solid_big 				= { pcs = { 10, 20, 30, 40 } , type = "stock", name_id = "bm_wp_r870_s_solid_big", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_s_solid_big",
																stats = { value = 4, spread_moving = -2, recoil = 2, concealment = -2 },
																forbids = { "wpn_fps_shot_r870_ris_special"},
															}
	-- Stock, Heavyweight, medium spread and medium moving_spread	
	self.parts.wpn_fps_shot_r870_s_solid_single 			= { type = "stock", name_id = "bm_wp_r870_s_solid_single", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_s_solid_single",
																stats = { value = 3, spread_moving = -1, recoil = 1, concealment = -1 },
																forbids = { "wpn_fps_shot_r870_ris_special"},
															}
															
	self.parts.wpn_fps_shot_r870_gadget_rail 				= { type = "extra", name_id = "bm_wp_r870_s_solid_single", a_obj = "a_fl", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_gadget_rail",
																forbids = { "wpn_fps_addon_ris"},
															}
	self.parts.wpn_fps_shot_r870_ris_special 				= { type = "extra", name_id = "bm_wp_r870_s_solid_single", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_ris_special",
															}
		
	self.parts.wpn_fps_shot_r870_b_long.third_unit = "units/payday2/weapons/wpn_third_shot_r870_pts/wpn_third_shot_r870_b_long"
	--self.parts.wpn_fps_shot_r870_body_bigrail.third_unit = "units/payday2/weapons/wpn_third_shot_r870_pts/wpn_third_shot_r870_body_bigrail"
	...
	--self.parts.wpn_fps_shot_r870_body_singlerail.third_unit = "units/payday2/weapons/wpn_third_shot_r870_pts/wpn_third_shot_r870_body_singlerail"
	...
	self.wpn_fps_shot_r870.optional_types = { "barrel_ext", "gadget", "magazine", }
	self.wpn_fps_shot_r870.stock_adapter = "wpn_fps_shot_r870_s_m4"	
	self.wpn_fps_shot_r870.adds = { 		wpn_fps_upg_o_specter = { "wpn_fps_shot_r870_ris_special" },
	...
	self.wpn_fps_shot_r870.uses_parts = {
											"wpn_fps_shot_r870_body_rack", "wpn_fps_shot_r870_body_standard",
											"wpn_fps_shot_r870_b_long",
											"wpn_fps_shot_r870_fg_big", "wpn_fps_shot_r870_fg_railed", "wpn_fps_shot_r870_fg_wood",
											"wpn_fps_shot_r870_m_extended",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_shot_r870_s_folding", "wpn_fps_shot_r870_s_m4",
											"wpn_fps_upg_m4_s_standard", "wpn_fps_upg_m4_s_pts", 
											"wpn_fps_shot_r870_s_nostock_big", "wpn_fps_shot_r870_s_nostock_single", "wpn_fps_shot_r870_s_nostock",
											"wpn_fps_shot_r870_s_solid_vanilla", "wpn_fps_shot_r870_s_solid_big", "wpn_fps_shot_r870_s_solid_single",
											"wpn_fps_upg_m4_g_standard", "wpn_fps_upg_m4_g_ergo", "wpn_fps_upg_m4_g_sniper",
											"wpn_fps_upg_ns_shot_thick", "wpn_fps_upg_ns_shot_shark",
											"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
...
function WeaponFactoryTweakData:_init_serbu()
	-- Parts
	-- Mag, Lightweight,
	self.parts.wpn_fps_shot_shorty_m_extended_short 		= { pcs = { 20, 30, 40 } , type = "magazine", name_id = "bm_wp_shorty_m_extended_short", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_shot_shorty_pts/wpn_fps_shot_shorty_m_extended_short",
																stats = { value = 1, extra_ammo = 1 }
															}
	self.parts.wpn_fps_shot_r870_b_short 					= { type = "barrel", name_id = "bm_wp_serbu_b_short", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_shot_r870_pts/wpn_fps_shot_r870_b_short",
																stats = { value = 1 }
															}
	-- Stock, No weight, bad spread and best moving_spread
	self.parts.wpn_fps_shot_shorty_s_nostock_short 			= { pcs = { 20, 30, 40 } , type = "stock", name_id = "bm_wp_serbu_s_nostock_short", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_shorty_pts/wpn_fps_shot_shorty_s_nostock_short",
																stats = { value = 4, spread_moving = 2, recoil = -4, concealment = 3 },
																forbids = { "wpn_fps_shot_r870_ris_special"},
															}
	-- Stock, Light weight, Best spread and Bad moving_spread
	self.parts.wpn_fps_shot_shorty_s_solid_short 			= { pcs = { 20, 30, 40 } , type = "stock", name_id = "bm_wp_serbu_s_solid_short", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_shorty_pts/wpn_fps_shot_shorty_s_solid_short",
																stats = { value = 3, spread_moving = -2, recoil = 4, concealment = -3 },
																forbids = { "wpn_fps_shot_r870_ris_special"},
															}
	...
	self.wpn_fps_shot_serbu.optional_types = { "barrel_ext", "gadget", "magazine", }
	self.wpn_fps_shot_serbu.stock_adapter = "wpn_fps_shot_r870_s_m4"
	self.wpn_fps_shot_serbu.adds = { 		wpn_fps_upg_o_specter = { "wpn_fps_shot_r870_ris_special" },
											wpn_fps_upg_o_aimpoint = { "wpn_fps_shot_r870_ris_special" },
											wpn_fps_upg_o_aimpoint_2 = { "wpn_fps_shot_r870_ris_special" },
											wpn_fps_upg_o_docter = { "wpn_fps_shot_r870_ris_special" },
											wpn_fps_upg_o_eotech = { "wpn_fps_shot_r870_ris_special" },
	...
	self.wpn_fps_shot_serbu.uses_parts = {
											"wpn_fps_shot_r870_body_rack", "wpn_fps_shot_r870_body_standard",
											"wpn_fps_shot_r870_b_short",
											"wpn_fps_shot_r870_fg_railed", "wpn_fps_shot_r870_fg_small",
											"wpn_fps_shot_shorty_m_extended_short",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_shot_r870_s_folding",									
											"wpn_fps_shot_r870_s_m4", "wpn_fps_upg_m4_s_standard", "wpn_fps_upg_m4_s_pts", 
											"wpn_fps_shot_shorty_s_nostock_short", "wpn_fps_shot_r870_s_nostock_single", "wpn_fps_shot_r870_s_nostock_vanilla",
											"wpn_fps_shot_r870_s_solid", "wpn_fps_shot_shorty_s_solid_short", "wpn_fps_shot_r870_s_solid_single",
											"wpn_fps_upg_m4_g_standard", "wpn_fps_upg_m4_g_ergo", "wpn_fps_upg_m4_g_sniper",
											"wpn_fps_upg_ns_shot_thick", "wpn_fps_upg_ns_shot_shark",
											"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
...
function WeaponFactoryTweakData:_init_g17()
	-- Parts
	self.parts.wpn_fps_pis_g17_b_standard 				= { type = "slide", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_g17_pts/wpn_fps_pis_g17_b_standard",
															stats = { value = 1 },
															animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" } }
	self.parts.wpn_fps_pis_g17_body_standard 			= { type = "lower_reciever", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_pis_g17_pts/wpn_fps_pis_g17_body_standard",
															stats = { value = 1 }, 
															}
	self.parts.wpn_fps_pis_g17_m_standard 				= { type = "magazine", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_g17_pts/wpn_fps_pis_g17_m_standard",
															stats = { value = 1 },
															animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
														}
...
function WeaponFactoryTweakData:_init_b92fs()
	-- Parts
	self.parts.wpn_fps_pis_beretta_b_std 					= { type = "slide", name_id = "bm_wp_beretta_b_std", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_b_std",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_pis_beretta_body_beretta 			= { type = "lower_reciever", name_id = "bm_wp_beretta_body_beretta", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_body_beretta",
																stats = { value = 1 }, 
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" } 
															}
	self.parts.wpn_fps_pis_beretta_body_rail 				= { type = "extra", name_id = "bm_wp_beretta_body_rail", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_body_rail",
																stats = { value = 1 }
															}
	-- Compensator, bad Suppression, best spread_moving (INFAMOUS)
	self.parts.wpn_fps_pis_beretta_co_co1 					= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id = "bm_wp_beretta_co_co1", a_obj = "a_co", parent="slide", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_co_co1",
																stats = { value = 4, damage = 1, recoil = 1, spread = 1, spread_moving = 1, concealment = -2 }
															}
	-- Compensator, best Suppression, bad spread_moving
	self.parts.wpn_fps_pis_beretta_co_co2 					= { pcs = { 10, 20, 30, 40 } , type = "barrel_ext", name_id = "bm_wp_beretta_co_co2", a_obj = "a_co", parent="slide", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_co_co2",
																stats = { value = 3, damage = 2, suppression = -5, spread_moving = 2, concealment = -2 }
															}
	-- Grip, Lightweight, Best spread_moving, Recoil is better
	self.parts.wpn_fps_pis_beretta_g_ergo 					= { pcs = { 10, 20, 30, 40 } , type = "grip", name_id = "bm_wp_beretta_g_ergo", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_g_ergo",
																stats = { value = 2, spread_moving = 1, recoil = 1 }
															}
	self.parts.wpn_fps_pis_beretta_g_std 					= { type = "grip", name_id = "bm_wp_beretta_g_std", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_g_std",
																stats = { value = 1 }
															}
	-- Mag, Heavyweight
	self.parts.wpn_fps_pis_beretta_m_extended 				= { pcs = { 10, 20, 30, 40 } , type = "magazine", name_id = "bm_wp_beretta_m_extended", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_m_extended",
																stats = { value = 2, spread_moving = -2, concealment = -2, extra_ammo = 6 }, 
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" } 
															}
	self.parts.wpn_fps_pis_beretta_m_std 					= { type = "magazine", name_id = "bm_wp_beretta_m_std", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_m_std",
																stats = { value = 1 }, 
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_pis_beretta_o_std 					= { type = "sight", name_id = "bm_wp_beretta_o_std", a_obj = "a_o", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_o_std",
																stats = { value = 1 }
															}
	-- Body, Better spread , Recoil is better
	self.parts.wpn_fps_pis_beretta_sl_brigadier 			= { pcs = { 10, 20, 30, 40 } , type = "upper_reciever", name_id = "bm_wp_beretta_sl_brigadier", a_obj = "a_sl", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_sl_brigadier",
																stats = { value = 1, recoil = 2, spread_moving = -2 }, 
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" } 
															}
	self.parts.wpn_fps_pis_beretta_sl_std 					= { type = "upper_reciever", name_id = "bm_wp_beretta_sl_std", a_obj = "a_sl", unit = "units/payday2/weapons/wpn_fps_pis_b92fs_pts/wpn_fps_pis_beretta_sl_std",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" } 
															}
	
	-- self.parts.wpn_fps_pis_beretta_b_std.third_unit = "units/payday2/weapons/wpn_third_pis_b92fs_pts/wpn_fps_pis_beretta_b_std"
	...
	self.wpn_fps_pis_beretta.animations = { fire = "recoil", fire_steelsight = "recoil", reload = "reload", }
	self.wpn_fps_pis_beretta.optional_types = { "barrel_ext", "gadget", }
	self.wpn_fps_pis_beretta.adds = { 	wpn_fps_upg_fl_pis_laser = { "wpn_fps_pis_beretta_body_rail" },
												wpn_fps_upg_fl_pis_tlr1 = { "wpn_fps_pis_beretta_body_rail" }, }
	self.wpn_fps_pis_beretta.override = { --	wpn_upg_o_marksmansight_rear = { a_obj = "a_or", },
												wpn_upg_o_marksmansight_front = { a_obj = "a_os", }
											 }
	...
	self.wpn_fps_pis_beretta.uses_parts = {
											"wpn_fps_pis_beretta_b_std",
											"wpn_fps_pis_beretta_body_beretta", "wpn_fps_pis_beretta_body_rail",
											"wpn_fps_pis_beretta_co_co1", "wpn_fps_pis_beretta_co_co2",
											"wpn_fps_pis_beretta_g_ergo", "wpn_fps_pis_beretta_g_std", 
											"wpn_fps_pis_beretta_m_extended", "wpn_fps_pis_beretta_m_std", 
											"wpn_fps_pis_beretta_o_std", "wpn_upg_o_marksmansight_rear",
											"wpn_fps_pis_beretta_sl_std", "wpn_fps_pis_beretta_sl_brigadier",
...
function WeaponFactoryTweakData:_init_huntsman()
	-- Parts
	self.parts.wpn_fps_shot_huntsman_b_long 				= { type = "barrel", name_id = "bm_wp_huntsman_b_long", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_shot_huntsman_pts/wpn_fps_shot_huntsman_b_long",
																stats = { value = 1 }, 
																animations = { reload = "reload", reload_not_empty = "reload" }
															}
	-- Barrel, Negative weight, Crazy spread_moving, Recoil is WORST
	self.parts.wpn_fps_shot_huntsman_b_short 				= { pc = 40 , type = "barrel", name_id = "bm_wp_huntsman_b_short", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_shot_huntsman_pts/wpn_fps_shot_huntsman_b_short",
																stats = { value = 10, recoil = -4, spread = -4, spread_moving = 3, concealment = 10 },
																animations = { reload = "reload", reload_not_empty = "reload" }
															}
	self.parts.wpn_fps_shot_huntsman_body_standard 			= { type = "lower_reciever", name_id = "bm_wp_huntsman_body_standard", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_shot_huntsman_pts/wpn_fps_shot_huntsman_body_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_shot_huntsman_s_long 				= { type = "stock", name_id = "bm_wp_huntsman_s_long", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_huntsman_pts/wpn_fps_shot_huntsman_s_long",
																stats = { value = 1 }
															}
	-- Stock, Negative weight, Crazy spread_moving, Recoil is WORST
	self.parts.wpn_fps_shot_huntsman_s_short 				= { pc = 40 , type = "stock", name_id = "bm_wp_huntsman_s_short", a_obj = "a_s", unit = "units/payday2/weapons/wpn_fps_shot_huntsman_pts/wpn_fps_shot_huntsman_s_short",
																stats = { value = 10, recoil = -4, spread = -4, spread_moving = 3, concealment = 10 }
															}
	...
	self.wpn_fps_shot_huntsman.uses_parts = {
											"wpn_fps_shot_huntsman_body_standard",
											"wpn_fps_shot_huntsman_b_long", "wpn_fps_shot_huntsman_b_short",
											"wpn_fps_shot_huntsman_s_long", "wpn_fps_shot_huntsman_s_short",
											}
...
function WeaponFactoryTweakData:_init_raging_bull()
	...
	self.parts.wpn_fps_pis_rage_b_comp2 					= { pcs = { 10, 20, 30, 40 } , type = "slide", name_id = "bm_wp_rage_b_comp2", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_rage_pts/wpn_fps_pis_rage_b_comp2",
																stats = { value = 4, recoil = 1, damage = 1, spread = -1, spread_moving = 1, suppression = -4, concealment = -3 }
															}
	-- Barrel, Heavyweight, Bad Spread_moving, Recoil is better
	self.parts.wpn_fps_pis_rage_b_long 						= { pcs = { 10, 20, 30, 40 } , type = "slide", name_id = "bm_wp_rage_b_long", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_rage_pts/wpn_fps_pis_rage_b_long",
																stats = { value = 5, recoil = 3, spread = 3, spread_moving = -3, concealment = -3 }
															}
	-- Barrel, Negative weight, Best Spread_moving, Recoil is worst
	self.parts.wpn_fps_pis_rage_b_short 					= { pcs = { 10, 20, 30, 40 } , type = "slide", name_id = "bm_wp_rage_b_short", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_rage_pts/wpn_fps_pis_rage_b_short",
																stats = { value = 3, recoil = -3, spread_moving = 3, spread = -2, concealment = 3 }
															}
	self.parts.wpn_fps_pis_rage_b_standard 					= { type = "slide", name_id = "bm_wp_rage_b_standard", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_rage_pts/wpn_fps_pis_rage_b_standard",
																stats = { value = 1 }
															}
	-- Body, Best Recoil (INFAMOUS)
	self.parts.wpn_fps_pis_rage_body_smooth 				= { pcs = { 10, 20, 30, 40 } , type = "upper_reciever", name_id = "bm_wp_rage_body_smooth", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_pis_rage_pts/wpn_fps_pis_rage_body_smooth",
																stats = { value = 6, recoil = 1, concealment = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty", fire = "recoil", fire_steelsight = "recoil" } 
															}
	self.parts.wpn_fps_pis_rage_body_standard 				= { type = "upper_reciever", name_id = "bm_wp_rage_body_standard", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_pis_rage_pts/wpn_fps_pis_rage_body_standard",
																stats = { value = 1 }, 
																animations = { reload = "reload", reload_not_empty = "reload_not_empty", fire = "recoil", fire_steelsight = "recoil" } 
															}
	-- Grip, Lightweight, Best spread_moving
	self.parts.wpn_fps_pis_rage_g_ergo 						= { pcs = { 10, 20, 30, 40 } , type = "grip", name_id = "bm_wp_rage_g_ergo", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_rage_pts/wpn_fps_pis_rage_g_ergo",
																stats = { value = 2, spread_moving = 1, recoil = 1 }
															}
	self.parts.wpn_fps_pis_rage_g_standard 					= { type = "grip", name_id = "bm_wp_rage_g_standard", a_obj = "a_g", unit = "units/payday2/weapons/wpn_fps_pis_rage_pts/wpn_fps_pis_rage_g_standard",
																stats = { value = 1 }
															}	
	...
	self.wpn_fps_pis_rage.uses_parts = {
											"wpn_fps_pis_rage_body_standard", "wpn_fps_pis_rage_body_smooth",
											"wpn_fps_pis_rage_b_standard", "wpn_fps_pis_rage_b_short", "wpn_fps_pis_rage_b_long", "wpn_fps_pis_rage_b_comp1", "wpn_fps_pis_rage_b_comp2",
											"wpn_fps_pis_rage_g_standard", "wpn_fps_pis_rage_g_ergo", 
											}
...
function WeaponFactoryTweakData:_init_saw()
	...
	self.parts.wpn_fps_saw_b_normal 						= { type = "barrel", name_id = "bm_wp_saw_b_normal", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_saw_pts/wpn_fps_saw_b_normal",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_saw_body_standard 					= { type = "lower_reciever", name_id = "bm_wp_saw_body_standard", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_saw_pts/wpn_fps_saw_body_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_saw_m_blade 							= { type = "magazine", name_id = "bm_wp_saw_m_blade", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_saw_pts/wpn_fps_saw_m_blade",
																stats = { value = 1 }, 
...
function WeaponFactoryTweakData:_init_usp()
	...
	self.parts.wpn_fps_pis_usp_body_standard			= { type = "lower_reciever", a_obj = "a_body", unit = "units/payday2/weapons/wpn_fps_pis_usp_pts/wpn_fps_pis_usp_body_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_pis_usp_m_standard					= { type = "magazine", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_usp_pts/wpn_fps_pis_usp_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_pis_usp_fl_adapter					= { type = "extra", a_obj = "a_fl", unit = "units/payday2/weapons/wpn_fps_pis_usp_pts/wpn_fps_pis_usp_fl_adapter",
																stats = { value = 1 }
															}
	...
	self.parts.wpn_fps_pis_usp_b_tactical					= { type = "slide", name_id = "bm_wp_pis_usp_b_tactical", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_usp_pts/wpn_fps_pis_usp_b_tactical",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" }
															}
	self.parts.wpn_fps_pis_usp_b_expert							= { pcs = { 10, 20, 30, 40 }, type = "slide", name_id = "bm_wp_pis_usp_b_expert", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_usp_pts/wpn_fps_pis_usp_b_expert",
																stats = { value = 2, spread = 3, concealment = -1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" },
																dlc = "pd2_clan"
															}
	self.parts.wpn_fps_pis_usp_b_match							= { pcs = { 10, 20, 30, 40 }, type = "slide", name_id = "bm_wp_pis_usp_b_match", a_obj = "a_b", unit = "units/payday2/weapons/wpn_fps_pis_usp_pts/wpn_fps_pis_usp_b_match",
																stats = { value = 2, recoil = 2, spread = 1, concealment = -1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" },
																
																dlc = "pd2_clan"
															}
	
	self.parts.wpn_fps_pis_usp_m_extended						= { pcs = { 10, 20, 30, 40 }, type = "magazine", name_id = "bm_wp_pis_usp_m_extended", a_obj = "a_m", unit = "units/payday2/weapons/wpn_fps_pis_usp_pts/wpn_fps_pis_usp_m_extended",
																stats = { value = 2, spread_moving = -1, concealment = -1, extra_ammo = 4 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" },
																dlc = "pd2_clan"
															}
	...
	self.parts.wpn_fps_pis_usp_co_comp_1			= { pcs = { 10, 20, 30, 40 }, type = "barrel_ext", name_id = "bm_wp_usp_co_comp_1", a_obj = "a_co", parent = "slide", unit = "units/payday2/weapons/wpn_fps_pis_usp_pts/wpn_fps_pis_usp_co_comp_1",
																stats = { value = 4, suppression = -5, damage = 2, spread = -1, concealment = -1 },
																dlc = "pd2_clan"
															}
	
	self.parts.wpn_fps_pis_usp_co_comp_2			= { pcs = { 10, 20, 30, 40 }, type = "barrel_ext", name_id = "bm_wp_usp_co_comp_2", a_obj = "a_co", parent = "slide", unit = "units/payday2/weapons/wpn_fps_pis_usp_pts/wpn_fps_pis_usp_co_comp_2",
																stats = { value = 5, spread = 2, recoil = 2, concealment = -1 },
																dlc = "pd2_clan"
															}
	...
	self.wpn_fps_pis_usp.adds = { wpn_fps_upg_fl_pis_laser = { "wpn_fps_pis_usp_fl_adapter" },
	...
	self.wpn_fps_pis_usp.uses_parts = {
					...
					"wpn_fps_pis_usp_body_standard",
					"wpn_fps_pis_usp_m_standard", "wpn_fps_pis_usp_m_extended",
					"wpn_fps_pis_usp_b_expert", "wpn_fps_pis_usp_b_tactical",
					
					"wpn_fps_pis_usp_co_comp_1", "wpn_fps_pis_usp_co_comp_2",
					
					"wpn_fps_upg_fl_pis_laser", "wpn_fps_upg_fl_pis_tlr1",
					"wpn_fps_upg_ns_pis_large", "wpn_fps_upg_ns_pis_medium", "wpn_fps_upg_ns_pis_small",
					"wpn_fps_upg_ns_pis_large_kac",
					"wpn_fps_upg_ns_pis_medium_gem",
					}
...
function WeaponFactoryTweakData:_init_m45()
	...
	self.parts.wpn_fps_smg_m45_m_mag					= { type = "magazine", name_id = "bm_wp_shorty_m_extended_short", texture_bundle_folder = "dlc1", a_obj = "a_m", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_m_mag",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_smg_m45_m_extended			= { pcs = { 10, 20, 30, 40 }, type = "magazine", name_id = "bm_wp_smg_m45_m_extended", texture_bundle_folder = "dlc1", a_obj = "a_m", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_m_extended",
																stats = { value = 4, concealment = -2, extra_ammo = 6 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_smg_m45_b_standard			= { type = "barrel", name_id = "bm_wp_serbu_b_short", texture_bundle_folder = "dlc1", a_obj = "a_b", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_b_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_m45_b_green				= { pcs = { 10, 20, 30, 40 }, type = "barrel", name_id = "bm_wp_smg_m45_b_green", texture_bundle_folder = "dlc1", a_obj = "a_b", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_b_green",
																stats = { value = 3, spread = 1, concealment = -1 },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_smg_m45_b_small				= { pcs = { 10, 20, 30, 40 }, type = "barrel", name_id = "bm_wp_smg_m45_b_small", texture_bundle_folder = "dlc1", a_obj = "a_b", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_b_small",
																stats = { value = 2, spread = -2, concealment = 3 },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_smg_m45_body_standard	= { type = "upper_reciever", name_id = "bm_wp_serbu_s_nostock_short", texture_bundle_folder = "dlc1", a_obj = "a_body", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_body_standard",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil" }
															}
	self.parts.wpn_fps_smg_m45_body_green			= { pcs = { 10, 20, 30, 40 }, type = "upper_reciever", name_id = "bm_wp_smg_m45_body_green", texture_bundle_folder = "dlc1", a_obj = "a_body", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_body_green",
																stats = { value = 3, recoil = 1, concealment = -1 },
																animations = { reload = "reload", fire = "recoil" },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_smg_m45_s_standard			= { type = "stock", name_id = "bm_wp_serbu_s_solid_short", texture_bundle_folder = "dlc1", a_obj = "a_s", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_s_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_m45_s_folded				= { pcs = { 10, 20, 30, 40 }, type = "stock", name_id = "bm_wp_smg_m45_s_folded", texture_bundle_folder = "dlc1", a_obj = "a_s", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_s_folded",
																stats = { value = 2, recoil = -2, concealment = 6 },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_smg_m45_g_standard			= { type = "grip", name_id = "bm_wp_serbu_s_solid_short", texture_bundle_folder = "dlc1", a_obj = "a_g", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_g_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_m45_g_ergo					= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_smg_m45_g_ergo", texture_bundle_folder = "dlc1", a_obj = "a_g", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_g_ergo",
																stats = { value = 2, spread = 1, recoil = 1 },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_smg_m45_g_bling				= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_smg_m45_g_bling", texture_bundle_folder = "dlc1", a_obj = "a_g", unit = "units/pd2_dlc1/weapons/wpn_fps_smg_m45_pts/wpn_fps_smg_m45_g_bling",
																stats = { value = 2, recoil = 2, concealment = -1 },
																dlc = "armored_transport"
															}
	...
	self.wpn_fps_smg_m45.adds = { 		wpn_fps_upg_o_specter = { "wpn_fps_shot_r870_ris_special" },
											wpn_fps_upg_o_aimpoint = { "wpn_fps_shot_r870_ris_special" },
											wpn_fps_upg_o_aimpoint_2 = { "wpn_fps_shot_r870_ris_special" },
											wpn_fps_upg_o_docter = { "wpn_fps_shot_r870_ris_special" },
											wpn_fps_upg_o_eotech = { "wpn_fps_shot_r870_ris_special" },
	...
	self.wpn_fps_smg_m45.uses_parts = {
											"wpn_fps_smg_m45_m_mag", "wpn_fps_smg_m45_b_standard", "wpn_fps_smg_m45_body_standard", "wpn_fps_smg_m45_s_standard", "wpn_fps_smg_m45_g_standard",
											"wpn_fps_smg_m45_m_extended", "wpn_fps_smg_m45_b_small", "wpn_fps_smg_m45_b_green", "wpn_fps_smg_m45_body_green", "wpn_fps_smg_m45_s_folded", "wpn_fps_smg_m45_g_bling", "wpn_fps_smg_m45_g_ergo",
...
function WeaponFactoryTweakData:_init_s552()
	...
	self.parts.wpn_fps_ass_s552_o_flipup						= { type = "sight", name_id = "bm_wp_shorty_m_extended_short", texture_bundle_folder = "dlc1", a_obj = "a_of", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_o_flipup",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_s552_m_standard					= { type = "magazine", name_id = "bm_wp_shorty_m_extended_short", texture_bundle_folder = "dlc1", a_obj = "a_m", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_ass_s552_b_standard					= { type = "barrel", name_id = "bm_wp_serbu_b_short", texture_bundle_folder = "dlc1", a_obj = "a_b", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_b_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_s552_b_long							= { pcs = { 10, 20, 30, 40 }, type = "barrel", name_id = "bm_wp_ass_s552_b_long", texture_bundle_folder = "dlc1", a_obj = "a_b", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_b_long",
																stats = { value = 6, spread = 1, damage = 1, spread_moving = -4, concealment = -4 },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_ass_s552_body_standard				= { type = "upper_reciever", name_id = "bm_wp_serbu_s_nostock_short", texture_bundle_folder = "dlc1", a_obj = "a_body", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_body_standard",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil" }
															}
	self.parts.wpn_fps_ass_s552_body_standard_black	= { pcs = { 10, 20, 30, 40 }, type = "upper_reciever", name_id = "bm_wp_ass_s552_body_standard_black", texture_bundle_folder = "dlc1", a_obj = "a_body", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_body_standard_black",
																stats = { value = 7, spread = -1, damage = 1, concealment = 4 },
																animations = { reload = "reload", fire = "recoil" },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_ass_s552_fg_standard					= { type = "foregrip", name_id = "bm_wp_serbu_s_nostock_short", texture_bundle_folder = "dlc1", a_obj = "a_fg", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_fg_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_s552_fg_standard_green		= { pcs = { 10, 20, 30, 40 }, type = "foregrip", name_id = "bm_wp_ass_s552_fg_standard_green", texture_bundle_folder = "dlc1", a_obj = "a_fg", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_fg_standard_green",
																stats = { value = 1, spread = 2, concealment = -4 },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_ass_s552_fg_railed						= { pcs = { 10, 20, 30, 40 }, type = "foregrip", name_id = "bm_wp_ass_s552_fg_railed", texture_bundle_folder = "dlc1", a_obj = "a_fg", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_fg_railed",
																stats = { value = 7, spread_moving = -2, recoil = 5, concealment = -2 },
																forbids = { "wpn_fps_addon_ris" },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_ass_s552_g_standard					= { type = "grip", name_id = "bm_wp_serbu_s_solid_short", texture_bundle_folder = "dlc1", a_obj = "a_g", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_g_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_s552_g_standard_green		= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_ass_s552_g_standard_green", texture_bundle_folder = "dlc1", a_obj = "a_g", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_g_standard_green",
																stats = { value = 4, recoil = 2, concealment = -2 },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_ass_s552_s_m4								= { type = "stock", name_id = "bm_wp_serbu_s_solid_short", texture_bundle_folder = "dlc1", a_obj = "a_s", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_s_m4",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_s552_s_standard					= { type = "stock", name_id = "bm_wp_serbu_s_solid_short", texture_bundle_folder = "dlc1", a_obj = "a_s", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_s_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_s552_s_standard_green		= { pcs = { 10, 20, 30, 40 }, type = "stock", name_id = "bm_wp_ass_s552_s_standard_green", texture_bundle_folder = "dlc1", a_obj = "a_s", unit = "units/pd2_dlc1/weapons/wpn_fps_ass_s552_pts/wpn_fps_ass_s552_s_standard_green",
																stats = { value = 4, recoil = 2, concealment = -2 },
																dlc = "armored_transport"
															}
	...
	self.wpn_fps_ass_s552.adds = { 		wpn_fps_upg_fl_ass_smg_sho_surefire = { "wpn_fps_addon_ris" },
	...
	self.wpn_fps_ass_s552.uses_parts = {
											"wpn_fps_ass_s552_o_flipup",
											"wpn_fps_ass_s552_m_standard",
											"wpn_fps_ass_s552_b_standard", "wpn_fps_ass_s552_b_long",
											"wpn_fps_ass_s552_body_standard", "wpn_fps_ass_s552_body_standard_black",
											"wpn_fps_ass_s552_fg_standard", "wpn_fps_ass_s552_fg_railed", "wpn_fps_ass_s552_fg_standard_green",
											"wpn_fps_ass_s552_s_standard", "wpn_fps_ass_s552_s_m4", "wpn_fps_ass_s552_s_standard_green",
											"wpn_fps_ass_s552_g_standard", "wpn_fps_ass_s552_g_standard_green",
											
											
											"wpn_fps_upg_m4_s_standard_vanilla", "wpn_fps_upg_m4_s_pts",
											"wpn_fps_upg_o_specter", "wpn_fps_upg_o_aimpoint", "wpn_fps_upg_o_docter", "wpn_fps_upg_o_eotech", "wpn_fps_upg_o_t1micro", "wpn_fps_upg_o_rx30", "wpn_fps_upg_o_rx01", "wpn_fps_upg_o_reflex", "wpn_fps_upg_o_eotech_xps", "wpn_fps_upg_o_cmore",
											"wpn_fps_upg_o_aimpoint_2", "wpn_fps_upg_o_acog",
											"wpn_fps_upg_fl_ass_smg_sho_peqbox", "wpn_fps_upg_fl_ass_smg_sho_surefire",
											"wpn_fps_upg_ns_ass_smg_large", "wpn_fps_upg_ns_ass_smg_medium", "wpn_fps_upg_ns_ass_smg_small",
...
function WeaponFactoryTweakData:_init_ppk()
	...
	self.parts.wpn_fps_pis_ppk_b_long					= { pcs = { 10, 20, 30, 40 }, type = "slide", name_id = "bm_wp_pis_ppk_b_long", texture_bundle_folder = "dlc1", a_obj = "a_b", unit = "units/pd2_dlc1/weapons/wpn_fps_pis_ppk_pts/wpn_fps_pis_ppk_b_long",
																stats = { value = 3, damage = 1, spread = 2, spread_moving = -2, concealment = -2 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_pis_ppk_b_standard			= { type = "slide", name_id = "bm_wp_sppk_b_standard", texture_bundle_folder = "dlc1", a_obj = "a_b", unit = "units/pd2_dlc1/weapons/wpn_fps_pis_ppk_pts/wpn_fps_pis_ppk_b_standard",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" }
															}
	self.parts.wpn_fps_pis_ppk_body_standard	= { type = "lower_reciever", name_id = "bm_wp_serbu_s_solid_short", texture_bundle_folder = "dlc1", a_obj = "a_body", unit = "units/pd2_dlc1/weapons/wpn_fps_pis_ppk_pts/wpn_fps_pis_ppk_body_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_pis_ppk_fl_mount				= { type = "extra", name_id = "bm_wp_serbu_s_solid_short", texture_bundle_folder = "dlc1", a_obj = "a_fl", unit = "units/pd2_dlc1/weapons/wpn_fps_pis_ppk_pts/wpn_fps_pis_ppk_fl_mount",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_pis_ppk_g_laser				= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_pis_ppk_g_laser", texture_bundle_folder = "dlc1", a_obj = "a_g", unit = "units/pd2_dlc1/weapons/wpn_fps_pis_ppk_pts/wpn_fps_pis_ppk_g_laser",
																stats = { value = 1, spread = 2 }, perks = { "gadget" },
																dlc = "armored_transport"
															}
	self.parts.wpn_fps_pis_ppk_g_standard			= { type = "grip", name_id = "bm_wp_serbu_s_solid_short", texture_bundle_folder = "dlc1", a_obj = "a_g", unit = "units/pd2_dlc1/weapons/wpn_fps_pis_ppk_pts/wpn_fps_pis_ppk_g_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_pis_ppk_m_standard			= { type = "magazine", name_id = "bm_wp_serbu_s_solid_short", texture_bundle_folder = "dlc1", a_obj = "a_m", unit = "units/pd2_dlc1/weapons/wpn_fps_pis_ppk_pts/wpn_fps_pis_ppk_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	...
	self.wpn_fps_pis_ppk.animations = { fire = "recoil", fire_steelsight = "recoil", reload = "reload" }
	self.wpn_fps_pis_ppk.optional_types = { "barrel_ext", "gadget" }
	self.wpn_fps_pis_ppk.adds = { 		wpn_fps_upg_fl_pis_laser = { "wpn_fps_pis_ppk_fl_mount" },
	...
	self.wpn_fps_pis_ppk.uses_parts = {
											"wpn_fps_pis_ppk_b_standard", "wpn_fps_pis_ppk_b_long",
											"wpn_fps_pis_ppk_body_standard",
											"wpn_fps_pis_ppk_g_standard", "wpn_fps_pis_ppk_g_laser",
											"wpn_fps_pis_ppk_m_standard", "wpn_fps_pis_ppk_fl_mount",
...
function WeaponFactoryTweakData:_init_mp7()
	...
	self.parts.wpn_fps_smg_mp7_m_short					= { type = "magazine", name_id = "bm_wp_mp7_m_short", texture_bundle_folder = "gage_pack", a_obj = "a_m", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_smg_mp7_pts/wpn_fps_smg_mp7_m_short",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" },
															}
	self.parts.wpn_fps_smg_mp7_m_extended					= { pcs = { 10, 20, 30, 40 }, type = "magazine", name_id = "bm_wp_mp7_m_extended", texture_bundle_folder = "gage_pack", a_obj = "a_m", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_smg_mp7_pts/wpn_fps_smg_mp7_m_extended",
																stats = { value = 1, spread_moving = -1, concealment = -3, extra_ammo = 6 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" },
																dlc = "gage_pack"
															}
	self.parts.wpn_fps_smg_mp7_b_standard	= { type = "barrel", name_id = "bm_wp_mp7_b_standard", texture_bundle_folder = "gage_pack", a_obj = "a_b", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_smg_mp7_pts/wpn_fps_smg_mp7_b_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_mp7_b_suppressed					= { pcs = { 10, 20, 30, 40 }, type = "barrel_ext", sub_type = "silencer", name_id = "bm_wp_mp7_b_suppressed", texture_bundle_folder = "gage_pack", a_obj = "a_ns", parent = "barrel", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_smg_mp7_pts/wpn_fps_smg_mp7_b_suppressed",
																stats = { value = 4, spread = 1, suppression = 12, alert_size = 12, damage = -1, recoil = 3, spread_moving = -2, concealment = -2 }, perks = { "silencer" }, sound_switch = { suppressed = "suppressed_b" },
																dlc = "gage_pack"
															}
	self.parts.wpn_fps_smg_mp7_body_standard	= { type = "upper_reciever", name_id = "bm_wp_mp7_body_standard", texture_bundle_folder = "gage_pack", a_obj = "a_body", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_smg_mp7_pts/wpn_fps_smg_mp7_body_standard",
																stats = { value = 1 },
																adds = { "wpn_fps_upg_vg_ass_smg_stubby" },
																animations = { reload = "reload", fire = "recoil" }
															}
	self.parts.wpn_fps_smg_mp7_s_standard	= { type = "stock", name_id = "bm_wp_mp7_s_standard", texture_bundle_folder = "gage_pack", a_obj = "a_s", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_smg_mp7_pts/wpn_fps_smg_mp7_s_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_smg_mp7_s_long				= { pcs = { 10, 20, 30, 40 }, type = "stock", name_id = "bm_wp_mp7_s_long", texture_bundle_folder = "gage_pack", a_obj = "a_s", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_smg_mp7_pts/wpn_fps_smg_mp7_s_long",
																stats = { value = 1, recoil = 2, spread_moving = -1, concealment = -2 },
																dlc = "gage_pack"
															}
	...
	self.wpn_fps_smg_mp7.uses_parts = {
											...
											"wpn_fps_smg_mp7_m_extended", "wpn_fps_smg_mp7_b_suppressed", "wpn_fps_smg_mp7_s_long",
...
function WeaponFactoryTweakData:_init_scar()
	...
	self.parts.wpn_fps_ass_scar_m_standard			= { type = "magazine", name_id = "bm_wp_scar_m_standard", texture_bundle_folder = "gage_pack", a_obj = "a_m", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_ass_scar_ns_standard			= { type = "barrel_ext", name_id = "bm_wp_scar_ns_standard", texture_bundle_folder = "gage_pack", a_obj = "a_ns", parent = "barrel", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_ns_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_scar_ns_short				= { type = "barrel_ext", name_id = "bm_wp_scar_ns_short", texture_bundle_folder = "gage_pack", a_obj = "a_ns", parent = "barrel", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_ns_short",
																stats = { value = 1 }
															}
	
	self.parts.wpn_fps_ass_scar_b_long					= { pcs = {10, 20, 30, 40}, type = "barrel", name_id = "bm_wp_scar_b_long", texture_bundle_folder = "gage_pack", a_obj = "a_b", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_b_long",
																stats = { value = 4, spread = 2, spread_moving = -3, concealment = -3 },
																dlc = "gage_pack",
																
															}
	self.parts.wpn_fps_ass_scar_b_medium				= { type = "barrel", name_id = "bm_wp_scar_b_medium", texture_bundle_folder = "gage_pack", a_obj = "a_b", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_b_medium",
																stats = { value = 1 },
																
															}
	self.parts.wpn_fps_ass_scar_b_short					= { pcs = {10, 20, 30, 40}, type = "barrel", name_id = "bm_wp_scar_b_short", texture_bundle_folder = "gage_pack", a_obj = "a_b", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_b_short",
																stats = { value = 3, damage = 1, suppression = -2, spread = -1, spread_moving = 3, concealment = 3 },
																dlc = "gage_pack",
																override = { wpn_fps_ass_scar_ns_standard = { unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_ns_short", third_unit = "units/pd2_dlc_dec5/weapons/wpn_third_ass_scar_pts/wpn_third_ass_scar_ns_short" }
																}
																
															}
	self.parts.wpn_fps_ass_scar_body_standard		= { type = "upper_reciever", name_id = "bm_wp_scar_body_standard", texture_bundle_folder = "gage_pack", a_obj = "a_body", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_body_standard",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil" }
															}
	self.parts.wpn_fps_ass_scar_fg_railext			= { pcs = {10, 20, 30, 40}, type = "foregrip", name_id = "bm_wp_scar_fg_railext", texture_bundle_folder = "gage_pack", a_obj = "a_fg", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_fg_railext",
																stats = { value = 4, recoil = 1, spread_moving = -1, concealment = -1 },
																dlc = "gage_pack"
															}
	self.parts.wpn_fps_ass_scar_o_flipups_down	= { type = "extra", name_id = "bm_wp_scar_o_flipups_down", texture_bundle_folder = "gage_pack", a_obj = "a_o", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_o_flipups_down",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_scar_o_flipups_up		= { type = "sight", name_id = "bm_wp_scar_o_flipups_up", texture_bundle_folder = "gage_pack", a_obj = "a_o", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_o_flipups_up",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_ass_scar_s_sniper				= { pcs = {10, 20, 30, 40}, type = "stock", name_id = "bm_wp_scar_s_sniper", texture_bundle_folder = "gage_pack", a_obj = "a_s", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_s_sniper",
																stats = { value = 4, recoil = 2, spread_moving = -3, concealment = -3 },
																dlc = "gage_pack"
															}
	self.parts.wpn_fps_ass_scar_s_standard			= { type = "stock", name_id = "bm_wp_scar_s_standard", texture_bundle_folder = "gage_pack", a_obj = "a_s", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_ass_scar_pts/wpn_fps_ass_scar_s_standard",
																stats = { value = 1 }
															}
	...
	self.wpn_fps_ass_scar.adds = {	wpn_fps_upg_o_specter = { "wpn_fps_ass_scar_o_flipups_down" },
	...
	self.wpn_fps_ass_scar.uses_parts = {
											"wpn_fps_ass_scar_m_standard",
											"wpn_fps_ass_scar_ns_standard", "wpn_fps_ass_scar_ns_short",
											"wpn_fps_ass_scar_b_medium", "wpn_fps_ass_scar_b_long", "wpn_fps_ass_scar_b_short",
											"wpn_fps_ass_scar_body_standard", "wpn_fps_ass_scar_fg_railext",
											"wpn_fps_ass_scar_s_standard", "wpn_fps_ass_scar_s_sniper",
											"wpn_fps_ass_scar_o_flipups_up", "wpn_fps_ass_scar_o_flipups_down",
											"wpn_fps_upg_m4_g_hgrip_vanilla", "wpn_fps_upg_m4_g_mgrip",
											"wpn_fps_upg_m4_g_ergo", "wpn_fps_upg_m4_g_sniper",
...
function WeaponFactoryTweakData:_init_p226()
	...
	self.parts.wpn_fps_pis_p226_b_standard			= { type = "slide", name_id = "bm_wp_p226_b_standard", texture_bundle_folder = "gage_pack", a_obj = "a_b", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_b_standard",
																stats = { value = 1 },
																adds = { "wpn_fps_pis_p226_o_standard" },
																forbids = { "wpn_fps_pis_p226_o_long" },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" }
															}
	self.parts.wpn_fps_pis_p226_b_equinox				= { pcs = { 10, 20, 30, 40 }, type = "slide", name_id = "bm_wp_p226_b_equinox", texture_bundle_folder = "gage_pack", a_obj = "a_b", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_b_equinox",
																stats = { value = 4, suppression = -2, recoil = 1, damage = 2, spread_moving = 1 },
																dlc = "gage_pack",
																adds = { "wpn_fps_pis_p226_o_standard" },
																forbids = { "wpn_fps_pis_p226_o_long" },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" }
															}
	self.parts.wpn_fps_pis_p226_b_long					= { pcs = { 10, 20, 30, 40 }, type = "slide", name_id = "bm_wp_p226_b_long", texture_bundle_folder = "gage_pack", a_obj = "a_b", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_b_long",
																stats = { value = 6, damage = 1, spread = 2, recoil = 1, concealment = -3, spread_moving = -3 },
																dlc = "gage_pack",
																adds = { "wpn_fps_pis_p226_o_long" },
																forbids = { "wpn_fps_pis_p226_o_standard" },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" }
															}
	self.parts.wpn_fps_pis_p226_body_standard		= { type = "lower_reciever", name_id = "bm_wp_p226_body_standard", texture_bundle_folder = "gage_pack", a_obj = "a_body", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_body_standard",
																stats = { value = 1 },
																animations = { reload = "reload", fire = "recoil", fire_steelsight = "recoil" }
															}
	self.parts.wpn_fps_pis_p226_g_standard			= { type = "grip", name_id = "bm_wp_p226_g_standard", texture_bundle_folder = "gage_pack", a_obj = "a_g", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_g_standard",
																stats = { value = 1 }
															}
	self.parts.wpn_fps_pis_p226_g_ergo					= { pcs = { 10, 20, 30, 40 }, type = "grip", name_id = "bm_wp_p226_g_ergo", texture_bundle_folder = "gage_pack", a_obj = "a_g", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_g_ergo",
																stats = { value = 1, recoil = 1, concealment = -1 },
																dlc = "gage_pack"
															}
	self.parts.wpn_fps_pis_p226_m_standard			= { type = "magazine", name_id = "bm_wp_p226_m_standard", texture_bundle_folder = "gage_pack", a_obj = "a_m", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_m_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_pis_p226_m_extended			= { pcs = { 10, 20, 30, 40 }, type = "magazine", name_id = "bm_wp_p226_m_extended", texture_bundle_folder = "gage_pack", a_obj = "a_m", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_m_extended",
																stats = { value = 1, extra_ammo = 4, spread_moving = -2 },
																dlc = "gage_pack",
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_pis_p226_o_standard			= { type = "extra", name_id = "bm_wp_p226_o_standard", texture_bundle_folder = "gage_pack", a_obj = "a_o", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_o_standard",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	self.parts.wpn_fps_pis_p226_o_long					= { type = "extra", name_id = "bm_wp_p226_o_long", texture_bundle_folder = "gage_pack", a_obj = "a_o", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_o_long",
																stats = { value = 1 },
																animations = { reload = "reload", reload_not_empty = "reload_not_empty" }
															}
	...
	self.parts.wpn_fps_pis_p226_co_comp_1				= { pcs = { 10, 20, 30, 40 }, type = "barrel_ext", name_id = "bm_wp_p226_co_comp_1", a_obj = "a_co", parent = "slide", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_co_comp_1",
																stats = { value = 4, suppression = -5, damage = 2, spread = -1, concealment = -1 },
																dlc = "gage_pack"
															}
	
	self.parts.wpn_fps_pis_p226_co_comp_2				= { pcs = { 10, 20, 30, 40 }, type = "barrel_ext", name_id = "bm_wp_p226_co_comp_2", a_obj = "a_co", parent = "slide", unit = "units/pd2_dlc_dec5/weapons/wpn_fps_pis_p226_pts/wpn_fps_pis_p226_co_comp_2",
																stats = { value = 5, recoil = 2, spread = 2, concealment = -1 },
																dlc = "gage_pack"
															}
	...
	self.wpn_fps_pis_p226.animations = { fire = "recoil", fire_steelsight = "recoil", reload = "reload" }
	...
	self.wpn_fps_pis_p226.uses_parts = {
											"wpn_fps_pis_p226_b_standard", "wpn_fps_pis_p226_b_equinox", "wpn_fps_pis_p226_b_long",
											"wpn_fps_pis_p226_body_standard",
											"wpn_fps_pis_p226_g_standard", "wpn_fps_pis_p226_g_ergo",
											"wpn_fps_pis_p226_m_standard", "wpn_fps_pis_p226_m_extended",
											"wpn_fps_pis_p226_o_standard", "wpn_fps_pis_p226_o_long",
											
											
											"wpn_fps_pis_p226_co_comp_1", "wpn_fps_pis_p226_co_comp_2",
