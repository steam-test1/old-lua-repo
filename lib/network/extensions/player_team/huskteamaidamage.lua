...
TeamAIDamage._RESULT_NAME_TABLE = { "hurt", "bleedout", "death", "light_hurt", "heavy_hurt", "fatal" }
...
function HuskTeamAIDamage:damage_bullet( attack_data )
	...
	local damage_abs, damage_percent = self:_clamp_health_percentage( attack_data.damage, true ) -- round damage to a % of max health
...
------------------------------------------------------------------------------------------
-- Unit damage received from server. it can have happened on any client
...
------------------------------------------------------------------------------------------
-- sent from the host. The unit bled to death
...
------------------------------------------------------------------------------------------
-- sent from the host. The unit was electrocuted to incapacitation
...
------------------------------------------------------------------------------------------
-- sent from the host. The unit was revived or is not tased any more
...
------------------------------------------------------------------------------------------
-- Someone wants to revive us on the local machine
