...
function MenuComponentManager:set_active_components( components, node )
	...
	-- print( "set_active_components", inspect( components ) )
...
function MenuComponentManager:update( t, dt )
	...
	--[[
	for key, count in pairs( self._texture_cache ) do
		if type( count ) == "userdata" then
			TextureCache:unretrieve( count )
			self._texture_cache[ key ] = nil
		end
	end
	
	if #self._remove_requests > 0 then
		for key, texture_ids in ipairs( self._remove_requests ) do
			self._texture_cache[ texture_ids:key() ] = nil
			self._requested_textures[ texture_ids:key() ] = nil
			self._requested_index[ texture_ids:key() ] = nil
			TextureCache:unretrieve( texture_ids )
		end
...
-- Reported from MenuRenderer from MenuInput
-- Used to detect that the input is changed to not accepted
...
function MenuComponentManager:input_focus()
	...
	if( self._skilltree_gui ) then
		if( self._skilltree_gui:input_focus() ) then
			return 1
		end
	end
...
function MenuComponentManager:scroll_up()
	...
	if self._mission_briefing_gui then
		if self._mission_briefing_gui:scroll_up() then
			return true
		end
	end
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:scroll_up() then
			return true
		end
	end
	if self._lootdrop_gui then
		if self._lootdrop_gui:scroll_up() then
			return true
		end
	end
	if self._lootdrop_casino_gui then
...
function MenuComponentManager:scroll_down()
	...
	if self._mission_briefing_gui then
		if self._mission_briefing_gui:scroll_down() then
			return true
		end
	end
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:scroll_down() then
			return true
		end
	end
	if self._lootdrop_gui then
		if self._lootdrop_gui:scroll_down() then
			return true
		end
	end
	if self._lootdrop_casino_gui then
...
function MenuComponentManager:move_up()
	if self._skilltree_gui then
		if self._skilltree_gui:move_up() then
			return true
		end
	end
	if self._mission_briefing_gui then
	...
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:move_up() then
			return true
		end
	end
	if( self._blackmarket_gui ) then
		if( self._blackmarket_gui:move_up() ) then
			return true
		end
	end
	if( self._lootdrop_gui ) then
...
function MenuComponentManager:move_down()
	...
	if self._mission_briefing_gui then
		if self._mission_briefing_gui:move_down() then
			return true
		end
	end
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:move_down() then
			return true
		end
	end
	if( self._blackmarket_gui ) then
		if( self._blackmarket_gui:move_down() ) then
			return true
		end
	end
	if( self._lootdrop_gui ) then
		if( self._lootdrop_gui:move_down() ) then
			return true
		end
	end
	if( self._lootdrop_casino_gui ) then
...
function MenuComponentManager:move_left()
	if self._skilltree_gui then
		if self._skilltree_gui:move_left() then
			return true
		end
	end
	if self._mission_briefing_gui then
	...
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:move_left() then
			return true
		end
	end
	if( self._blackmarket_gui ) then
		if( self._blackmarket_gui:move_left() ) then
			return true
		end
	end
	if( self._lootdrop_gui ) then
		if( self._lootdrop_gui:move_left() ) then
			return true
		end
	end
	if( self._lootdrop_casino_gui ) then
...
function MenuComponentManager:move_right()
	...
	if self._mission_briefing_gui then
		if self._mission_briefing_gui:move_right() then
			return true
		end
	end
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:move_right() then
			return true
		end
	end
	if( self._blackmarket_gui ) then
		if( self._blackmarket_gui:move_right() ) then
			return true
		end
	end
	if( self._lootdrop_gui ) then
...
function MenuComponentManager:next_page()
	if self._skilltree_gui then
		if self._skilltree_gui:next_page(true) then
			return true
		end
	end
	if self._mission_briefing_gui then
		if self._mission_briefing_gui:next_page() then
			return true
		end
	end
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:next_page() then
			return true
		end
	end
	if( self._blackmarket_gui ) then
		if( self._blackmarket_gui:next_page() ) then
			return true
		end
	end
	if self._crimenet_gui then
		if self._crimenet_gui:next_page() then
			return true
		end
	end
	if( self._lootdrop_gui ) then
	...
	if self._ingame_manual_gui then
		if self._ingame_manual_gui:next_page() then
			return true
		end
	end
end
...
function MenuComponentManager:previous_page()
	if self._skilltree_gui then
		if self._skilltree_gui:previous_page(true) then
			return true
		end
	end
	if self._mission_briefing_gui then
		if self._mission_briefing_gui:previous_page() then
			return true
		end
	end
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:previous_page() then
			return true
		end
	end
	if( self._blackmarket_gui ) then
		if( self._blackmarket_gui:previous_page() ) then
			return true
		end
	end
	if self._crimenet_gui then
		if self._crimenet_gui:previous_page() then
			return true
		end
	end
	if( self._lootdrop_gui ) then
		if( self._lootdrop_gui:previous_page() ) then
			return true
		end
	end
	if( self._lootdrop_casino_gui ) then
...
function MenuComponentManager:confirm_pressed()
	if self._skilltree_gui then
		if self._skilltree_gui:confirm_pressed() then
			return true
		end
	end
	if self._mission_briefing_gui then
	...
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:confirm_pressed() then
			return true
		end
	end
	if( self._blackmarket_gui ) then
		if( self._blackmarket_gui:confirm_pressed() ) then
			return true
		end
	end
	if self._crimenet_gui then
		if self._crimenet_gui:confirm_pressed() then
			return true
		end
	end
	if( self._lootdrop_gui ) then
		if( self._lootdrop_gui:confirm_pressed() ) then
			return true
		end
	end
	if( self._lootdrop_casino_gui ) then
...
function MenuComponentManager:back_pressed()
	if self._mission_briefing_gui then
		if self._mission_briefing_gui:back_pressed() then
			return true
		end
	end
	if self._stage_endscreen_gui then
		if self._stage_endscreen_gui:back_pressed() then
			return true
		end
	end
	if( self._lootdrop_gui ) then
...
function MenuComponentManager:special_btn_pressed( ... )
	if self._skilltree_gui then
		if self._skilltree_gui:special_btn_pressed( ... ) then
			return true
		end
	end
	if self._blackmarket_gui then
		if self._blackmarket_gui:special_btn_pressed( ... ) then
			return true
		end
	end
	if self._crimenet_contract_gui then
		if self._crimenet_contract_gui:special_btn_pressed( ... ) then
			return true
		end
	end
	if self._crimenet_gui then
		if self._crimenet_gui:special_btn_pressed( ... ) then
			return true
		end
	end
	if self._mission_briefing_gui then
		if self._mission_briefing_gui:special_btn_pressed( ... ) then
			return true
		end
	end
	if( self._lootdrop_gui ) then
		if( self._lootdrop_gui:special_btn_pressed( ... ) ) then
			return true
		end
	end
	if( self._lootdrop_casino_gui ) then
...
function MenuComponentManager:mouse_pressed( o, button, x, y )
	...
	if( self._blackmarket_gui ) then
		if self._blackmarket_gui:mouse_pressed( button, x, y ) then
			return true
		end
	end
	
	if self._game_chat_gui then
		if self._game_chat_gui:mouse_pressed( button, x, y ) then
			return true
		end
		--[[
		if button == Idstring( "0" ) then
			if self._chat_book:check_minimize( x, y ) then
				-- self._chat_book:set_visible( false )
				local minimized_data = { callback = callback( self, self, "_maximize_chat_book" ), text = "CHATS", help_text = "MAXIMIZE CHAT WINDOW" }
				self._chat_book:set_minimized( true, minimized_data )
				-- self._chat_book_minimized_id = self:add_minimized( minimized_data )
				return true
			end
			if self._chat_book:check_grab_scroll_bar( x, y ) then
				return true
			end
		elseif button == Idstring( "mouse wheel down" ) then
			if self._chat_book:mouse_wheel_down( x, y ) then
				return true
			end
		elseif button == Idstring( "mouse wheel up" ) then
			if self._chat_book:mouse_wheel_up( x, y ) then
				return true
			end
		end]]
	end
	...
	if self._newsfeed_gui then
		if self._newsfeed_gui:mouse_pressed( button, x, y ) then
			return true
		end
	end
	...
	if self._profile_gui then
		...
		if button == Idstring( "0" ) then
			if self._profile_gui:check_minimize( x, y ) then
				local minimized_data = { --[[callback = callback( self, self, "_maximize_profile_gui" ),]] text = "PROFILE", help_text = "MAXIMIZE PROFILE WINDOW" }
				-- self._profile_gui:set_visible( false )
				self._profile_gui:set_minimized( true, minimized_data )
				-- self._profile_gui_minimized_id = self:add_minimized( { callback = callback( self, self, "_maximize_profile_gui" ), text = "PROFILE", help_text = "MAXIMIZE PROFILE WINDOW" } )
				return true
			end
		...
		elseif button == Idstring( "mouse wheel up" ) then
			if self._profile_gui:mouse_wheel_up( x, y ) then
				return true
			end
		end
	end
	...
	if self._contract_gui then
		...
		if button == Idstring( "0" ) then
			if self._contract_gui:check_minimize( x, y ) then
				...
				-- self._contract_gui:set_visible( false )
				-- self._contract_gui_minimized_id = self:add_minimized( { callback = callback( self, self, "_maximize_contract_gui" ), text = "CONTRACT", help_text = "MAXIMIZE CONTRACT WINDOW" } )
				return true
			end
		...
		elseif button == Idstring( "mouse wheel up" ) then
			if self._contract_gui:mouse_wheel_up( x, y ) then
				return true
			end
		end
	end
	...
	if self._server_info_gui then
		...
		elseif button == Idstring( "mouse wheel up" ) then
			if self._server_info_gui:mouse_wheel_up( x, y ) then
				return true
			end
		end
	end
	...
	if self._lobby_profile_gui then
		...
		if button == Idstring( "0" ) then
			if self._lobby_profile_gui:check_minimize( x, y ) then
				-- self._lobby_profile_gui:set_visible( false )
				-- self._lobby_profile_gui_minimized_id = self:add_minimized( { callback = callback( self, self, "_maximize_lobby_profile_gui" ), text = "PROFILE", help_text = "MAXIMIZE PROFILE WINDOW" } )
				return true
			end
		...
		elseif button == Idstring( "mouse wheel up" ) then
			if self._lobby_profile_gui:mouse_wheel_up( x, y ) then
				return true
			end
		end
	end
	...
	if( self._mission_briefing_gui ) then
		if self._mission_briefing_gui:mouse_pressed( button, x, y ) then
			return true
		end
	end
	if( self._stage_endscreen_gui ) then
		if self._stage_endscreen_gui:mouse_pressed( button, x, y ) then
			return true
		end
	end
	...
	if self._view_character_profile_gui then
		...
		if button == Idstring( "0" ) then
			if self._view_character_profile_gui:check_minimize( x, y ) then
				-- self._view_character_profile_gui:set_visible( false )
				-- self._view_character_profile_gui_minimized_id = self:add_minimized( { callback = callback( self, self, "_maximize_view_character_profile_gui" ), text = "PROFILE", help_text = "MAXIMIZE PROFILE WINDOW" } )
				return true
			end
		...
		elseif button == Idstring( "mouse wheel up" ) then
			if self._view_character_profile_gui:mouse_wheel_up( x, y ) then
				return true
			end
		end
	end
	...
	if self._crimenet_contract_gui then
		if self._crimenet_contract_gui:mouse_pressed( o, button, x, y ) then
			return true
		end
	end	
	if self._crimenet_gui then
		if self._crimenet_gui:mouse_pressed( o, button, x, y ) then
			return true
		end
	end	
	...
	if self._friends_book then
		...
		elseif button == Idstring( "mouse wheel up" ) then
			if self._friends_book:mouse_wheel_up( x, y ) then
				return true
			end
		end
	end
	...
	if self._debug_strings_book then
		...
		elseif button == Idstring( "mouse wheel up" ) then
			if self._debug_strings_book:mouse_wheel_up( x, y ) then
				return true
			end
		end
	end
	...
	if self._weapon_text_box then
		...
		elseif button == Idstring( "mouse wheel up" ) then
			if self._weapon_text_box:mouse_wheel_up( x, y ) then
				return true
			end
		end
	end
...
function MenuComponentManager:mouse_released( o, button, x, y )
	if self._game_chat_gui then
		if self._game_chat_gui:mouse_released( o, button, x, y ) then
			return true
		end
	end
	if self._crimenet_gui then
		if self._crimenet_gui:mouse_released( o, button, x, y ) then
			return true
		end
	end
	if self._blackmarket_gui then
	...
	if self._friends_book then
		if self._friends_book:release_scroll_bar() then
			return true
		end
	end
	if self._skilltree_gui then
		if self._skilltree_gui:mouse_released( button, x, y ) then
			return true
		end
	end
	
	if self._debug_strings_book then
		if self._debug_strings_book:release_scroll_bar() then
			return true
		end
	end
	...
	if self._profile_gui then
		if self._profile_gui:release_scroll_bar() then
			return true
		end
	end
	
	if self._contract_gui then
		if self._contract_gui:release_scroll_bar() then
			return true
		end
	end
	
	if self._server_info_gui then
		if self._server_info_gui:release_scroll_bar() then
			return true
		end
	end
		
	if self._lobby_profile_gui then
		if self._lobby_profile_gui:release_scroll_bar() then
			return true
		end
	end
	
	if self._view_character_profile_gui then
		if self._view_character_profile_gui:release_scroll_bar() then
			return true
		end
	end
	...
	if self._weapon_text_box then
		if self._weapon_text_box:release_scroll_bar() then
			return true
		end
	end
...
function MenuComponentManager:mouse_moved( o, x, y )
	...
	if self._friends_book then
		--[[if self._friends_book:moved_scroll_bar( x, y ) then
			return true, wanted_pointer
		end]]
	...
	if self._game_chat_gui then
		-- local used, pointer = self._chat_book:moved_scroll_bar( x, y )
		-- if used then
		-- 	return true, pointer
		-- end
	...
	if self._test_profile1 then
		...
		if used then return true, pointer end
	...
	if self._weapon_text_box then
		if self._weapon_text_box:moved_scroll_bar( x, y ) then
			return true, wanted_pointer
		end
	end
...
function MenuComponentManager:close_crimenet_gui()
	-- print( "MenuComponentManager:_close_crimenet_gui", self._crimenet_gui )
	if self._crimenet_gui then
...
function MenuComponentManager:create_weapon_box( w_id, params )
	...
	local stats_list = { 	{ type = "bar", text = "DAMAGE: 32(+6)", current = 32, total = 50 },
							...
							{ type = "empty", h = 10 },
							{ type = "mods", list = { "SHORTENED BARREL", "SPEEDHOLSTER SLING", "ONMILTE TRITIUM SIGHTS" } },
							{ type = "empty", h = 10 },
						}
-- 	self:_create_text_box( title, text, { stats_list = stats_list }, { type = "weapon_stats", no_close_legend = true, use_minimize_legend = true } )
...
--[[function MenuComponentManager:_create_text_box( ... )
	-- self:_close_weapon_box()
	if self._weapon_text_box then
		self._weapon_text_box:recreate_text_box( self._ws, ... )
	else
		self._weapon_text_box = TextBoxGui:new( self._ws, ... )
	end
end]]
...
function MenuComponentManager:create_chat_gui()
	...
	--[[local crew_gui = ChatGui:new( self._ws, "Crew", "" )
	crew_gui:set_channel_id( ChatManager.CREW )
	crew_gui:set_layer( self._chat_book:layer() )]]
	...
	--[[local chat_gui2 = ChatGui:new( self._ws, "FutureCatCar", "" )
	chat_gui2:set_channel_id( 4 )
	chat_gui2:set_layer( self._chat_book:layer() )]]
	
	--[[local crew2_gui = ChatGui:new( self._ws, "Crew2", "" )
	crew2_gui:set_channel_id( ChatManager.CREW )
	crew2_gui:set_layer( self._chat_book:layer() )]]
		
	-- self._chat_book:add_page( "Crew", crew_gui, true )
 	self._chat_book:add_page( "Global", global_gui, false )
	-- self._chat_book:add_page( "FutureCatCar", chat_gui2, false )
	-- self._chat_book:add_page( "Crew2", crew2_gui, false )
...
function MenuComponentManager:add_game_chat()
	if( SystemInfo:platform() == Idstring( "WIN32" ) ) then
		...
		-- if self._chat_book:has_page( "Game" ) then
		-- 	return
		-- end
		
		self._game_chat_gui = ChatGui:new( self._ws ) -- , "Game", "" )
		if( self._game_chat_params ) then
			self._game_chat_gui:set_params( self._game_chat_params )
			self._game_chat_params = nil
		end
		
		-- self._game_chat_gui:set_channel_id( ChatManager.GAME )
		-- game_gui:set_layer( self._chat_book:layer() )
		
		-- self._chat_book:add_page( "Game", game_gui, true )
	end
end
...
function MenuComponentManager:pre_set_game_chat_leftbottom( from_left, from_bottom )
	if( self._game_chat_gui ) then
		self._game_chat_gui:set_leftbottom( from_left, from_bottom )	-- from the left / bottom
	else
		self._game_chat_params = self._game_chat_params or {}
...
function MenuComponentManager:remove_game_chat()
	...
	-- print( "MenuComponentManager:remove_game_chat" )
...
function MenuComponentManager:close_chat_gui()
	if self._game_chat_gui then
		-- print( "MenuComponentManager:_close_chat_gui", self._chat_book )
		-- Application:stack_dump()
...
function MenuComponentManager:close_friends_gui()
	-- print( "MenuComponentManager:_friends_gui", self._friends_gui )
	if self._friends_gui then
		-- self._friends_gui:close()
...
function MenuComponentManager:close_contract_gui()
	...
	--[[if self._contract_gui_minimized_id then
		self:remove_minimized( self._contract_gui_minimized_id )
		self._contract_gui_minimized_id = nil
	end]]
end
...
function MenuComponentManager:_create_skilltree_gui()
	--[[if self._skilltree_gui then
		self._skilltree_gui:set_enabled( true )
		return
	end]]
...
function MenuComponentManager:_create_server_info_gui()	
	if self._server_info_gui then
		-- self._server_info_gui:set_enabled( true )
...
function MenuComponentManager:_create_stage_endscreen_gui()
	-- print( "_create_stage_endscreen_gui()" )
	self:create_stage_endscreen_gui()
end

function MenuComponentManager:create_stage_endscreen_gui()
	-- print( "create_stage_endscreen_gui()" )
	-- self:close_stage_endscreen_gui()
	
	if( not self._stage_endscreen_gui ) then
		self._stage_endscreen_gui = StageEndScreenGui:new( self._ws, self._fullscreen_ws ) -- , self._endscreen_data )
	end
	game_state_machine:current_state():set_continue_button_text()
...
function MenuComponentManager:show_stage_endscreen_gui()
	-- print( "show_stage_endscreen_gui()" )
	if self._stage_endscreen_gui then
		self._stage_endscreen_gui:show()
	end
end
...
function MenuComponentManager:set_endscreen_continue_button_text( text, not_clickable )
	-- print( "set_endscreen_continue_button_text( text, not_clickable )", self._stage_endscreen_gui, text, not_clickable )
	if self._stage_endscreen_gui then
...
function MenuComponentManager:refresh_player_profile_gui()
	if self._player_profile_gui then
		self:create_player_profile_gui()	-- create closes first, so this is "fine"
	end
end
...
function MenuComponentManager:close_player_profile_gui()
	...
	--[[if self._profile_gui_minimized_id then
		self:remove_minimized( self._profile_gui_minimized_id )
		self._profile_gui_minimized_id = nil
	end]]
end
...
function MenuComponentManager:create_test_profiles()
	...
	self._test_profile1 = ProfileBoxGui:new( self._ws ) self._test_profile1:set_title( "" ) self._test_profile1:set_use_minimize_legend( false )
	self._test_profile2 = ProfileBoxGui:new( self._ws ) self._test_profile2:set_title( "" ) self._test_profile2:set_use_minimize_legend( false )
	self._test_profile3 = ProfileBoxGui:new( self._ws ) self._test_profile3:set_title( "" ) self._test_profile3:set_use_minimize_legend( false )
	self._test_profile4 = ProfileBoxGui:new( self._ws ) self._test_profile4:set_title( "" ) self._test_profile4:set_use_minimize_legend( false )
end
...
function MenuComponentManager:create_weapon_mod_icon_list( weapon, category, factory_id, slot )
	...
	if table.size( mods_all ) > 0 then
		...
		table.sort( mods_sorted, function( x, y ) return y < x end )
...
function MenuComponentManager:create_debug_strings_gui()
	...
	self._debug_strings_book = BookBoxGui:new( self._ws, nil, { no_close_legend = true, no_scroll_legend = true , w = 1280 * 0.85, h = 720 * 0.85 } )
...
function MenuComponentManager:close_debug_strings_gui()
	-- print( "MenuComponentManager:_debug_strings_gui", self._debug_strings_gui )
	-- if self._debug_strings_book then
...
--[[function MenuComponentManager:_maximize_chat_book( data )
	self._chat_book:set_visible( true )
	self._chat_book_minimized_id = nil
	self:remove_minimized( data.id )
end]]

--[[function MenuComponentManager:_maximize_profile_gui( data )
	self._profile_gui:set_visible( true )
	self._profile_gui_minimized_id = nil
	self:remove_minimized( data.id )
end]]

--[[function MenuComponentManager:_maximize_contract_gui( data )
	self._contract_gui:set_visible( true )
	self._contract_gui_minimized_id = nil
	self:remove_minimized( data.id )
end]]
...
function MenuComponentManager:add_minimized( config )
	...
	local text
	if config.text then
		text = panel:text( { text = config.text, align="center", halign="left", vertical="center", hvertical="center",
							font = tweak_data.menu.default_font, font_size = 22, layer = 2 } )
	...
	local help_text = panel:parent():text( { text = config.help_text or "CLICK TO MAXIMIZE WEAPON INFO", align="left", halign="left", vertical="center", hvertical="center",
							visible = false, font = tweak_data.menu.small_font, font_size = tweak_data.menu.small_font_size, color = Color.white, layer = 3 } )
	...
	-- panel:set_bottom( self._bottom_line:top() )
...
function MenuComponentManager:_request_done_callback( texture_ids )
	--print( "[MenuComponentManager:_request_done_callback]", texture_ids )
...
function MenuComponentManager:request_texture( texture, done_cb )
	...
	local key = texture_ids:key()
	local is_removing = self._removing_textures[ key ] and true or false -- table.contains( self._removing_textures, texture_ids )
	self._removing_textures[ key ] = nil
	-- table.delete( self._removing_textures, texture_ids )
	...
	elseif self._requested_textures[ key ] then
		...
		self._requested_index[ key ] = count
		self._requested_textures[ key ][ count ] = done_cb
		-- table.insert( self._requested_textures[ key ], done_cb )
	...
	if self._cached_textures[ key ] then
		...
		if self._cached_textures[ key ] == 0 then
			if not is_removing then
				...
				-- table.insert( self._removing_textures, texture_ids )
			else
...
function MenuComponentManager:test_camera_shutter_tech()
	if not self._tcst then
		...
		-- o:bitmap( { name="blur",  texture="guis/textures/test_blur_df", w=o:w(), h=o:h(), layer=6, render_template="VertexColorTexturedBlur3D", halign="scale", valign="scale" } )
		-- o:bitmap( { name="blur2", texture="guis/textures/test_blur_df", w=o:w(), h=o:h(), layer=3, render_template="VertexColorTexturedBlur3D", blend_mode="lighten", halign="scale", valign="scale" } )
		-- o:bitmap( { name="blur3", texture="guis/textures/test_blur_df", w=o:w(), h=o:h(), layer=4, render_template="VertexColorTexturedBlur3D", blend_mode="darken", halign="scale", valign="scale" } )
	...
	--[[
	local animate_test = function(o)
		local black = o:child("black")
		local blur = o:child("blur")
		local blur2 = o:child("blur2")
		local blur3 = o:child("blur3")
		
		o:hide()
		black:set_size( o:w(), o:h() )
		black:set_bottom( o:h() )
		...
		over( 0.25, function(p)
			black:set_h( (1-p) * (1-p) * (1-p) * o:h() )
			black:set_bottom( o:h() )
			blur:set_alpha(math.min(1, 2-p*2))
			blur2:set_alpha(math.min(1, 2-p*2))
			blur3:set_alpha(math.min(1, 2-p*2))
		end )
