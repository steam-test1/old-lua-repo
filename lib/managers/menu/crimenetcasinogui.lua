...
function CrimeNetCasinoGui:init( ws, fullscreen_ws, node )
	...
	local button_exit = self._button_panel:text( { name = "button_exit", text = managers.localization:to_upper_text( "menu_casino_choice_exit", { BTN_X = managers.localization:btn_macro( "menu_casino_exit" ) } ), align = "right", font = medium_font, font_size = medium_font_size, color = tweak_data.screen_colors.text, layer = 1, blend_mode = "add" } )
	...
	local button_bet = self._button_panel:text( { name = "button_bet", text = managers.localization:to_upper_text( "menu_casino_choice_bet", { BTN_X = managers.localization:btn_macro( "menu_casino_bet" ) } ), align = "right", font = medium_font, font_size = medium_font_size, color = tweak_data.screen_colors.text, layer = 1, blend_mode = "add" } )
