...
-- Command line was: F:\SteamLibrary\SteamApps\common\PAYDAY 2\lua\lib\managers\mission\elementdisableunit.luac 

core:import("CoreMissionScriptElement")
if not ElementDisableUnit then
  ElementDisableUnit = class(CoreMissionScriptElement.MissionScriptElement)
end
ElementDisableUnit.init = function(l_1_0, ...)
...
ElementDisableUnit.on_script_activated = function(l_2_0)
...
ElementDisableUnit._load_unit = function(l_3_0, l_3_1)
  Application:stack_dump()
  table.insert(l_3_0._units, l_3_1)
end

ElementDisableUnit.client_on_executed = function(l_4_0, ...)
  l_4_0:on_executed(...)
   -- DECOMPILER ERROR: Confused about usage of registers for local variables.

end

ElementDisableUnit.on_executed = function(l_5_0, l_5_1)
  ...
  ElementDisableUnit.super.on_executed(l_5_0, l_5_1)
end

ElementDisableUnit.save = function(l_6_0, l_6_1)
  l_6_1.save_me = true
  l_6_1.enabled = l_6_0._values.enabled
end

ElementDisableUnit.load = function(l_7_0, l_7_1)
