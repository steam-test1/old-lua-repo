			...
			for achievement, achievement_data in pairs(tweak_data.achievement.complete_heist_achievements) do
				...
				if achievement_data.equipped_team then
					...
					for _, member in pairs(managers.network:game():all_members()) do
						...
						if not pass_armor or not pass_deployable or not pass_mask or not pass_melee_weapon or not pass_primary or not pass_secondary or not pass_primaries or not pass_secondaries or not pass_primary_unmodded or not pass_secondary_unmodded then
