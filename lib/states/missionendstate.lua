...
-- 	managers.menu_component:pre_set_game_chat_leftbottom( 0, 0 )
	...
	if self._success and Global.game_settings.difficulty == "overkill_145" and managers.job:current_contact_id() == "vlad" then
		if managers.blackmarket:equipped_mask().mask_id == tweak_data.achievement.in_soviet_russia.mask then
