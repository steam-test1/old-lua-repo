...
function CoreAreaHubElement:_altitude_ctrlr(panel, name, value, type, sizer)
	...
	ctrl:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_altitude_text"), {ctrl = ctrl, type = type})
	ctrl:connect("EVT_KILL_FOCUS", callback(self, self, "set_altitude_text"), {ctrl = ctrl, type = type})
