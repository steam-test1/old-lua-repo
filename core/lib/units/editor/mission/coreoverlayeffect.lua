...
function CoreOverlayEffectUnitElement:_build_panel(panel, panel_sizer)
	...
	effect:connect("EVT_COMMAND_COMBOBOX_SELECTED", callback(self, self, "set_element_data"), {ctrlr = effect, value = "effect"})
	...
	fade_in:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_option_time"), {ctrlr = fade_in, value = "fade_in"})
	fade_in:connect("EVT_KILL_FOCUS", callback(self, self, "set_option_time"), {ctrlr = fade_in, value = "fade_in"})
	...
	sustain:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_option_time"), {ctrlr = sustain, value = "sustain"})
	sustain:connect("EVT_KILL_FOCUS", callback(self, self, "set_option_time"), {ctrlr = sustain, value = "sustain"})
	...
	fade_out:connect("EVT_COMMAND_TEXT_ENTER", callback(self, self, "set_option_time"), {ctrlr = fade_out, value = "fade_out"})
	fade_out:connect("EVT_KILL_FOCUS", callback(self, self, "set_option_time"), {ctrlr = fade_out, value = "fade_out"})
